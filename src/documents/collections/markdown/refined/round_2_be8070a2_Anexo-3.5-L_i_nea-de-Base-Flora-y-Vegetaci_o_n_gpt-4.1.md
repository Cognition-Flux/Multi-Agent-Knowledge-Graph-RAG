...
Región de Atacama, Febrero de 2020
...
Se presentan los resultados de la revisión bibliográfica, junto con la sistematización y análisis de la información recopilada en la prospección realizada en terreno en el área de influencia del proyecto “Planta Fotovoltaica North West” para la componente biótica Flora y Vegetación vascular.

El área de influencia se encuentra emplazada aproximadamente a 10 km al sureste de la localidad de Cachiyuyo y a 50 km de la localidad de La Higuera, en un polígono ubicado al costado de la Ruta 5 Norte en la III Región de Atacama; vegetacionalmente se encuentra en la formación del Desierto Florido de las Serranías, de acuerdo a la propuesta de Gajardo (1994).
...
Cabe destacar que dentro del área de estudio se registraron 2 especies clasificadas en categoría de conservación: *Krameria cistoidea* y *Cumulopuntia sphaerica*, ambas clasificadas en la categoría de En Preocupación Menor.
...
El Proyecto se localiza administrativamente aproximadamente a 10 km al sureste de la localidad de Cachiyuyo y a 50 km de la localidad de La Higuera, en la III Región de Atacama.
...
La clasificación vegetacional de Luebert y Pliscoff (2017) corresponde a una síntesis de varios sistemas de clasificación y propuestas fitogeográficas y vegetacionales anteriores, en donde determinan las unidades denominadas “pisos de vegetación” que es el cruce de variables bioclimáticas y de altitud con las formaciones vegetacionales, la composición florista y la fisionomía de la vegetación presente a lo largo y ancho de Chile.
...
(Se describen a continuación los tipos de recubrimientos de suelo mencionados en el cuadro anterior, ver texto original para detalles.)
...
Finalmente, el estado de conservación se definió de acuerdo a los siguientes listados oficiales (ver texto original para detalle de decretos y referencias).
...
|                 | *Encelia canescens* Lam. var. *parvifolia* (Kunth) Ball (Coronilla de fraile) |         |                    |
...
|                 | *Heliotropium stenophyllum* Hook. & Arn. (Monte negro) |         |                    |
...
|                 | *Balsamocarpon brevifolium* Clos (Algarrobilla) |         |                    |
|                 | *Caesalpinia angulata* (Hook. & Arn.) Baill. (Retamo) |         |                    |
...
De acuerdo con la prospección realizada en terreno en el área de influencia del proyecto, la superficie total del área equivale a 25 ha. La superficie se divide en dos unidades de cobertura, la primera posee vegetación de características xerofíticas en su totalidad; correspondiente a: Matorral arbustivo leñoso alto de *Bulnesia chilensis* y *Adesmia argentea*, mientras que la segunda corresponde al camino de acceso. La formación vegetacional se describe a continuación.

### Matorral arbustivo leñoso alto de *Bulnesia chilensis* y *Adesmia argentea*

Unidad de vegetación que da homogeneidad y se distribuye en toda el área proyectada para la ejecución del proyecto, en donde la especie dominante corresponde a la arbustiva alta *Bulnesia chilensis* “retama”, con un elemento secundario que varía en densidad y cobertura correspondiente a la arbustiva baja *Adesmia argentea* “jarilla”. En las áreas con mayor densidad, la cobertura de ambas especies no supera el 25% a nivel de suelo. De forma ocasional se registraron otras especies como *Ephedra chilensis* “pingo pingo”; *Krameria cistoidea* “pacúl”; *Caesalpinia angulata* y la única suculenta registrada en el área de estudio correspondiente a *Cumulopuntia sphaerica* “gatitos”.
...
Durante el levantamiento de información en terreno se registraron un total de 6 taxas de plantas vasculares. El total de los taxas (6 especies) se clasifican en dos divisiones taxonómicas; correspondientes a Pinophyta (1 especie) y 5 taxas corresponden a la división Magnoliophyta, sub división Magnoliopsida.
...
En relación al origen geográfico de las especies, se registraron un total de 4 especies de origen endémico y 2 taxas nativas de Chile.

De acuerdo con la prospección realizada en el área de influencia, se registraron 2 taxas clasificadas en alguna categoría de conservación de acuerdo con la revisión de los instrumentos oficiales e indicativos mencionados en la metodología del presente informe.

#### Tabla 6-3. Especies de plantas vasculares clasificadas en categoría de conservación registradas en el área de influencia

| Especie | Categoría Benoit (1989) | MMA | Libro Rojo de Atacama |
|---------|------------------------|-----|----------------------|
| *Krameria cistoidea* Hook. & Arn. | VU2 | LC3 DS 42/2011 MMA | FP4 |
| *Cumulopuntia sphaerica* (C.F. Först.) E.F. Anderson | LC DS 19/2012 | FP |
...
| Familia        | UTM Este | UTM Norte |
|---------------|----------|-----------|
| Krameriaceae  | 313525   | 6776807   |
|               | 313041   | 6776831   |
| Cactaceae     | 313150   | 6776820   |
...
| Magnoliophyta-   | Cactaceae     | *Cumulopuntia sphaerica* (C.F. Först.) E.F. Anderson (Gatitos) | Nativo   | Arbusto suculento     |
| Magnoliopsida    | Fabaceae      | *Adesmia argentea* Meyen (Jarilla) | Endémico | Arbusto perenne       |
|                  | Fabaceae      | *Caesalpinia angulata* (Hook. & Arn.) Baill. (Retamo) | Endémico | Arbusto perenne       |
|                  | Francoaceae   | *Bulnesia chilensis* Gay (Retama del cerro) | Endémico | Arbusto perenne       |
|                  | Krameriaceae  | *Krameria cistoidea* Hook. & Arn. (Pacúl) | Endémico | Arbusto perenne       |
...
- Squeo, F., Arancio, G. y Gutierres, J. 2008. Libro Rojo de la Flora Nativa y de los Sitios Prioritarios para su Conservación: Región de Atacama. Ediciones de la Universidad de La Serena.
...
|--------------------|------|------|------|------|------|------|------|------|------|------|------|
| *Adesmia argentea* |  +   |  +   |  r   |  +   |      |      |      |      |      |      |      |
| *Bulnesia chilensis*|  2   |  2   |  2   |      |      |      |      |      |      |      |      |
| *Caesalpinia angulata* |    |      |      |  r   |      |      |      |      |      |      |      |
| *Cumulopuntia sphaerica* | |  r   |      |      |      |      |      |      |      |      |      |
| *Ephedra chilensis*|      |      |      |      |      |      |      |      |  p   |      |      |
| *Krameria cistoidea*|  p   |      |      |      |      |      |      |      |  p   |      |      |
