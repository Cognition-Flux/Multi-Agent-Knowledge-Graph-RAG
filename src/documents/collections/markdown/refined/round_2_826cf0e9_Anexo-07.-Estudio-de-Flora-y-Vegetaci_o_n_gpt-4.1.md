...
## “PROYECTO EXTRACCIÓN DE ÁRIDOS RÍO ÑUBLE”
...
| Tabla | Descripción |
|-------|-------------|
| 1 | Ubicación Georreferenciada del área extracción. |
| 2 | Ubicación Georreferenciada del área de Instalación de Faenas. |
| 3 | Claves de codificación según el espectro biológico de las especies. |
| 4 | Categorías de recubrimiento y codificación. |
| 5 | Codificación de las especies dominantes. |
| 6 | Grado de artificialización. |
| 7 | Regiones Vegetacionales en Chile. |
| 8 | Resultados Carta de Ocupación de Tierras |
| 9 | Especies dominantes descritas en la COT. |
| 10 | Listado de especies vegetales registradas en el área de estudio. |
...
| 4 | Catastro Vegetacional SIT CONAF 2008. |
| 5 | Resultados COT. |
| 6 | Características del área de estudio (febrero 2018). |
| 7 | Características del área de estudio (febrero 2018). |
| 8 | Características del área de estudio (febrero 2018). |
| 9 | Hábito de especies vegetales registradas en el área de estudio. |
| 10 | Ejemplar de *Rubus ulmifolius* (Zarzamora). |
| 11 | Ejemplar de *Acacia caven* (Espinillo). |
| 12 | Ejemplar de *Convolvulus arvensis* (Suspiro blanco). |
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Extracción de Áridos Río Ñuble”, en la comuna de San Carlos y Chillán, ambas de la región de Ñuble.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Extracción de Áridos Río Ñuble”.
...
El proyecto “Extracción de Áridos Río Ñuble” se emplaza a 7 km del sector Noreste de la ciudad de Chillán, Camino a San Carlos (Figura 1). El área del proyecto se encuentra más específicamente en la ribera del Río Ñuble (**¡Error! No se encuentra el origen de la referencia.**).
...
### Tabla 1. Ubicación Georreferenciada del área extracción.
...
### Tabla 2. Ubicación Georreferenciada del área de Instalación de Faenas.
...
Las actividades en terreno se ejecutaron durante el mes de febrero de 2018, donde se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
(Se mantiene la estructura y contenido original de la tabla, ver texto fuente para detalles.)
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron 5 unidades ambientales (Figura 5), la primera unidad identificada corresponde a Formación arbórea que se compone de especies arbóreas de origen introducido *Salix babylonica* y *Populus nigra* los cuales tienen características ornamentales, la segunda unidad ambiental corresponde a la de Matorral predominando la especie arbustiva *Rubus ulmifolius* de origen introducida, la tercera unidad ambiental corresponde a la de Caja de Río siendo la unidad que abarca mayor superficie del predio, zona de ribera del río en donde se llevaran a cabo las obras de extracción de áridos, compuesto por piedras (Bolones). Además de plantas herbáceas de origen exóticas como *Galega officinalis* y *Hypochaeris radicata*, la cuarta unidad corresponde a Cuerpo de agua que se compone del Caudal del Río Ñuble, por último la unidad de Infraestructura que corresponde al sector del predio en el cual se encuentra la instalación de faenas del proyecto.
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| Formación arbórea| LA, LA, SB, PN   | Formación compuesta por especies arbóreas de origen introducidas y características ornamentales como *Salix babylonica* y *Populus nigra*. | Leñoso alto, muy clara / Leñoso Alto, escasa. |
| Matorral         | Ru               | Formación herbácea de tipo maleza, predominando especies arbustivas de origen introducidas como *Rubus ulmifolius*. | Leñoso bajo, muy clara. |
| Caja de Río      | H, H, go, hr     | Zona de ribera del río en donde se llevaran a cabo las obras de extracción de áridos, compuesto por piedras (Bolones) y arena. Además de plantas herbáceas de origen exóticas como *Galega officinalis* y *Hypochaeris radicata*. | Herbáceo, muy clara. |
| Cuerpo de agua   |                  | Caudal del Río Ñuble. |                           |                   |
| Infraestructura  |                  | Sector del predio en el cual se encuentra la instalación de faenas del proyecto. |                   |                   |
...
| Herbácea      | *Galega officinalis*  | go    |
| Herbácea      | *Hypochaeris radicata*| hr    |
...
- Carta: 
- Escala: 1:12.500
- Simbología: CARTA DE OCUPACION DE TIERRAS (COT)
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia*

**Figura 6, 7, 8. Características del área de estudio (febrero 2018).**

#### 6.3.3. Flora

##### 6.3.3.1. Listado de especies

La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 18 especies de plantas pertenecientes a 12 familias (Tabla 10). De las especies registradas 17 corresponden a especies introducidas, principalmente invasoras y ornamentales y 1 especie nativa *Acacia caven*.
...
| Fabaceae          | *Acacia caven*           | Espinillo            |            | Nativa   |
| Rosaceae          | *Rubus ulmifolius*       | Zarzamora            | Arbustiva  |          |
...
| Labiatae          | *Mentha pulegium*        | Poleo                |            |          |
| Poaceae           | *Avena fatua*            | Avena silvestre      |            |          |
| Convolvulaceae    | *Convolvulus arvensis*   | Suspiro blanco       |            |          |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto “Extracción de Áridos Río Ñuble”, en términos de diversidad y la presencia de especies de interés.

La evaluación de la distribución geográfica indica que todas las especies reconocidas en la zona tienen una amplia distribución en Chile, no registrándose especies exclusivas del área de estudio o restringidas a la región de Ñuble.

La flora y vegetación está compuesta principalmente por presencia de especies introducidas, las cuales son consideradas plantas invasoras y ornamentales.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación, obteniendo 5 unidades ambientales: la primera unidad identificada corresponde a Formación arbórea que se compone de especies arbóreas de origen introducido *Salix babylonica* y *Populus nigra* los cuales tienen características ornamentales, la segunda unidad ambiental corresponde a la de Matorral predominando la especie arbustiva *Rubus ulmifolius* de origen introducida, la tercera unidad ambiental corresponde a la de Caja de Río siendo la unidad que abarca mayor superficie del predio, zona de ribera del río en donde se llevaran a cabo las obras de extracción de áridos, compuesto por piedras (Bolones). Además de plantas herbáceas de origen exóticas como *Galega officinalis* y *Hypochaeris radicata*, la cuarta unidad corresponde a Cuerpo de agua que se compone del Caudal del Río Ñuble, por último, la unidad de Infraestructura que corresponde al sector del predio en el cual se encuentra la instalación de faenas del proyecto.
...
- **Figura 10. Ejemplar de *Rubus ulmifolius* (Zarzamora).**
  - *Fuente: Levantamiento en terreno. Elaboración propia.*
- **Figura 11. Ejemplar de *Acacia caven* (Espinillo).**
- **Figura 12. Ejemplar de *Convolvulus arvensis* (Suspiro blanco).**
