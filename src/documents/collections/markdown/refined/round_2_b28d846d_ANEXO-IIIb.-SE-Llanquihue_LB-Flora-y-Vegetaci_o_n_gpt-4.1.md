...
La descripción de la vegetación del área del proyecto considera la metodología empleada en el Proyecto "Catastro y Evaluación de los Recursos Vegetacionales Nativos de Chile" (CONAF-CONAMA-BIRF, 1999), basada en la Cartografía de Ocupación de Tierras (COT), desarrollada por el Centro de Estudios Fitosociológicos y Ecológicos L. Emberger (CEPE de Montpellier) y adaptada por Etienne y Prado (1982). Ver Tabla 1.

#### Tabla 1: Clasificación de Uso actual del suelo

| Categoría de Uso del Suelo | Categoría de Uso del Suelo |
|---------------------------|---------------------------|
| Áreas urbanas e industriales | Humedales |
...
| Terrenos agrícolas | 5.3 Ñadis herbáceos y arbustivos |
| 2.1 Terreno de uso agrícola | 5.4 Turbales |
| 2.2 Rotación cultivo / pradera | 5.5 Bofedales |
| Praderas y matorrales | 5.6 Vegas |
...
Para la caracterización vegetacional del área del proyecto se utilizó la cobertura de uso actual del suelo según el Catastro de Bosque Nativo de la Región de los Lagos (Conaf, 2013). A partir de ésta y con el apoyo de la imagen satelital (Google Earth, Mayo de 2015) disponible para el sector, se hizo una fotointerpretación a escala 1:2.000 utilizando el software ArcGis 10.1. Los resultados se muestran en la Tabla 7, la cual presenta las distintas categorías de Uso del Suelo presentes en el AI del proyecto (buffer de 100 m alrededor del predio).
...
| Plantación de Pino                     |     | 0,54              | 2,85          |                                           |                 |
| **Sub-Total Plantaciones**             |     | **0,54**          | **2,85**      |                                           |                 |
| Pradera                                |     | 15,19             | 79,97         | 4,0                                       | 100             |
...
| Nombre Científico      | Origen | Abundancia relativa | Punto de Muestreo 1 |
|-----------------------|--------|---------------------|---------------------|
| *Cirsium vulgare*     |        |                     |                     |
| *Plantago lanceolata* |        |                     |                     |
| *Rubus ulmifolius*    |        |                     |                     |
...
| Nombre Científico   | Origen      | Abundancia relativa | Pto. Muestreo 2 |
|---------------------|-------------|---------------------|-----------------|
| *Pinus radiata*     | Leñoso alto |                     |                 |
| *Rubus ulmifolius*  |             |                     |                 |
...
| Nombre Científico      | Origen | Abundancia relativa | Punto de Muestreo 3 |
|-----------------------|--------|---------------------|---------------------|
| *Holcus lanatus*      |        |                     |                     |
...
| Origen Geográfico | Nativas | Introducidas | Total |
|-------------------|---------|--------------|-------|
| Endémicas         |         |              |       |
| No Endémicas      |         |              |       |
| Total             | 0       | 10           | 10    |

En total fueron identificadas 10 especies de plantas vasculares, todas especies introducidas.
...
|----|----------------|------------------------|-------------------|---------------|--------|----------|
| 1  | Asteraceae     | *Cirsium vulgare*      | Cardo Negro       |               |        | RM - X   |
| 2  | Poaceae        | *Holcus lanatus*       | Pasto miel        |               |        | IV - XII |
| 3  | Asteraceae     | *Hypochaeris radicata* | Hierba del chancho|               |        | IV - XII |
| 4  | Poaceae        | *Lolium sp.*           | Ballica           |               |        | IV - XII |
| 5  | Pinaceae       | *Pinus radiata*        | Pino Insigne      | Leñoso alto   |        | VI - X   |
| 6  | Plantaginaceae | *Plantago lanceolata*  | Siete venas       |               |        | II - XII |
| 7  | Ranunculaceae  | *Ranunculus repens*    | Botón de Oro      |               |        | IV - XII |
| 8  | Rosaceae       | *Rubus ulmifolius*     | Zarzamora         |               |        | IV - VIII|
| 9  | Asteraceae     | *Taraxacum officinale* | Diente de León    |               |        | RM - VIII|
| 10 | Fabaceae       | *Ulex europaeus*       | Chacay            |               |        | V - X    |

Estas 10 especies representan a 7 familias, siendo las de mayor presencia la familia *Asteraceae* con 3 especies, las cuales corresponden a herbáceas introducidas. Seguido por la familia *Poaceae* con 2 especies de herbáceas introducidas. Ver gráfico a continuación.
...
El componente vegetacional presente en el área de influencia del proyecto corresponde a formaciones vegetacionales fuertemente intervenidas, donde predominan las praderas y matorrales de especies introducidas.
