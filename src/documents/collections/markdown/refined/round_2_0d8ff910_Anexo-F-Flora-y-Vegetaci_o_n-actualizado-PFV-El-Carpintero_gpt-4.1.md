...
| TÍTULO DEL DOCUMENTO | ID de documento | Número de proyecto | Versión | Fecha | Detalle/Estado | Autor | Revisión | Revisión Cliente | Aprobado por |
|----------------------|-----------------|--------------------|---------|-------|----------------|-------|----------|------------------|--------------|
...
3. **RESULTADOS** ....................................................................................................................... 16
    ...
    3.2 CARTA DE OCUPACIÓN DE TIERRAS (COT) ........................................................................ 16
        3.2.1 Plantación de Eucalyptus globulus ........................................................................... 18
        3.2.2 Plantación de Pinus radiata ..................................................................................... 19
...
Caracterizar la condición actual de los ecosistemas vegetacionales terrestres presentes en el área de influencia del Proyecto, de acuerdo con los requerimientos estipulados en el D.S. Nº 40/2012 MMA, de manera que, asociado a su intervención, se pueda determinar posibles impactos ambientales, según lo establecido en la Ley Nº 19.300, en el D.S. Nº 40/2012 MMA, y la aplicación de la normativa ambiental vigente respectiva.
...
De manera general, el presente estudio se realizó en 3 etapas:

1. Revisión bibliográfica para contextualizar el marco biogeográfico y reconocimiento de potenciales formaciones, comunidades y especies en el AI, y delimitación preliminar de las potenciales UHV.
2. Trabajo de campo asociado al levantamiento de datos *in situ*.
3. Consolidación y análisis de la información recopilada a través de fuentes secundarias y de aquellas obtenidas en terreno.
...
En relación a lo anterior, se considera como área de influencia del Proyecto, la superficie de suelo y/o vegetación donde se instalarán las obras, es decir el emplazamiento del parque fotovoltaico. Esta área se emplaza en la comuna de Constitución, provincia de Talca, región del Maule y posee una superficie de aproximadamente 12,15 ha, cuya distribución espacial se expresa en la Figura 2-1.

**Figura 2-1. Área de influencia.**

### 2.2 Campaña de terreno

Para caracterizar la flora y vegetación terrestre se realizó una campaña de terreno durante la época de verano, ejecutada entre los días 3 y 4 de marzo de 2020. Esta campaña permitió identificar, prospectar y describir las formaciones vegetacionales presentes en el área de estudio, mediante un muestreo cualitativo-cuantitativo.
...
En total se realizaron 12 puntos de muestreo, complementado con un recorrido pedestre del área completa del proyecto. La ubicación de las parcelas de muestreo se entrega en la siguiente tabla:

**Tabla 2-1. Parcelas de muestreo**

| Puntos de muestreo | Coordenadas WGS 84, Huso 18 Sur | Este | Norte |
|--------------------|----------------------------------|------|-------|
...
- **Leñosos altos (arbóreos):** especies de tejidos lignificados, cuyo tamaño excede los 2 metros de altura.
- **Leñosos bajos (arbustivos):** especies de tejidos lignificados, cuyo tamaño no sobrepasa los 2 metros de altura.
...
|---------------|--------|
| Leñoso alto, con cubrimiento n | LA n |
| Leñoso bajo, con cubrimiento n | LB n |
| Herbáceo, con cubrimiento n | H n |
| Suculento, con cubrimiento n | S n |
| n = Cobertura (%) |

Fuente: FNC, en base a la Guía SEA (Ficha VE-02: Vegetación)

La estratificación se refiere a la disposición vertical de la vegetación, permitiendo distinguir y clasificar los diversos niveles de altura en los cuales se sitúan los tipos biológicos. La siguiente tabla muestra los rangos de altura clasificados con un índice.

**Tabla 2-3. Codificación rango de altura por tipo biológico**

| Índice | Leñoso alto (m) | Leñoso bajo (m) | Herbáceo (m) | Suculento (m) |
|--------|-----------------|-----------------|--------------|---------------|
| 2 - 4  | 0 - 0,25        | 0 - 0,25        | 0 - 0,25     | 0 - 0,25      |
| 4 - 8  | 0,25 – 0,5      | 0,25 – 0,5      | 0,25 – 0,5   | 0,25 – 0,5    |
| 8 - 16 | 0,5 - 1         | 0,5 - 1         | 0,5 - 1      | 0,5 - 1       |
| 16 - 32| 1 - 2           | 1 - 2           | 1 - 2        | 1 - 2         |
| >32    | >2              | >2              | >2           | >2            |
...
A partir de los datos obtenidos en la Carta de Ocupación de Tierras (COT) mencionado anteriormente, se obtiene una representación cartográfica de la vegetación y se puede deducir la formación vegetal de acuerdo a la clasificación presente en la siguiente tabla (SEA, 2015).

**Tabla 2-5. Clasificación de la vegetación de formaciones vegetacionales**

| Formación vegetal | % Cobertura por Tipo Biológico | Cobertura | Árbol | Arbustos | Herbáceas | Suculentas | No Vascular |
|-------------------|-------------------------------|-----------|-------|----------|-----------|------------|-------------|
| Praderas c/suculentas | 50 - 75 | 25 - 50 | 5 - 10 |           |           |           |             |
| Pradera con arbustos c/suculentas | 50 – 75 | 25 – 50 | 5 - 10 | No existe |           |           |             |
| Matorral c/suculentas | 50 – 75 | 25 – 50 | <25 | 5 - 10 | 5 - 10 |           |             |
| Matorral arborescente (Matorral con árboles) c/suculentas | 50 – 75 | 25 - 50 | No existe | No existe |           |             |
| Formación de suculentas (Presencia de suculentas > 5%) | >25 | 5 - 10 |           |           |           |             |
| Bosque (Árboles potencial > 5 m de altura) c/suculentas | 50 – 75 | 25 - 50 | <25 | <25 | 5-10 |           |             |
| Praderas con árboles | 50 – 75 | 25 - 50 | No existe | No existe |           |             |
| Zonas de vegetación escasa (< sin vegetación) |           |           |           |           |           |             |

Fuente: FNC. En base a Ficha VE-04: Vegetación, SEA, 2015.

El Catastro y Evaluación de los recursos vegetacionales nativos de Chile (CONAF-CONAMA BIRF, 1997) establece criterios de clasificación de uso del suelo, que resulta conveniente homologar con el sistema de clasificación de la vegetación que se desarrolla en este documento, de manera que los resultados puedan ser comparados a nivel local y regional. De esta manera, el Sub-Uso se asociará a la formación vegetal definida en la tabla anterior. Asimismo, en la siguiente tabla se puede observar el sistema de clasificación que se usará para el uso del suelo (Uso actual) y formaciones vegetacionales.

**Tabla 2-6. Clasificación de formaciones vegetacionales**

| Uso actual | Sub-Uso | Formación vegetal |
|------------|---------|------------------|
| Ambientes modificados | Áreas urbanas e industriales | 1.1 Ciudades-Pueblos-Zonas Industriales |
|                        | Caminos | 1.2 Caminos |
|                        | Casas o galpones | 1.3 Casas o galpones |
| Ambientes intervenidos | Terrenos agrícolas | 2.1 Terrenos de uso agrícola |
|                        | Rotación Cultivo – Pradera | 2.2 Rotación Cultivo – Pradera |
|                        | Plantación forestal | 3.1 Plantación adulta |
|                        | Plantación joven o recién cosechada | 3.2 Plantación joven o recién cosechada |
|                        | Bosques de exóticas asilvestradas | 3.3 Bosques de exóticas asilvestradas |
|                        | Bosque (especies exóticas predominantes) | |
| Ambientes Naturales    | Praderas y Matorrales | 4.1 Praderas |
|                        | Praderas con árboles | 4.2 Matorral-pradera |
|                        | Praderas con arbustos | 4.3 Matorrales |
|                        | Matorral | 4.4 Matorrales arborescentes |
|                        | Matorral arborescente | 4.5 Matorral con suculentas |
|                        | Matorral con suculentas | 4.6 Formación de suculentas |
|                        | Formación de suculentas | |
| Áreas sin vegetación   | Afloramientos rocosos | 5.1 Afloramientos rocosos |
|                        | Terrenos sobre límite vegetación | 5.2 Terrenos sobre límite vegetación |
|                        | Corridas de lava y escoriales | 5.3 Corridas de lava y escoriales |
|                        | Derrumbes sin vegetación | 5.4 Derrumbes sin vegetación |
|                        | Otros terrenos sin vegetación | 5.5 Otros terrenos sin vegetación |
|                        | Cajas de ríos | 5.6 Cajas de ríos |
| Nieves y glaciares     |                      | |
| Cuerpos de agua        | Ríos - Esteros - Quebradas | 7.1 Ríos - Esteros - Quebradas |
|                        | Lagos - Lagunas – Embalses - Tranques | 7.2 Lagos - Lagunas – Embalses - Tranques |
| Bosque                 | Bosque nativo | 8.2 Bosque nativo |
|                        | Bosque adulto | 8.2.1 Bosque adulto |
|                        | Bosque de renovales | 8.2.2 Bosque de renovales |
|                        | Bosque adulto/renoval | 8.2.3 Bosque adulto/renoval |
|                        | Bosques achaparrados | 8.2.4 Bosques achaparrados |
|                        | Bosque de protección | 8.2.5 Bosque de protección |
|                        | Bosque nativo de preservación | |
|                        | Bosques mixtos | 8.3 Bosques mixtos |
|                        | Bosque nativo-Plantación | 8.3.1 Bosque nativo-Plantación |
|                        | Bosque nativo-Exóticas asilvestradas | 8.3.2 Bosque nativo-Exóticas asilvestradas |
...
Cabe señalar que las 2 fuentes de información corresponden a estudios bibliográficos sobre presencia de flora. Adicionalmente, se recurrió a la revisión de antecedentes de líneas de base presentados en proyectos cercanos al área de estudio, en el marco del Sistema de Evaluación de Impacto Ambiental.
...
El origen fitogeográfico de cada especie, fue determinado en base a su distribución geográfica natural. Se clasificó de acuerdo a lo expuesto en el catálogo de plantas vasculares del cono sur, del instituto de botánica Darwinion, la cual se describe en la siguiente tabla:
...
La flora vascular presente en el área de influencia se clasificó según sus hábitos de crecimiento, de acuerdo a lo establecido en el catálogo de plantas vasculares del cono sur, del instituto de botánica Darwinion (Zuloaga et al., 2008). Los hábitos de crecimiento corresponden a arbóreo, arbustivo, enredadera parásita anual, hierba anual, hierba anual o perenne, hierba anual o bienal, hierba epífita perenne, hierba perenne, suculento y no determinado (sin hábito conocido por tratarse de un taxón identificado a nivel genérico).

##### 2.4.2.4 Abundancia

La abundancia de cada especie registrada fue caracterizada con un valor de la escala de cubrimiento-abundancia de Braun-Blanquet (1979), mediante estimación visual dentro de las parcelas de inventario florístico. La siguiente tabla muestra la clasificación de cobertura por especie.
...
Las categorías de estado de conservación se asignaron según la literatura científico-técnica concerniente. Ésta se jerarquizó de acuerdo a un criterio donde priman los sistemas de clasificación con ponderación legal, es decir, la primera prioridad se aplicó a documentos incluidos en la legislación vigente a nivel nacional (Benoit, 1989; Decretos Supremos de MINSEGPRES (Nº 151/2007; Nº 50/2008; Nº 51/2008, N° 23/2009) y Ministerio de Medioambiente (Nº 33/2011, Nº 41/2012, Nº 42/2012, N° 19/2013, N° 13/2013, N° 52/2014 y N° 38/2015, N° 16/2016, N° 6/2017, N° 79/2018 y N°23/2019)). En segunda instancia se revisaron las propuestas científico-técnicas mencionadas en el boletín número 47 de MNHN (Núñez et al., 1998) para ciertos grupos de especies vegetales de interés (Pteridophyta: Baeza et al., 1998 y Geófitas: Ravenna et al., 1998).
...
|---------|-----|-----------|-----------------|--------------------|---------------------|
| P01 | LA5LAB1 | Plantación Eucalyptus globulus | 2, 1, 1 | 4, 5 | EG, CA, Ach, Gi, Ep |
| P02 | LA6LB2 | 3, 1 | 4, 5 | 6, 1 | EG, CA, Tm, EP |
| P03 | LA5LB1 | 2, 1 | 5, 1 | EG, LC, Tm |
| P04 | LA5LB1 | 3, 2 | 5, 2 | EG, PR, Tm |
| P05 | LA5LB2 | 3, 1, 3 | 4, 1, 1 | EG, CA, PR, Tm |
| P06 | LA6 | Plantación Pinus radiata | 3, 3 | 5, 2 | PR, EG |
| P07 | LA5LB1 | Plantación Pinus radiata | 3, 3 | 4, 2 | PR, EG, Bo |
| P08 | LA6 | Plantación Pinus radiata | 3, 3, 1 | 5, 3, 1 | PR, EG, CA |
| P09 | LA5LB3 | 3, 2, 1 | 4, 4 | 4, 2, 1, 3, 1 | EG, PR, NO, Tm, Pc |
| P10 | LA5LB2 | 3, 3, 1 | 3, 4 | 4, 2, 1, 3, 1 | EG, PR, LC, Tm, Um |
| P11 | LA5 | Plantación Pinus radiata | 3, 3 | 5, 2 | PR, EG |
| P12 | LA2 | Plantación Pinus radiata | 1, 1 | 1, 1 | PR, EG |

Dentro del área de influencia se identificaron, caracterizaron y delimitaron un total de 3 unidades homogéneas de vegetación (UHV), las que corresponden a Plantación de *Eucalyptus globulus*, Plantación de *Pinus radiata* y Sin vegetación.

Estas unidades constituyen un mosaico de vegetación para el área de influencia con distintos grados de participación, los cuales se sintetizan en la siguiente tabla. Al respecto, la unidad de vegetación más representativa corresponde a Plantación de *Eucalyptus globulus* con una superficie de 7,27 ha (60%), seguida por Plantación de *Pinus radiata* con una superficie de 4,31 ha (35%), mientras que la unidad de menor representatividad es Sin vegetación, con 0,57 ha de superficie (5%).

**Tabla 3-2. Usos de suelo presentes en el área del proyecto**

| Uso actual | Superficie (ha) | Porcentaje de representatividad (%) |
|------------|-----------------|-------------------------------------|
| Ambiente modificado | Sin vegetación | 0,57 | 5% |
| Ambiente intervenido | Plantación de Eucalyptus globulus | 7,27 | 60% |
| Ambiente intervenido | Plantación de Pinus radiata | 4,31 | 35% |
| **Total** | **12,15** | **100** |
...
| Uso actual | Uso actual | Superficie (ha) | Porcentaje de representatividad (%) |
|------------|-----------|-----------------|-------------------------------------|
| Ambiente modificado | Áreas urbanas e industriales | Sin vegetación | 0,57 | 5% |
| Ambiente intervenido | Plantación forestal | Plantación Eucalyptus globulus | 7,27 | 60% |
| Ambiente intervenido | Plantación forestal | Plantación de Pinus radiata | 4,31 | 35% |
| **Total** |           | **12,15** | **100** |

### 3.4 Tipología de formaciones según la Ley N°20.283

Acorde a las estipulaciones contenidas en la Ley N° 20.283, sobre Recuperación del Bosque Nativo y Fomento Forestal y según lo descrito en el Ordinario N° 528/2001 de la Corporación Nacional Forestal (CONAF), dentro del área de influencia no se encontró la presencia de Bosque nativo, por lo que se descarta la necesidad de presentar el PAS148.

Por otra parte, para la intervención de las formaciones vegetacionales, plantación de *Eucalyptus globulus* (7,27 ha) y plantación de *Pinus radiata* (4,31 ha), debido a que se encuentran en suelos de aptitud preferentemente forestal, se deberá tramitar el permiso ambiental sectorial N°149 con anterioridad a la ejecución de las intervenciones, según lo estipulado en la Ley N°19.300 y su Reglamento, y posteriormente se deberá elaborar un Plan de manejo de corta y reforestación de plantaciones para ejecutar obras civiles – D.L. N°701 ante CONAF.
...
Respecto a la taxonomía de la diversidad florística identificada en el área de estudio, esta incluye las divisiones Magnoliophyta (30 familias, 46 géneros y 49 especies), Pinophyta (una familia, género y especie) y Pteridophyta (una familia, género y especie). La familia Magnoliopsida es la más relevante en cuanto a contribución de especies (42), seguida por Liliopsida con 7, como se observa en la siguiente tabla.
...
Dentro de la riqueza autóctona total, 19 especies (37,3% del total) poseen origen fitogeográfico nativo no endémico y 14 especies (27,5%), presentan origen fitogeográfico endémico. Las especies introducidas o alóctonas corresponden a 17 especies (33,3%). Finalmente, una (1) especie (2%), presenta origen no determinado, pues su determinación taxonómica no logró ser identificada (Tabla 3-5). De acuerdo a lo anterior, se decidió tratarla a nivel de género. Además, fue registrada en estado de crecimiento vegetativo sin estructuras reproductivas lo que impide su completa identificación. Para mayor detalle ver Anexos (Tabla 6-1).

**Tabla 3-5. Origen fitogeográfico**

| Arbóreo | Arbustivo | Herbáceas | Total | Representación porcentual |
|---------|-----------|-----------|-------|--------------------------|
| Anual | Anual o bianual | Bianual | Perenne | No determinado |
| 1 | 2,0 |
| 14 | 27,5 |
| 17 | 33,3 |
| 10 | 19 | 37,3 |
...
Respecto a lo señalado en las fuentes de información indicadas en el párrafo anterior, se encontraron 4 especies en alguna categoría de conservación (Tabla 3-6). Para mayor detalle ver Anexos (Tabla 6-4).
...
|-------------------|--------------------------|-----|--------|
| Aextoxicon punctatum Ruiz & Pav. | DS 79/2018 MMA |
| Blechnum hastatum Kaulf | DS 19/2012 MMA |
| Nothofagus glauca (Phil.) Krasser | Casi amenazada (NT) | DS 42/2011 MMA |
| Persea lingue (Ruiz & Pav.) Nees | DS 42/2011 MMA |
...
Dentro del área de influencia se encontró la presencia de *Lapageria rosea* Ruiz & Pav, especie que pese a no estar dentro de ninguna categoría de estado de conservación, se encuentra protegida por el D.S. N°129/1971. Se prohíbe la corta, arranque, trasporte, tenencia y comercio de esta especie a lo largo de todo el territorio nacional. Además, se prohíbe su tenencia en lugares de venta o en la vía pública.
...
- Dentro del área de influencia se identificaron, caracterizaron y delimitaron un total de 3 unidades homogéneas de vegetación (UHV), las que corresponden a Plantación de *Eucalyptus globulus* (7,27 ha), Plantación de *Pinus radiata* (4,31 ha) y sin vegetación (0,57 ha).
...
- Dentro de las formaciones vegetales presentes en el área de influencia se detectó la presencia de 14 especies de flora vascular con características de endemismo. En este sentido, el nivel de endemismo de la flora vascular nativa del área de influencia del proyecto llega a tan solo un 27,5%, lo que puede entenderse como baja. Esta condición, sin duda, se encuentra dentro de lo esperable para el contexto en que se extiende el área de influencia del proyecto, debido a la gran actividad forestal. Esto conlleva a que los elementos naturales originarios se encuentren restringidos y limitados en su desarrollo, manteniendo las áreas de vegetación nativa circunscritas a pequeños paños remanentes fuera del área de estudio. En consecuencia, el bajo grado de endemismo que es posible observar, sumado a la alta participación de especies exóticas dentro del *pool* florístico del área, evidencian un alto grado de degradación de las formaciones vegetales originarias de la zona y cuya presencia no representa un sistema de alto valor para el patrimonio natural del país.
- Dentro del área de influencia se encontraron 4 especies clasificadas en un nivel jerárquico menor (categorías casi amenazada y preocupación menor), las que corresponden a *Aextoxicon punctatum* Ruiz & Pav. (Preocupación menor, LC), *Blechnum hastatum* Kaulf (Preocupación menor, LC), *Nothofagus glauca* (Phil.) Krasser (Casi amenazada, NT) y *Persea lingue* (Ruiz & Pav.) Nees (Preocupación menor, LC). Se entiende por taxón Casi Amenazado (NT) cuando este ha sido evaluado y no satisface, actualmente, los criterios para En Peligro Crítico, En Peligro o Vulnerable; pero está próximo a satisfacer los criterios, o posiblemente los satisfaga en un futuro cercano. Por otro lado, Preocupación Menor (LC), habiendo sido evaluado, no cumple ninguno de los criterios que definen las categorías de En Peligro Crítico, En Peligro, Vulnerable o Casi Amenazado. Se incluyen en esta categoría taxa abundantes y de amplia distribución.
- En síntesis, el área de influencia se encuentra dominada en extensión por territorios que son utilizados para plantaciones forestales y, en donde, no se encontraron bosques naturales. Esto se complementa, a su vez, con una alta presencia de especies exóticas y niveles bajos de especies endémicas.
...
- Ley N° 19300/1994. Ley sobre bases generales del medio ambiente. Diario Oficial, Santiago, Chile. 34810: 3381-3388.
...
| N° | División | Clase | Familia | Género | Especie | Hábito de crecimiento | Fitogeográfico |
|----|----------|-------|---------|--------|---------|----------------------|---------------|
| Bromeliaceae | Greigia | Greigia sphacelata (Ruiz & Pav) Regel |
| Dioscoreaceae | Dioscorea | Dioscorea humifusa Poepp. |
| Iridaceae | Sisyrinchium | Sisyrinchium sp. | No determinado |
| Philesiaceae | Lapageria | Lapageria rosea Ruiz & Pav |
| Poaceae | Avena | Avena barbata Pott ex Link |
| Poaceae | Chusquea | Chusquea quila Kunth |
| Poaceae | Vulpia | Vulpia myuros (L.) C.C.Gmel. |
| 8 | Aextoxicaceae | Aextoxicon | Aextoxicon punctatum Ruiz & Pav. |
| 9 | Anacardiaceae | Lithraea | Lithrea caustica (Molina) Hook & Arn |
| 10 | Magnoliophyta | Anacardiaceae | Schinus | Schinus polygamus (Cav) Cabrera |
| 11 | Magnoliophyta | Baccharis | Baccharis obovata Hook & Arn |
| 12 | Magnoliophyta | Cirsium | Cirsium vulgare (Savi) Ten | Hierba anual o bianual |
| 13 | Magnoliophyta | Hypochaeris | Hypochaeris radicata L |
| 14 | Magnoliophyta | Podanthus | Podanthus ovatifolius Lag |
| 15 | Magnoliophyta | Proustia | Proustia cuneifolia D. Don |
| 16 | Magnoliophyta | Proustia | Proustia pyrifolia DC. |
| 17 | Magnoliophyta | Silybum | Silybum marianum (L.) Gaertn. | Hierba anual o bianual |
| 18 | Magnoliophyta | Bignoniaceae | Campsidium | Campsidium valdivianum (Phil) Skottsb |
| 19 | Magnoliophyta | Convolvulaceae | Dichondra | Dichondra sericea Sw. |
| 20 | Magnoliophyta | Elaeocarpaceae | Aristotelia | Aristotelia chilensis (Molina) Stuntz |
| 21 | Magnoliophyta | Ericaceae | Gaultheria | Gaultheria insana (Molina) DJ Middleton |
| 22 | Magnoliophyta | Escalloniaceae | Escallonia | Escallonia pulverulenta (Ruiz & Pav.) Pers. |
| 24 | Magnoliophyta | Fabaceae | Acacia | Acacia caven (Molina) Molina |
| 25 | Magnoliophyta | Fabaceae | Acacia | Acacia dealbata Link |
| 26 | Magnoliophyta | Fabaceae | Robinia | Robinia pseudoacacia L |
| 27 | Magnoliophyta | Fabaceae | Teline | Teline monspessulana (L) K Koch |
| 28 | Magnoliophyta | Fabaceae | Vicia | Vicia sativa L. |
| 29 | Magnoliophyta | Geraniaceae | Geranium | Geranium berteroanum Colla |
| 30 | Magnoliophyta | Geraniaceae | Geranium | Geranium pusillum L |
| 31 | Magnoliophyta | Grossulariaceae | Ribes | Ribes punctatum Ruiz & Pav |
| 32 | Magnoliophyta | Lamiaceae | Teucrium | Teucrium bicolor Sm. |
| 33 | Magnoliophyta | Lauraceae | Cryptocarya | Cryptocarya alba (Molina) Looser |
| 34 | Magnoliophyta | Lauraceae | Persea | Persea lingue (Ruiz & Pav.) Nees |
| 35 | Magnoliophyta | Monimiaceae | Peumus | Peumus boldus Molina |
| 36 | Magnoliophyta | Myrtaceae | Amomyrtus | Amomyrtus luma (Molina) D Legrand & Kausel |
| 37 | Magnoliophyta | Myrtaceae | Eucalyptus | Eucalyptus globulus Labill |
| 38 | Magnoliophyta | Myrtaceae | Luma | Luma apiculata (DC.) Burret |
| 39 | Magnoliophyta | Myrtaceae | Ugni | Ugni molinae Turcz |
| 40 | Magnoliophyta | Nothofagaceae | Nothofagus | Nothofagus glauca (Phil.) Krasser |
| 41 | Magnoliophyta | Polygonaceae | Muehlenbeckia | Muehlenbeckia hastulata (Sm.) I.M. Johnst. |
| 42 | Magnoliophyta | Proteaceae | Gevuina | Gevuina avellana Molina |
| 43 | Magnoliophyta | Proteaceae | Lomatia | Lomatia hirsuta (Lam.) Diels |
| 44 | Magnoliophyta | Rosaceae | Acaena | Acaena ovalifolia Ruiz & Pav |
| 45 | Magnoliophyta | Rosaceae | Crataegus | Crataegus oxyacantha L. |
| 46 | Magnoliophyta | Rosaceae | Rosa | Rosa rubiginosa L |
| 47 | Magnoliophyta | Rubiaceae | Galium | Galium aparine L |
| 48 | Magnoliophyta | Salicaceae | Azara | Azara integrifolia Ruiz & Pav |
| 49 | Magnoliophyta | Scrophulariaceae | Verbascum | Verbascum virgatum Stokes | Hierba bianual |
| 50 | Magnoliophyta | Vitaceae | Cissus | Cissus striata Ruiz & Pav |
| 51 | Pinophyta | Pinopsida | Pinaceae | Pinus | Pinus radiata D Don |
| 52 | Pteridophyta | Polypodiopsida | Blechnaceae | Blechnum | Blechnum hastatum Kaulf |
...
|----|---------|--------|--------|
| Acacia caven (Molina) Molina | AC |
| Acacia dealbata Link | AD |
| Aextoxicon punctatum Ruiz & Pav. | AP |
| Amomyrtus luma (Molina) D Legrand & Kausel | AL |
| Aristotelia chilensis (Molina) Stuntz | ACh |
| Crataegus oxyacantha L. | CO |
| Cryptocarya alba (Molina) Looser | CA |
| Eucalyptus globulus Labill | EG |
| Gevuina avellana Molina | GA |
| Lithrea caustica (Molina) Hook & Arn | LC |
| Lomatia hirsuta (Lam.) Diels | LH |
| Luma apiculata (DC.) Burret | LA |
| Muehlenbeckia hastulata (Sm.) I.M. Johnst. | MH |
| Nothofagus glauca (Phil.) Krasser | NG |
| Persea lingue (Ruiz & Pav.) Nees | PL |
| Peumus boldus Molina | PB |
| Pinus radiata D Don | PR |
| Robinia pseudoacacia L | RP |
| Schinus polygamus (Cav) Cabrera | SP |
| Azara integrifolia Ruiz & Pav | Ai |
| Baccharis obovata Hook & Arn | Bo |
| Campsidium valdivianum (Phil) Skottsb | Cv |
| Escallonia pulverulenta (Ruiz & Pav.) Pers. | EP |
| Gaultheria insana (Molina) DJ Middleton | Gi |
| Podanthus ovatifolius Lag | Po |
| Proustia cuneifolia D. Don | Pr |
| Proustia pyrifolia DC. | Pp |
| Ribes punctatum Ruiz & Pav | Rp |
| Rosa rubiginosa L | Rr |
| Teline monspessulana (L) K Koch | Tm |
| Teucrium bicolor Sm. | Tb |
| Ugni molinae Turcz | Um |
| Acaena ovalifolia Ruiz & Pav | ao |
| Avena barbata Pott ex Link | ab |
| Blechnum hastatum Kaulf | bh |
| Chusquea quila Kunth | cq |
| Cirsium vulgare (Savi) Ten | cv |
| Cissus striata Ruiz & Pav | cs |
| Dichondra sericea Sw. | ds |
| Dioscorea humifusa Poepp. | dh |
| Galium aparine L | ga |
| Geranium berteroanum Colla | gb |
| Geranium pusillum L | gp |
| Greigia sphacelata (Ruiz & Pav) Regel | gs |
| Hypochaeris radicata L | hr |
| Lapageria rosea Ruiz & Pav | lr |
| Silybum marianum (L.) Gaertn. | si |
| Sisyrinchium sp. | ss |
| Verbascum virgatum Stokes | vv |
| Vicia sativa L. | vs |
| Vulpia myuros (L.) C.C.Gmel. | vm |
...
|-------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| Liliopsida | Bromeliaceae | Greigia sphacelata (Ruiz & Pav) Regel |
| Dioscoreaceae | Dioscorea humifusa Poepp. |
| Iridaceae | Sisyrinchium sp. |
| Philesiaceae | Lapageria rosea Ruiz & Pav |
| Poaceae | Avena barbata Pott ex Link |
| Poaceae | Chusquea quila Kunth |
| Poaceae | Vulpia myuros (L.) C.C.Gmel. |
| Magnoliopsida | Aextoxicaceae | Aextoxicon punctatum Ruiz & Pav. |
| Anacardiaceae | Lithrea caustica (Molina) Hook & Arn |
| Schinus polygamus (Cav) Cabrera |
| Asteraceae | Baccharis obovata Hook & Arn |
...
| Bignoniaceae | Campsidium valdivianum (Phil) Skottsb |
| Convolvulaceae | Dichondra sericea Sw. |
| Elaeocarpaceae | Aristotelia chilensis (Molina) Stuntz |
| Ericaceae | Gaultheria insana (Molina) DJ Middleton |
| Escalloniaceae | Escallonia pulverulenta (Ruiz & Pav.) Pers. |
| Fabaceae | Acacia caven (Molina) Molina |
| Acacia dealbata Link |
| Robinia pseudoacacia L |
| Teline monspessulana (L) K Koch |
| Vicia sativa L. |
| Geraniaceae | Geranium berteroanum Colla |
| Geranium pusillum L |
| Grossulariaceae | Ribes punctatum Ruiz & Pav |
| Lamiaceae | Teucrium bicolor Sm. |
| Lauraceae | Cryptocarya alba (Molina) Looser |
| Persea lingue (Ruiz & Pav.) Nees |
| Monimiaceae | Peumus boldus Molina |
| Myrtaceae | Amomyrtus luma (Molina) D Legrand & Kausel |
| Eucalyptus globulus Labill |
| Luma apiculata (DC.) Burret |
| Ugni molinae Turcz |
| Nothofagaceae | Nothofagus glauca (Phil.) Krasser |
| Polygonaceae | Muehlenbeckia hastulata (Sm.) I.M. Johnst. |
| Proteaceae | Gevuina avellana Molina |
| Lomatia hirsuta (Lam.) Diels |
| Rosaceae | Acaena ovalifolia Ruiz & Pav |
| Crataegus oxyacantha L. |
| Rosa rubiginosa L |
| Rubiaceae | Galium aparine L |
| Salicaceae | Azara integrifolia Ruiz & Pav |
| Scrophulariaceae | Verbascum virgatum Stokes |
| Vitaceae | Cissus striata Ruiz & Pav |
| Pinopsida | Pinaceae | Pinus radiata D Don |
| Polypodiopsida | Blechnaceae | Blechnum hastatum Kaulf |
...
| Aextoxicon punctatum Ruiz & Pav. | DS 79/2018 |
...
| Nothofagus glauca (Phil.) Krasser | Casi amenazada (NT) | DS 42/2011 MMA | VU |
| Persea lingue (Ruiz & Pav.) Nees | DS 42/2011 MMA | VU (Persea meyeniana) |
