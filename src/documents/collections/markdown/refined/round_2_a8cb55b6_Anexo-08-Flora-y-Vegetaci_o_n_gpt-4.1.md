...
| 9 | Flora Potencial de acuerdo a las formaciones descritas por Luebert y Pliscoff (2017) |
...
| 13-21 | Diversas tablas con información taxonómica, abundancia, tipos biológicos, origen geográfico, estado de conservación, singularidades ambientales, listado taxonómico de especies identificadas, etc. |
...
- Figura 8. Fotografías correspondientes a la Unidad de “Matorral con suculentas de Proustia cuneifolia y Colliguaja odorífera con Trichocereus chiloensis” identificada en el Área de Influencia del Proyecto.
- Figura 9. Fotografías correspondientes a la Unidad de “Terrenos Agrícolas” identificada en el Área de Influencia del Proyecto.

---

# 1. INTRODUCCIÓN

En el presente informe se presentan los resultados que caracterizan al componente Flora y Vegetación como parte de la caracterización ambiental asociada al Área de Influencia del “Proyecto Solar Zaturno”, en adelante “el Proyecto”, ubicado 27 km al Noreste de la ciudad de Antofagasta, Región del Antofagasta.

Para este efecto, se realizó el levantamiento de información mediante una campaña de terreno realizada el día 28 de febrero del 2020.
...
El área de influencia se encuentra en la comuna de Antofagasta, 27 km al Noreste de la zona urbana, Región de Antofagasta.

Según el Reglamento del SEIA (D.S. N° 40/12), el área de influencia (AI) se define como: “El área o espacio geográfico, cuyos atributos, elementos naturales o socioculturales deben ser considerados con la finalidad de definir si el proyecto o actividad genera o presenta alguno de los efectos, características o circunstancias del artículo 11 de la Ley, o bien para justificar la inexistencia de dichos efectos, características o circunstancias”.

El área de influencia para el componente flora y vegetación corresponde a las áreas que serán directamente intervenidas por las obras, partes y acciones del Proyecto que en sus distintas fases pueden afectar a la flora y vegetación.

La zona de emplazamiento de los paneles solares comprende un área de 29,7 ha, mientras que la línea de conexión tiene una extensión de 1,9 km. El área de influencia corresponde a las superficies que serán ocupadas por el Proyecto propiamente tal, determinada por la superficie de afectación por causa de las obras del Proyecto correspondiente a la Línea de Transmisión y Estructuras, contemplando además una franja de seguridad de 15,5 metros hacia cada lado de la línea. Adicionalmente se ha considerado una zona buffer a dicha franja de 50 metros en ambos lados, comprendiendo una superficie total de 55,2 ha. La distribución espacial del área de influencia se muestra en la **Figura 1**.
...
La metodología utilizada para determinar el marco biogeográfico donde se emplazará el proyecto, los ambientes vegetacionales y la flora potencial, se realizó en primera instancia un trabajo de gabinete a través de la recopilación de antecedentes bibliográficos en base a las clasificaciones vegetacionales existentes en la literatura. Para ello se consultó la “Vegetación Natural de Chile: Clasificación y Distribución geográfica” (Gajardo, 1994) y “Sinopsis Bioclimática y Vegetacional de Chile” (Luebert y Pliscoff, 2017), con el área de influencia.

La clasificación propuesta por Gajardo (1994), desarrollada a partir de criterios biogeográficos y antecedentes de terreno, establece una clasificación de tipo jerárquico para la vegetación potencial de Chile con cuatro niveles de agregación: a) Región ecológica; b) Subregión ecológica; c) Formación vegetal; d) Comunidad tipo.
...
La metodología utilizada para describir y caracterizar la Flora y vegetación en el presente documento considera adaptaciones a los protocolos metodológicos propuestos por la Guía para la descripción de los componentes suelo, flora y fauna de ecosistemas terrestres en el SEIA (SEA, 2015).
...
Para el área de influencia se verificó la eventual existencia de formaciones vegetacionales contempladas en Ley 20.283 del MINAGRI, la que en su Artículo N°2, establece 6 tipos de Formaciones Vegetacionales a considerar en el desarrollo de cualquier tipo de actividad:
...
En el contexto vegetacional, según Gajardo (1994) el proyecto se localiza en la Región del Desierto, subregión del Desierto Absoluto, específicamente en la formación del desierto interior. El área de estudio se encuentra en las cercanías de la zona de transición de esta formación con la del desierto costero de Tocopilla.
...
De acuerdo con los autores Luebert & Pliscoff (2017), el Piso Vegetacional respectivo correspondería al “Desierto tropical interior con vegetación escasa” y contenido en la formación “Desierto Absoluto”. Este Piso se encuentra en la zona de transición con el piso “Matorral desértico tropical mediterráneo costero de Ephedra breana y Eulychnia iquiquensis”, el que encuentra al Oeste del área de influencia.
...
#### Tabla 10. Flora Potencial de acuerdo a las formaciones descritas por Luebert y Pliscoff (2017)
...
Respecto al uso de suelos identificaron Otros Usos de suelo correspondiente a caminos de servicio. En la siguiente tabla se presentan las superficies de las unidades identificadas.
...
|-------|--------------------------|------------------------------------------|-----------------------------------------|
| 1 | Desierto Absoluto | 46,78 | 84,7% |
| 2 | Caminos | 8,42 | 15,3% |
| Total | | 54 | 100% |
...
En la tabla anterior, se aprecia que el 84,7% del área e influencia se encuentra en una zona de desierto absoluto. Dicha unidad corresponde a un área totalmente desprovista de vegetación, con suelo desnudo y pedregosidad variable.

**Caminos**

Le sigue en importancia la unidad de “caminos”, los que representaron un área menor en el uso de suelos del área de influencia y se encuentra asociada a un porción del área de la línea de conexión eléctrica del proyecto.
...
La diversidad Florística presente en el área de influencia se determinó mediante la realización de 14 puntos de muestreo (**Tabla 12**) dentro del área de influencia del Proyecto abarcando la mayor cantidad de ambientes y/o unidades Vegetacionales. Las coordenadas de cada punto de muestreo se presentan a continuación (**Figura 8**).
...
| Punto | Coordenadas (WGS 1984, Huso 19S) | Este | Norte |
|-------|-----------------------------------|------|-------|
| P01 | 375737 | 7403749 |
| P02 | 375855 | 7403701 |
| P03 | 376062 | 7403609 |
...
|----------------------------|----------------------------------------------------|
| Presencia de formaciones vegetales únicas o de baja representatividad nacional | No se identificó |
| Presencia de formaciones vegetales relictuales | No se identificó |
| Presencia de formaciones vegetales remanentes. | No se identificó |
| Presencia de formaciones vegetales frágiles cuya existencia se ve amenazada por escasez de recursos o fenómenos poblacionales que restringen su crecimiento y mantención en el tiempo | No se identificó |
| Presencia de bosque nativo de preservación o formaciones xerofíticas que contienen especies clasificadas según su estado de conservación de acuerdo a lo estipulado en la Ley N°19.300. | No se identificó |
| Presencia de especies vegetales que están bajo protección oficial. | No se identificó |
| Presencia de especies clasificadas según su estado de conservación como amenazadas, incluyendo la categoría de “casi amenazadas”. | No se identificó |
| Presencia de especies endémicas. | No se identificó |
| Presencia de especies de distribución restringida o cuya población es reducida o baja en número. | No se identificó |
| Actividad del proyecto que se localiza en o cercana al límite de distribución geográfica de una o más especies nativas (latitudinal o altitudinal). | No se identificó |
| Actividad del proyecto que se localiza en o colindante a un sitio prioritario para la conservación de la biodiversidad. | No se identificó |
| Actividad del proyecto que se localiza en o colindante a área bajo protección oficial. | No se identificó |
| Actividad del proyecto que se localiza en o colindante a área protegida privada. | No se identificó |
| Presencia de árboles y arbustos aislados ubicados en lugares específicos del territorio, identificados según decretos dictados de conformidad al artículo 4 de la Ley N° 18.378. | No se identificó |
| Presencia de un ecosistema amenazado. | No se identificó |
| Otras singularidades ambientales identificadas en terreno. | No se identificaron otras singularidades ambientales en el área de influencia del proyecto. |
...
El Área de Influencia del proyecto se encuentra inserta en el piso vegetacional de “Desierto tropical interior con vegetación escasa” según Luebert y Pliscoff (2017) y en la formación del “Desierto interior” de Gajardo (1994). Ambas clasificaciones caracterizadas por una vegetación prácticamente ausente, con excepciones puntuales y poco frecuentes. De acuerdo con estas categorizaciones, se observó en terreno una total ausencia de formaciones vegetacionales tanto al interior como en la periferia del área de influencia, el cual se encuentra en una matriz de desierto absoluto.

Respecto al uso del suelo, solo es posible, dado la nula presencia de vegetación, hacer referencia respecto a la superficie ocupada por el desierto absoluto (46,78 ha) y a caminos (8,42 ha) y no a unidades vegetacionales.

Con relación a la composición florística observada en el área de influencia, no se observaron especies vegetales en ninguno de los 14 puntos de muestreo de flora definidos.
