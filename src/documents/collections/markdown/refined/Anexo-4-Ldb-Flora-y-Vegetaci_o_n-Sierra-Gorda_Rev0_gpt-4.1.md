...
En el marco de elaboración de la Declaración de Impacto Ambiental (DIA) del Proyecto Fotovoltaico La Sierra (en adelante el Proyecto), ubicado a 3,5 km al este de la comuna de Sierra Gorda, en la Región de Antofagasta, el titular del proyecto El Cóndor Solar SpA ha realizado una caracterización ambiental del componente flora y vegetación para un área de estudio definida por el límite predial, el cual considera una superficie de 62,9 hectáreas más su respectiva línea de evacuación y camino de acceso.

El Proyecto corresponde a la construcción y operación de un Parque Fotovoltaico con una potencia instalada de 9 MW y su respectiva línea de evacuación de media tensión, destinadas a la generación de energía eléctrica y posterior inyección de ésta al Sistema Eléctrico Nacional (SEN).
...
- Evaluar la existencia de especies que de acuerdo a la normativa vigente, presenten problemas de conservación, como también aquellas de importancia ecológica y/o científica para los sectores involucrados en el área de influencia.

## 3. Área de estudio

Para efectos del presente análisis se definió un área de estudio correspondiente a la totalidad del predio, el cual abarca una superficie de 62,9 hectáreas, mientras que el área a utilizar de manera efectiva por el proyecto corresponde a 25,9 hectáreas.
...
Por lo tanto, se ha definido como área de influencia (AI) del proyecto, a la porción de terreno en la que se procederá a construir el proyecto fotovoltaico, la cual abarca una superficie de 18 ha. Se ubica en un sector de topografía plana, con suaves relieves y bajas depresiones.

<figure>
<figcaption>Figura 1. Área de Estudio</figcaption>

[Mapa con coordenadas y leyenda del área de estudio, caminos de acceso, LMT, área de proyecto y predio. Proyección: UTM. Datum: WGS 84, Huso 19S. Escala 1:45.000]
...
La descripción de la vegetación asociada a cada área del proyecto se realizó mediante transectos sobre los cuales se hizo un recorrido pedestre, cubriendo la totalidad de las áreas que componen el Proyecto. Adicionalmente, se definieron parcelas de caracterización de la vegetación.
...
| Código COT | Cobertura vegetal | Descripción     |
|------------|------------------|-----------------|
| 7          | 100%             | Muy Denso       |
| 6          | 90%              | Denso           |
| 5          | 75%              | Poco Denso      |
...
|---------------|---------------------------|------------|
| Leñoso Alto   | Kageneckia angustifolia   | KA         |
| Leñoso Bajo   | Proustia cuneifolia       | Pc         |
| Suculentas    | Pozoa coriacea            | PC         |
| Herbáceo      | Pyrrhocactus curvspinus   | Pc         |
...
| Leñoso alto-leñoso bajo- herbáceo              | Bosque                                   |
| Leñoso alto                                    | Bosque                                   |
...
A continuación, se presenta el listado de especies potenciales que de acuerdo a la prospección bibliográfica, se podrían encontrar en el área de influencia del Proyecto (Tabla 2):

| Nombre científico         | Nombre común                        | Origen  | Categoría vigente |
|--------------------------|-------------------------------------|---------|-------------------|
| Atriplex atacamensis     | cachiyuyo                           | Nativa  | EN                |
| Tessaria absinthioides   | Brea, Chilquilla, Soroma, Peril     | Nativa  | No Indicado       |
| Pleocarphus revolotus    | cola de ratón                       | Nativa  | No Indicado       |

### 5.2. Vegetación

El proyecto se localiza en la comuna de Sierra Gorda, en la región de Antofagasta y de acuerdo a lo señalado por el Catastro de Bosque Nativo elaborado por CONAF (1997) el sector donde se instalarán las obras corresponde a un área sin vegetación (Figura 4).

<figure>
<figcaption>Figura 4. Catastro de usos de suelo (CONAF, 1999).</figcaption>

[Mapa con coordenadas y leyenda de áreas sin vegetación, caminos de acceso, LMT, área de estudio y área de proyecto. Proyección: UTM. Datum: WGS 84, Huso 19S. Escala 1:80.000]
...
[Mapa con coordenadas y leyenda de pisos vegetacionales, caminos de acceso, LMT, área de estudio y área de proyecto. Proyección: UTM. Datum: WGS 84, Huso 19S. Escala 1:60.000]
...
Se recorrió la totalidad del área de proyecto de manera pedestre y se realizaron 65 parcelas en la totalidad del predio, el camino de acceso y la línea de media tensión a construir (Figura 6).

<figure>
<figcaption>Figura 6. Ubicación parcelas de muestreo</figcaption>

[Mapa con coordenadas y leyenda de parcelas de muestreo, caminos de acceso, LMT, área de estudio y área de proyecto. Proyección: UTM. Datum: WGS 84, Huso 19S. Escala 1:60.000]
...
[Fotografía del ambiente en el área de proyecto]
