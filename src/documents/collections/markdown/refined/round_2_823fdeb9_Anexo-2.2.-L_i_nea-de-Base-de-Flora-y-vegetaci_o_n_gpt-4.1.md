...
**Teléfono:** +56 222047671  
**Correo:** contacto@csw.cl
...
3. Área de estudio ............................................................................................................. 3
4. Determinación de impactos preliminares sobre el componente ................................. 4
5. Metodología .................................................................................................................. 4
   5.1 Caracterización bibliográfica ................................................................................. 5
   5.2 Flora ..................................................................................................................... 5
   5.3 Vegetación ........................................................................................................... 6
      5.3.1 Descripción en terreno ............................................................................. 6
      5.3.2 Clasificación de la vegetación ................................................................. 8
      5.3.3 Elaboración de cartografía ..................................................................... 8
   5.4 Identificación de singularidades ambientales ...................................................... 9
6. Resultados .................................................................................................................. 10
   6.1 Caracterización bibliográfica .............................................................................. 10
      6.1.1 Flora ....................................................................................................... 10
      6.1.2 Vegetación ............................................................................................. 11
   6.2 Campaña de terreno ......................................................................................... 12
      6.2.1 Esfuerzo de muestreo ............................................................................ 12
      6.2.2 Flora ...................................................................................................... 13
      6.2.3 Vegetación ............................................................................................. 13
   6.3 Singularidades ambientales ............................................................................... 14
   6.4 Evaluación de impactos ..................................................................................... 14
7. Conclusiones ............................................................................................................... 15
8. Bibliografía .................................................................................................................. 16
...
En el marco de la elaboración de la Declaración de Impacto Ambiental (DIA) del Proyecto Fotovoltaico Dolores (en adelante el Proyecto), ubicado a 48 km al norte de Huara, Grenergy requiere desarrollar una caracterización ambiental del sector de emplazamiento del mismo.

El Proyecto corresponde a la construcción y operación de un Parque Fotovoltaico con una potencia instalada de 9 MW, destinadas a la generación de energía eléctrica y posterior inyección de ésta al Sistema Eléctrico Nacional (SEN).
...
El presente informe contiene la caracterización y línea base ambiental para el componente, con el objetivo de poder identificar si es que se encuentra presente alguna característica de flora relevante que pudiese requerir algún tipo de modificación a lo proyectado, se procedió a recorrer de manera pedestre el área de proyecto. Esta actividad se realizó el día 16 de mayo.

---

## 2. Objetivo

El objetivo del documento es caracterizar la flora y vegetación del área donde se construirá la Planta Fotovoltaica.
...
Por lo tanto, se ha definido como área de influencia (AI) del proyecto, a la porción de terreno en la que se procederá a construir el proyecto fotovoltaico, la cual abarca una superficie de 28,83 ha. Se ubica en un sector de topografía plana, con suaves relieves y bajas depresiones.

Actualmente dentro del AI no se registra ningún tipo de actividad.

---

## 4. Determinación de impactos preliminares sobre el componente

A modo preliminar se pueden mencionar algunos impactos sobre los componentes flora y vegetación a consecuencia de la ejecución del proyecto, los cuales una vez evaluados, se determinará la real magnitud de los impactos:
...
El estado de conservación se determinará siguiendo las directrices de los decretos supremos del Ministerio de Medio Ambiente en el marco del “Proceso de Clasificación de Especies”, que oficializan del primer al decimotercer proceso de clasificación de especies, dictados según lo establecido en el Reglamento de Clasificación de Especies Silvestres (D.S. N° 75 del MINSEGPRES 2004, reemplazado por el D.S. N° 29 del MMA). Específicamente, los decretos aludidos son:
...
### 5.4 Identificación de singularidades ambientales
...
### 6.1 Caracterización bibliográfica

#### 6.1.1 Flora

A continuación, se presenta el listado de especies potenciales encontrados en el área de influencia del Proyecto:

**Tabla 2. Listado potencial de especies vegetales en el área de estudio.**

| Nombre científico                        | Nombre común   | Origen | Forma de vida | Fuente                        |
|------------------------------------------|----------------|--------|---------------|-------------------------------|
| *Atriplex atacamensis* Phil.             | Cachiyuyo      | Nativa |               | EIA Pampa Solar (RCA 49/2015) |
| *Prosopis tamarugo* Phil.                | Tamarugo       |        | Árbol         | Pampa Solar (RCA 49/2015)     |
| *Nolana leptophylla* (Miers) I.M. Johnst.| Nolana         |        |               | Pampa Solar (RCA 49/2015)     |
| *Tessaria absinthioides* (Hook. et Arn.) DC. | Brea, soroma | Nativa |               | Luebert y Pliscoff (206)      |
| *Caesalpinia aphylla* Phil.              | Retamo         |        |               | Planta Solar Pintados (RCA 93/2014) |
| *Schinus molle* L.                       | Molle          | Nativa | Árbol         |                               |
| *Prosopis alba* Griseb.                  | -              | Nativa |               |                               |
| *Malesherbia tenuifolia* D. Don          | -              |        | Sub arbusto   |                               |
| *Cristaria dissecta* (Hook. et Arn.)     | -              |        | Herbácea      |                               |
| *Cisthante amaranthoides* Phil.          | -              |        | Suculenta     |                               |
| *Nolana foliosa* (Phil.) I.M. Johnst.    | -              |        |               |                               |

#### 6.1.2 Vegetación

El área del Proyecto se ubica en la comuna de Huara, en la provincia del Tamarugal, en la Región de Tarapacá. Desde la perspectiva geomorfológica, ésta se encuentra en la región Septentrional de las pampas desérticas y cordilleranas pre altiplánicas, en la unidad morfoestructural Pampa del Tamarugal, en la zona Depresión intermedia (Börgel, 1983). De acuerdo al Catastro y Evaluación de los Recursos Vegetacionales Nativos de Chile (CONAF), el Proyecto se encuentra en su totalidad sobre el uso de suelo “Otros sin vegetación”.

Por otra parte, de acuerdo a Luebert y Pliscoff (2017), el proyecto se emplaza en la formación vegetacional Desierto tropical interior con vegetación escasa. Se encuentra en los pisos bioclimáticos mesotropical ultrahiperárido y supratropical inferior ultrahiperárido hiperocéanico. Corresponde a un piso de vegetación que carece casi completamente de vida vegetal, excepto en algunos sectores con presencia de napa subterránea salobre donde se observa un matorral halófilo dominado por *Tessaria absinthioide*. Es posible que existan otras comunidades vegetales, pero el conocimiento botánico sobre estas áreas está muy poco desarrollado en Chile, por lo que no se dispone de información sobre la composición florística (Luebert & Pliscoff, 2017).

### 6.2 Campaña de terreno

#### 6.2.1 Esfuerzo de muestreo

Se realizaron 30 transectos horizontales de largo variable en el área de influencia del Proyecto, con una longitud total de 11,04 km. Al mismo tiempo, se realizaron 10 parcelas de muestreo para caracterizar la vegetación.
...
### 6.3 Singularidades ambientales

De acuerdo a los antecedentes bibliográficos revisados, respecto a la caracterización del contexto vegetal y florístico del área donde se desarrollará el Proyecto, en conjunto con los hallazgos del trabajo de terreno, no existen singularidades ambientales para el componente flora y vegetación, sensibles ante la ejecución del proyecto.

### 6.4 Evaluación de impactos

Dada la ausencia de individuos de especies vegetales y singularidades ambientales de flora y vegetación de acuerdo a lo observado en terreno, es posible señalar que, a consecuencia de la ejecución del proyecto, no se generarán impactos sobre el componente flora y vegetación dentro del área de influencia, ya que corresponde a un sector desértico, carente en lo absoluto de flora y vegetación.

---

## 7. Conclusiones

El área de proyecto Fotovoltaico Dolores, comuna de Huara, en la provincia del Tamarugal, en la Región de Tarapacá. Desde la perspectiva geomorfológica, ésta se encuentra en la región Septentrional de las pampas desérticas y cordilleranas pre altiplánicas, en la unidad morfoestructural Pampa del Tamarugal, en la zona Depresión intermedia, inserta en áreas desérticas, de terreno planos, con suaves relieves y depresiones, y de fácil acceso.

El recorrido pedestre en la totalidad del área de influencia del Proyecto permite concluir que se trata de una zona desértica carente de vegetación.
