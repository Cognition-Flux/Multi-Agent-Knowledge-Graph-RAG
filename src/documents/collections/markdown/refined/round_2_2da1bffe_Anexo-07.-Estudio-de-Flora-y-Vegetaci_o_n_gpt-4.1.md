...
## “PROYECTO EXTRACCIÓN Y PROCESAMIENTO DE ÁRIDOS RÍO MAULE”
...
- Tabla 1. Ubicación georreferenciada del área de cuñas de extracción. ................................. 7
- Tabla 2. Ubicación georreferenciada del área de Instalación de Faenas. .............................. 8
- Tabla 3. Claves de codificación según el espectro biológico de las especies ....................... 11
- Tabla 4. Categorías de recubrimiento y codificación. .......................................................... 12
- Tabla 5. Codificación de las especies dominantes ................................................................ 12
- Tabla 6. Grado de artificialización ........................................................................................ 12
- Tabla 7. Regiones Vegetacionales en Chile........................................................................... 20
- Tabla 8. Resultados Carta de Ocupación de Tierras. ............................................................ 23
- Tabla 9. Especies dominantes descritas en la COT. .............................................................. 23
- Tabla 10. Listado de especies vegetales registradas en el área de estudio. ........................ 25

## ÍNDICE DE FIGURAS

- Figura 1. Ubicación geográfica del área de estudio Región del Maule. ................................. 6
- Figura 2. Área del proyecto (Polígono Total) .......................................................................... 7
- Figura 3. Área de influencia del proyecto. ............................................................................ 19
...
- Figura 8. Origen de especies vegetales registradas en el área de estudio. .......................... 26

---

## 1. INTRODUCCIÓN

La línea de base consiste en la descripción detallada del área de influencia de un proyecto o actividad, en forma previa a su ejecución. Además, constituye uno de los contenidos mínimos exigidos por la Ley N°19.300, sobre Bases Generales del Medio Ambiente, para la elaboración de Estudios de Impacto Ambiental, lo cual permite evaluar los impactos que pudiesen generarse o presentarse sobre los elementos del medio ambiente.

La caracterización de la línea base del área de influencia del proyecto incluye la descripción de las formaciones vegetales y la determinación de especies de flora nativa presentes en el área de emplazamiento del proyecto, con el objeto de evaluar los posibles impactos generados por el proyecto dicho componente, considerando el estado de conservación de las especies, rango de distribución, abundancia y endemismo, así como la presencia de áreas bajo protección oficial.
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Extracción y Procesamiento de Áridos Río Maule”.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Extracción y Procesamiento de Áridos Río Maule”.
...
El proyecto “Extracción y Procesamiento de Áridos Río Maule” se emplazará en dos comunas; esto dado que las cuñas de extracción abarcan tanto la comuna de San Javier, provincia de Linares, como la comuna de Maule, provincia de Talca, ambas de la región del Maule.
...
- Carta:
- Escala: 1:21.000
- Simbología: VÉRTICES POLIGONO DEL PROYECTO
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia.*

### Tabla 1. Coordenadas polígonos cuñas de extracción.

| Vértice | Coordenadas UTM Datum WGS84 18H | Norte | Este |
|--------|-----------------------------------|-------|------|
| C1     |                                   | 6059890 | 262254 |
| C2     |                                   | 6060224 | 261988 |
| C3     |                                   | 6060309 | 261848 |
...
### Tabla 2. Coordenadas polígono del área de Instalación de Faenas y pozo lastrero.
...
Las actividades en terreno se ejecutaron durante el día 1 de octubre de 2018, se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
En este sentido, la descripción de la vegetación y del ambiente, mediante la COT, involucra la evaluación de tres criterios: formación vegetal, especies dominantes y el grado de artificialización, además de describir la riqueza florística del área de estudio.
...
Disposición vertical en la comunidad. Se utilizan los 4 tipos biológicos como base en la definición de la estratificación (Tabla 3).
...
Se define en función de la proyección del área ocupada por la vegetación (Tabla 4).
...
La segunda variable se trabajó con las especies dominantes: la dominancia se establece por comparación con un valor umbral, variable según la región ecológica (Tabla 5).
...
Para la componente Flora y Vegetación el Área de Influencia de este proyecto está definida como la superficie que coincide con la totalidad del terreno a utilizar para la construcción y operación del proyecto junto a una proyección de 100 metros:
...
- Carta:
- Escala: 1:21.000
- Simbología: ÁREA DE INFLUENCIA DEL PROYECTO
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia.*
...
Debido a que esta es la zona del país con mayor población, el paisaje original ha sido modificado en gran parte siendo difícil encontrar muestras de vegetación inalteradas. Debido a las alteraciones humanas, principalmente plantaciones forestales, actualmente la vegetación natural de esta zona se presenta en forma de renuevos por monte bajo. La forma de vida predominante son los arbustos espinosos, del tipo suculento o caducifolio de verano. La delimitación de esta sub‐región sigue patrones muy similares a los de las especies; Espino (*Acacia caven*), Algarrobo (*Prosopis chilensis*).

Particularmente en la región, este tipo forestal ha ocupado de preferencia una gran proporción de los terrenos planos y lomajes suaves, por lo cual históricamente, ha sido talado para establecer siembras agrícolas, viñedos, terrenos para la crianza de ganado y asentamientos humanos. De esta forma, en la actualidad el área de estudio presenta también una porción importante de terrenos agrícolas o de cultivo y matorral. Además, cabe mencionar que la zona estudiada perteneciente al área de influencia del proyecto, es un lugar altamente intervenido, ubicándose en una zona urbana.

Por otra parte, de acuerdo a la clasificación de Luebert y Pliscoff (2004) el área del proyecto se ubica en el piso vegetacional del Bosque esclerófilo dominado por *Lithrea caustica* y *Peumus boldus* en el dosel superior y con presencia más ocasional de *Quillaja saponaria* y *Cryptocarya alba*, pero que generalmente asume la forma de un matorral arborescente producto de la fuerte extracción que ha sufrido. La estrata arbustiva está conformada por *Satureja gilliesii*, *Podanthus mitiqui*, *Colletia hystrix* y *Retanilla trinervis*, gramíneas y algunas geófitas en la estrata herbácea. Incluye las asociaciones de *Lithrea caustica*-*Peumus boldus* como comunidad típica y *Chusquea cumingiii* con menor frecuencia. La vegetación azonal se compone de los bosques pantanosos de Mirtáceas con Crinodendron patagua en zonas pantanosas y cursos de agua, que en algunos lugares es reemplazada por comunidades de *Pluchea absinthioides*-*Baccharis pingraea*, con un carácter ruderal.

La Composición florística incluye especies como: Alstroemeria revoluta, *Aristotelia chilensis*, *Baccharis linearis*, *Baccharis rhomboidalis*, *Calceolaria dentata*, *Chusquea cumingii*, *Colletia hystrix*, *Colliguaja odorifera*, *Cryptocarya alba*, *Eryngium paniculatum*, *Escallonia pulverulenta*, *Gochnatia foliolosa*, *Lithrea caustica*, *Muehlenbeckia hastulata*, *Nassella chilensis*, *Peumus boldus*, *Podanthus mitiqui*, *Proustia pyrifolia*, *Quillaja saponaria*, *Retanilla trinervis*, *Ribes punctatum*, *Satureja gilliesii*, *Sophora macrocarpa* (Amigo et al. 2000).

La corta reiterada y la quema de vegetación produce un cambio en la fisionomía de la vegetación, desde un bosque a un matorral esclerófilo, donde el rebrote de las especies arbóreas dominantes con capacidad de regeneración vegetativa cambian de un hábito arbóreo a uno arbustivo, lo que va acompañado por la invasión de especies arbustivas propias de ambientes más secos como *Baccharis linearis*, *Muehlenbeckia hastulata* o *Retanilla trinervis*. La presión de pastoreo de estos ambientes lleva progresivamente a una pérdida de los elementos arbóreos característicos y a la incorporación de elementos del matorral espinoso de *Acacia caven*. Se ha planteado que la exclusión del pastoreo puede permitir la recuperación del bosque esclerófilo.
...
De esta forma y de acuerdo los antecedentes mencionados, en la actualidad el área de estudio presenta, principalmente terrenos de uso agrícola, siendo un lugar altamente intervenido por actividad humana.

### 6.3. Levantamiento de información en terreno

#### 6.3.1. Caracterización general del terreno

Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo de Uso Agrícola, el cual al momento de la visita se encuentra en un 60% con escasa vegetación, destacándose la unidad ambiental de caja de río, que cubre la mayor parte del área del proyecto (Figura 4).
...
- Carta:
- Escala: 1:8.000
- Simbología: CATASTRO VEGETACIONAL
- Ubicación Proyecto
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia*
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvo cuatro unidades ambientales: Infraestructura, Vegetación ribereña, Caja de Río y Río (Figura 5). Las observaciones en terreno muestran un área de estudio cubierta principalmente de aromo chileno (*Acacia dealbata*), en estado de renovales (regeneración por tocones), los cuales se encuentran intervenidos para la extracción de leña y afectados también por incendios forestales, acompañados de otras especies exóticas, como alamo (*Populos sp*.) y aromo australiano (*Acacia melanoxcylon*). Adicionalmente, dentro de los matorrales encontrados se observó la presencia de rosa mosqueta (*Rosa rubiginosa*).
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| Pradera agrícola | H | hr | AC | Pradera en desuso degradada, dominando especies herbáceas además de la presencia de ejemplares de *Acacia Caven* (Espino maulino). Herbáceo denso |
| Matorral | AD, AC, AM | Matorral de especies principalmente exóticas con presencia de ejemplares aislados de *Acacia caven*. Leñoso bajo, denso; Leñoso bajo, Semidenso; Leñoso alto, muy clara |
| Arenas | - | - | - | - |
| Río | - | - | - | - |
...
|---------------|-------------------|-------|
| Leñoso alto   | *Acacia caven*    | AC    |
| Leñoso alto   | *Acacia melanoxylon* | AM |
| Leñoso bajo   | *Acacia dealbata* | AD    |
| Herbáceo      | *Hypochaeris radicata* | hr |
...
- Carta:
- Escala: 1:10.000
- Simbología: CARTA OCUPACIÓN DE TIERRAS (COT)
- Pradera en desuso, Matorral denso, Matorral semidenso, Matorral muy claro, Arenas, Rio Maule
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia*
...
|             | *Acacia caven*         | Espino maulino       |            |            |
|             | *Psoralea glandulosa*  | Culén                | Arbustivo  | Endémica   |
|             | *Galega officinalis*   | Galega               |            |            |
|             | *Trifolium glomeratum* | Trébol               |            |            |
|             | *Lupinus microcarpus*  | Lupino               |            |            |
| Anacardiaceae | *Lithraea caustica*  | Litre                |            |            |
|             | *Schinus polygamus*    | Huingán              | Arbustivo  |            |
| Salicaceae  | *Polupus nigra*        | Álamo negro          |            |            |
|             | *Salix alba*           | Sauce blanco         |            |            |
| Rhamnaceae  | *Talguenea quinquinervia* | Tralhuén          | Arbustivo  |            |
| Rosaceae    | *Rubus ulmifolius*     | Zarzamora            | Arbustivo  |            |
| Asteraceae  | *Baccharis linearis*   | Romerillo            | Arbustivo  |            |
|             | *Cirsium vulgare*      | Cardo negro          |            |            |
|             | *Xanthium spinosum*    | Clonqui              |            |            |
|             | *Coleostephus myconis* | Margarita amarilla   |            |            |
| Juncaceae   | *Juncus procerus*      | Junco                |            |            |
| Polygonaceae| *Rumex acetosella*     | Vinagrillo           |            |            |
| Solanaceae  | *Datura stramonium*    | Chamico              | Introducida|            |
| Apiaceae    | *Daucus carota*        | Zanahoria silvestre  |            |            |
| Liliaceae   | *Pasithea coerulea*    | Azulillo             |            |            |
| Loranthaceae| *Tristerix corymbosus* | Quintral             | Parásito   |            |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto “Extracción y Procesamiento de Áridos Río Maule”, ubicado en las comunas de San Javier, en términos de diversidad y la presencia de especies de interés.
...
La flora y vegetación está compuesta principalmente por parches de vegetación mixta que incluye principalmente especies arbustivas de origen nativo e introducido como *Baccharis linearis* (Romerillo), y *Rubus ulmifolius* (Zarzamora) y *Acacia caven* (Espino maulino), además especies arbóreas introducidas como *Acacia dealbata* (Aromo), *Populus nigra* (Aromo), *Salix alba* (Sauce blanco), en conjunto con especies herbáceas de tipo maleza que se establecen rápidamente sobre grandes superficies. Mientras que en la zona de área de extracción asociada al curso de agua (río Maule) en donde predomina la especie herbácea *Juncus procerus* (Junco).

La mayoría de las especies reconocidas en terreno corresponden a especies introducidas (57%), consideradas plantas frecuentes y colonizadoras de rápido crecimiento, con un alto valor ornamental razón principal de su introducción en el territorio.

Sin embargo, el área evaluada y donde se proyecta las distintas actividades del Proyecto “Extracción y Procesamiento de Áridos Rio Maule”, si bien corresponde a una Formación Xerofítica, definida en la Ley N°20.283/2008, Sobre la Recuperación del Bosque Nativo y Fomento Forestal, posee escasa participación de la especie *Acacia caven*, no constituyendo una formación vegetacional regulada por la normativa forestal vigente. Por lo tanto, esta especie no tiene restricciones para su intervención.

Destacar que durante el recorrido de todo el polígono de extracción y área de influencia del Proyecto no se registraron especies en alguna categoría de conservación.
