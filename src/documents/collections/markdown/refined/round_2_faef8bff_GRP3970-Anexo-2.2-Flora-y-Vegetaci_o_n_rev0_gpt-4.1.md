...
3. METODOLOGÍA .............................................................................................................. 5
   ...
   - TRABAJO DE GABINETE ..................................................................................... 6
     - 3.2.1 IDENTIFICACIÓN DE ESPECIES ............................................................ 6
     - 3.2.2 ORIGEN BIOGEOGRÁFICO ................................................................. 7
     - 3.2.3 HÁBITO BIOLÓGICO O DE CRECIMIENTO ........................................ 7
     - 3.2.4 CLASIFICACIÓN DE LAS ESPECIES SEGÚN CATEGORÍA DE CONSERVACIÓN ........ 8
...
- **Tabla N° 2:** Listado de especies halladas en el AI. ............................................................................. 22

## ÍNDICE DE FIGURAS

- **Figura N° 1:** Ubicación geográfica del Proyecto. ................................................................................. 3
- **Figura N° 2:** Vista general del Proyecto. .............................................................................................. 4
...
> **Nota:**
> - La Línea de Evacuación proyectada contempla un ancho de faja de 3,5 metros por lado y un ancho de línea de 1,0 metro.
> - El ancho promedio del camino existente es de 5,0 metros.
> - La superficie total del Proyecto corresponde a la superficie de Planta más la superficie de la Línea de Evacuación de Media Tensión.
...
Previo al análisis de flora se realizó una revisión bibliográfica para contextualizar el trabajo en terreno y reconocer el piso bioclimático y las formaciones y pisos vegetacionales principales en los que se encuentra enmarcada la Provincia de Arica, en la cual se emplazará el Proyecto. Para esto se revisó la obra de Gajardo (1994) y la de Luebert & Pliscoff (2017). El ecosistema se caracterizó siguiendo la bibliografía citada anteriormente y se basó en la identificación de las formas de crecimiento dominantes en los diferentes estratos de vegetación. Adicionalmente, se consultaron los antecedentes disponibles en la plataforma del Sistema de Evaluación de Impacto Ambiental (SEIA), sobre estudios aprobados que se encuentran referenciados en el entorno del área de influencia del proyecto.
...
La identificación de especies se realizó *in situ*. Para las especies que no pueden ser reconocidas en terreno, se colectan muestras representativas de cada ejemplar encontrado, para posteriormente utilizar claves taxonómicas y/o su descripción original. Para esto, las muestras son almacenadas en bolsas herméticas, y posteriormente se colocan en una prensa para su revisión e identificación. Para la asignación de nombres científicos, autores, forma de crecimiento, origen y posición taxonómica de cada especie, se revisan diversas fuentes, como páginas web, libros de flora y guías de campo, y la información se corrobora en base al listado de Zuloaga *et al.* (2008). Algunas de las fuentes que son consultadas habitualmente incluyen la base de datos del Laboratorio de Invasiones Biológicas de la Facultad de Ciencias Forestales de la Universidad de Concepción (www.lib.udec.cl), los volúmenes editados de la “Flora de Chile” (Marticorena & Rodríguez 1995, 2001, 2003), así como la “Guía de Campo de Helechos nativos del centro y sur de Chile” (Rodríguez *et al.* 2009), “Guía de Campo de Trepadoras, epífitas y parásitas” (Marticorena *et al.* 2010), la “Guía de flora silvestre de Chile, Cuando el desierto florece” (Hoffmann *et al.* 2015), la “Guía de flora nativa con valor ornamental, Zona Norte” (Riedemann *et al*. 2016), el “Manual de malezas que crecen en Chile” (Matthei 1995), la “Flora de la Reserva Nacional Río Clarillo” (Teillier *et al.* 2005) y la “Flora Andina de Santiago” (Teillier *et al.* 2011).
...
En relación a los componentes flora vascular y vegetación, el área de influencia del Proyecto está definida como el área que coincide con la totalidad del terreno a intervenir más el área que eventualmente recibirá los efectos producidos sobre el medio por las fases de construcción, operación y/o cierre del Proyecto. Es decir, el área que comprende la ubicación de las obras, temporales y permanentes, más una franja aledaña (buffer) de 20 metros, desde el límite de las obras, y hacia cada lado del eje central de la línea de evacuación y el camino de acceso, ya que producto de las actividades necesarias para ejecutar el Proyecto, sectores que no serán intervenidos directamente, eventualmente podrían ser afectados, por la operación de maquinaria, deslizamiento de terreno, tala o poda de árboles, circulación de vehículos y personas, entre otros. Esta área de influencia tiene una superficie total aproximada de 27,83 hectáreas. En la Figura N° 4 puede verse el área de influencia del Proyecto.
...
|-----------|----------------|---------------|------------------|-----------------|----------------|
| T-01      | 367.802        | 7.970.749     | 367.799          | 7.970.292       | 458            |
| T-02      | 367.702        | 7.970.773     | 367.702          | 7.970.293       | 481            |
| T-03      | 367.597        | 7.970.799     | 367.604          | 7.970.294       | 507            |
| T-04      | 367.492        | 7.970.826     | 367.501          | 7.970.292       | 535            |
| T-05      | 367.388        | 7.970.853     | 367.394          | 7.970.292       | 562            |
| T-06      | 367.296        | 7.970.896     | 367.299          | 7.970.291       | 606            |
| T-07      | 367.242        | 7.970.936     | 366.632          | 7.970.493       | 755            |
| T-08      | 365.643        | 7.970.357     | 364.889          | 7.970.319       | 757            |
| T-09      | 363.863        | 7.970.168     | 363.135          | 7.969.947       | 761            |
| T-10      | 362.219        | 7.969.699     | 362.412          | 7.968961        | 764            |
...
El Desierto Interior se encuentra en las regiones de Arica y Parinacota, Antofagasta y Atacama (actualizado a nombres vigentes), desde el límite con Perú hasta los 25° de latitud sur. La comunidad vegetal principal que se allí se encuentra es la de *Tessaria absinthioides* – *Distichlis spicata*, la cual se encuentra ampliamente repartida, especialmente como ruderal en lugares con intervención humana o bajo la influencia de aguas de alta salinidad.
...
De acuerdo a este mismo autor, el área de estudio del proyecto se encuentra dentro del piso vegetacional Desierto tropical interior con vegetación escasa.
...
De la revisión en terreno del AI del Proyecto, se ha encontrado que, en 9 de los 10 transectos de muestreo, hay ausencia completa de vegetación en el área. Esto debido a que el sector pertenece a la zona de desierto absoluto. El único sector con vegetación corresponde al transecto 10, en donde se desarrollan 7 especies, debido a que hay una zanja donde se acumula cierta humedad, proveniente de una tubería. En relación a lo anterior, se aclara que la mayor parte de la vegetación existente es propia del lugar.

En cuanto a las obras línea de evacuación y el camino, se aclara que corresponden a zonas muy intervenidas, donde actualmente existen construcciones, invernaderos, basurales, y presentan caminos, movimientos de tierra y numerosas huellas de vehículo. Por su parte, el polígono de planta presenta poca alteración, aunque se observan muchas huellas vehiculares.

En la Fotografía N° 1, Fotografía N° 2 y Fotografía N° 3, se observa el aspecto general del área en estudio, donde se puede apreciar que es un terreno desprovisto completamente de vegetación, salvo el transecto 10 correspondiente a un sector de la línea de evacuación.

## Fotografía N° 1: Aspecto general del ambiente en la zona del Planta fotovoltaico
...
## Fotografía N° 3: Aspecto general del ambiente en la zona del camino y línea de evacuación eléctrica

Fuente: Registro fotográfico P&A, octubre 2019.

## FLORA

Considerando todos los transectos de muestreo, se determinó una riqueza total de 6 especies, pertenecientes a la División Magnoliophyta (dicotiledóneas y monocotiledóneas). En la Tabla N° 2 se entrega un listado de las especies encontradas.

### Tabla N° 2: Listado de especies halladas en el AI

| División / Clase         | Familia        | Nombre científico                                   | Nombre común                                 | Hábito de crecimiento | Origen |
|-------------------------|---------------|-----------------------------------------------------|-----------------------------------------------|----------------------|--------|
| Magnoliophyta /         | Asteraceae    | *Sonchus oleraceus* L.                              | Cerraja, cerrajón                             | Herbácea             | I      |
| Magnoliopsida           |               | *Tessaria absinthioides* (Hook. & Arn.) DC.         | Chilca, brea                                  | Arbustiva            | N      |
|                         | Casuarinaceae | *Casuarina equisetifolia* L.                        | Casuarina, pino australiano, árbol de la tristeza, pino de París | Arbórea              | I      |
| Magnoliophyta /         | Poaceae       | *Diplachne fusca* (L.) Kunth subsp. uninervia (J. Presl) P.M. Peterson & N. Snow | Nudillo | Herbácea             | N      |
| Liliopsida              |               | *Pennisetum advena* Wipff & Veldkamp var. rubrum    | Pennisetum rojo                                | Herbácea             | I      |
|                         |               | *Pennisetum alopecuroides* (L.) Spreng.             | Pennisetum chino, hierba de fuente, cola de zorro | Herbácea             | I      |

---

### 4.3.1 ORIGEN BIOGEOGRÁFICO

El origen de la flora identificada mostró una mayor frecuencia de especies introducidas (4), con un 66,7%, seguida de las nativas (2), que representan el 33,3% del total.
...
En cuanto a la forma de crecimiento, la mayor frecuencia la poseen las especies herbáceas (4), con un 66,7%, luego las arbóreas (1) y arbustivas (1), cada una de ellas con un 16,7%.
...
Del total de 2 especies nativas registradas, ninguna de ellas posee categoría de conservación ni se encuentra protegida por regulaciones especiales.

## Fotografía N° 4: Especies de flora presentes en el área de influencia
...
Luego de realizar los recorridos a través del polígono, camino y línea de evacuación, se encontró muy poca vegetación, la cual está asociada a sectores muy intervenidos, los cuales se encuentran específicamente en el último tramo de la línea de evacuación donde existe humedad de manera artificial. De las especies presentes, solo dos de ellas son nativas: *Tessaria absinthioides* (chilca, brea) y *Diplachne fusca* (nudillo). Ninguna de ellas se encuentra en categoría de conservación. Para el resto del AI no se encontró vegetación, ni rastros de su existencia en otras épocas del año.

Por lo tanto, se puede concluir que, el Área de Influencia del Proyecto carece de vegetación, siendo casi nula, donde además no existe presencia de ninguna formación vegetacional con características particulares o que amerite su protección y, del mismo modo, tampoco se encuentran especies de flora vascular clasificadas en alguna categoría de conservación, ni protegidas por regulaciones especiales. Es decir, desde el punto de vista de la flora y vegetación, el AI no posee características singulares a las que haya que poner especial cuidado.
...
- Ministerio del Medio Ambiente. 2018. Especies. Clasificación según Estado de Conservación. Disponible en http://www.mma.gob.cl/clasificacionespecies/informacion-procesos-2014.htm (Consultada en octubre de 2019).
...
- Zuloaga FO, Morrone O & Belgrano MJ (eds.). 2008. Catálogo de las Plantas Vasculares del Cono Sur (Argentina, Sur de Brasil, Chile, Paraguay y Uruguay). Monographs of the Missouri Botanical Garden 107. Disponible en http://www2.darwin.edu.ar/Proyectos/FloraArgentina/fa.htm (consultada en octubre de 2019).
