...
## PROYECTO INMOBILIARIO “HACIENDA EL BOLDO”
...
| 4      | Catastro vegetacional SIT (CONAF 2009). |
| 6      | Resultados COT. |
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Hacienda el Boldo”, en la comuna de Curicó, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Hacienda el Boldo”.
...
El proyecto “Hacienda el Boldo” se emplaza en el sector Norte de la ciudad de Curicó (Figura 1). El área de estudio se encuentra en una zona urbana que limita con la Calle El Boldo (Figura 2).

**Figura 1. Ubicación geográfica del área de estudio.**

- Consultor: Hacienda el Boldo
...
*Subtipos y detalles se encuentran en el texto original.*
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron dos unidades ambientales (Figura 5), las observaciones en terreno muestran una superficie tipo Pradera agrícola en desuso y altamente intervenida, abarcando la mayor parte del predio en donde dominan especies herbáceas de origen introducidas de características como *Cynodon dactylon*, entre otras, y la segunda unidad ambiental compuesta por infraestructura y ciudad.
...
- Escala: 1:5,000
- Proyección: WGS 84 UTM H19S
- Simbología: Pradera en desuso, Infraestructura
- Fuente: Elaboración propia
...
| Asteraceae  | *Cichorium intybus*    | Achicoria            |          |        |
| Asteraceae  | *Taraxacum officinale* | Diente de león       |          |        |
| Asteraceae  | *Hypochaeris radicata* | Hierba del chancho   |          |        |
| Asteraceae  | *Xanthium spinosum*    | Abrojo               |          |        |
| Asteraceae  | *Centaurea melitensis* | Cizaña               |          |        |
...
| Poaceae     | *Cynodon dactylon*     | Césped               |          |        |
| Poaceae     | *Lolium perenne*       | Ballica              |          |        |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Hacienda el Boldo”, en términos de diversidad y la presencia de especies de interés.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), estableciéndose dos unidades ambientales en el área de estudio, una superficie tipo Pradera en desuso y altamente intervenida, la cual abarca la mitad del área comprendida por el futuro proyecto, donde dominan especies herbáceas de origen introducidas de características invasoras como *Cynodon dactylon* (Césped), entre otras, y la segunda unidad ambiental la cual involucra infraestructura.
