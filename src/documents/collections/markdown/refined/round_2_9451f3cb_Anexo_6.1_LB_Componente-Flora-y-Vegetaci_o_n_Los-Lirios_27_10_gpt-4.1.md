...
| COMPONENTE         | FECHA       | ELABORADO POR           | FIRMA |
|--------------------|-------------|-------------------------|-------|
| Flora y Vegetación | 19/10/2020  | Eduardo De Luca Jofré   | Ingeniero Forestal/Gestión Ambiental |
...
## INDICE IMÁGENES, TABLAS Y FOTOGRAFÍAS
...
El Proyecto **“Planta Solar Los Lirios”** corresponde a una nueva Planta Solar ubicada en la comuna de Requínoa, Región del Libertador General Bernardo O’Higgins. Dicho Proyecto generará energía limpia a través de la construcción de una central de 9 MW AC, por lo que se considera como un pequeño medio de generación distribuido (PMGD) en base a energías renovables no convencionales (ERNC) y contempla la utilización de una superficie aproximada de 25,27 hectáreas, en la cual se ejecutarán el total de sus instalaciones.

La planta solar estará constituida por 25,000 paneles, instalados con tecnología de seguidores de un eje y considera la construcción de una línea eléctrica de 15 kV de tensión (“Línea de evacuación eléctrica”), con una longitud aproximada de 335 m, la cual se conectará al alimentador “El Olivar” de propiedad de la empresa de distribución local correspondiente a la subestación “Cachapoal”, esto con la finalidad de transmitir la energía producida hacia el Sistema Eléctrico Nacional (SEN), de acuerdo a la Norma Técnica de Conexión y Operación de Pequeños Medios de Generación Distribuidos (PMGD) en instalaciones de Media Tensión.

Para este efecto, se realizó el levantamiento de información mediante una (1) campaña el día 1 de octubre del 2020. Este levantamiento permitió recopilar antecedentes de estructura, cobertura y estado de conservación de la Flora presente en el área de influencia del Proyecto. Dicho lo anterior, se entrega una descripción en base a los antecedentes bibliográficos consultados, para luego describir la flora de interés y vegetación de acuerdo a la información recopilada en terreno.
...
- Identificar y caracterizar sitios de singularidad vegetacional dentro del área de estudio, en caso que se detecten.
...
Respecto del área de influencia para Plantas Vasculares, según el Reglamento del SEIA (D.S. N° 40/12), el cual en su Artículo 2°, letra a), define área de influencia (AI) como:
...
El área de influencia (AI) corresponde a un terreno agrícola, el cual es destinado para la producción intensiva de *Malus domestica* (plantación de manzanos variedad Smith), donde la vegetación principal es introducida y con una escaza cobertura arbustiva y herbácea.

En consecuencia, el área de influencia del Proyecto (Anexo 1) que en sus distintas fases podría afectar el componente Flora y Vegetación comprende una superficie total 26 ha incluyendo un buffer de 5 metros respecto del área total del proyecto (25 ha.) cuya distribución espacial se muestra a continuación en la Imagen 1.
...
Realizando un recorrido del área, se procedió a realizar un listado florístico en el cual se estableció la importancia sociológica de cada taxa en la formación utilizando una escala adaptada de la tradicional metodología de cobertura y abundancia de Braun-Blanquet (Tabla 1).

**Tabla 1: Escala de abundancia-dominancia de Braun-Blanquet**

| Registro | Atributos de la Población |
|----------|---------------------------|
| 5        | Cualquier número de ind., pero con cobertura superior al 75% de la parcela |
...
Esta formación se caracteriza por presentar lomajes de pendientes suaves y en extensas superficies planas de secano, se desarrolla como un paisaje vegetal homogéneo, constituido por arbustos altos dispersos, en el que el espino (*Acacia caven*) es la especie dominante, acompañada en ciertos sectores por elementos esclerófilos. Es una formación de carácter secundario, resultado del deterioro sufrido por el ambiente tras la intervención humana. En los pequeños valles y en los lugares menos alterados se encuentran asociaciones típicas de los bosques esclerófilos.
...
La diversidad florística presente en el área de estudio se determinó mediante la realización de parcelas de muestreo (inventarios florísticos) distribuidos en las distintas unidades de vegetación reconocibles en terreno. En total se efectuaron 4 puntos de muestreo, insertos en parcelas de 250 m². Como resultado de los inventarios, se determinó que la flora vascular está conformada por 11 especies vasculares de plantas, donde gran parte de estas son especies originarias de otros países (adventicias), habituales de áreas de cultivos y plantaciones, lo cual se puede apreciar con mayor énfasis en el catálogo taxonómico adjunto en el Apéndice A del presente documento.

De acuerdo a las características taxonómicas de la flora vascular registrada en el sector, es posible indicar que gran parte de la flora identificada pertenece a la división *Magnoliophyta*. La división *Magnoliophyta* la cual está divida en las clases *Magnoliopsida* y *Liliopsida*, donde la primera es la de mayor representatividad, alcanzando un valor de 90,9% (11 taxa) (Tabla N°4). A nivel de familia, es posible indicar una mayor contribución de Fabáceas y Rosaceae con dos (2) especies cada una.

**Tabla N°4. Resumen taxonómico de la flora vascular identificada**

| CLASE           | Nº FAMILIAS | Nº GÉNEROS | Nº ESPECIES |
|-----------------|-------------|------------|-------------|
| Liliopsida      | 1           | 1          | 1           |
| Magnoliopsida   | 8           | 9          | 10          |
| **TOTAL**       | **9**       | **11**     | **11**      |
...
Se registraron once (11) especies en el área de influencia. La cobertura (%) se definió en función del promedio de cobertura por especie en la parcela. La especie de mayor abundancia corresponde a *Malus domestica* superior al 95%. El resto de especies identificadas presentan un índice de abundancia con pocos individuos y cobertura inferior a 5%.

#### 5.2.3 Origen geográfico

En términos generales, se indica que la cubierta vegetacional del área de estudio está definida por zonas de cultivo agrícola intensivo que limitan fuertemente el desarrollo de una matriz de vegetación nativa, la cual solo es apreciable de manera aislada y en los límites a modo de separación predial y asociada a cursos de agua artificiales. En este contexto, el origen fitogeográfico de la riqueza identificada en el área en cuestión, revela que gran parte de la diversidad detectada (100%), son especies que se encuentran fuera de sus límites naturales de distribución, es decir, que corresponden a entidades que fueron introducidas al territorio nacional (adventicias o alóctonas).

En síntesis, en Tabla N°5 se entrega la referencia porcentual del origen geográfico de las especies detectadas y el porcentaje de contribución de cada grupo para el área de estudio.
...
Referente a los tipos biológicos identificados en el área de estudio, es posible indicar que la fisionomía estructural del sector presenta una composición definida fundamentalmente por especies arbóreas (45,45%). En la Tabla Nº 6 se observa la proporción resultante según los distintos tipos biológicos registrados en el sector.
...
En consideración a la actual legislación referente a la flora y vegetación natural de Chile, respecto de la Ley 20.283/2008 Sobre Recuperación del Bosque Nativo y Fomento Forestal y su reglamento, no se constató la presencia de especies de plantas vasculares que se catalogan como especies originarias del país, según el Decreto N.º 68/2009 del MINAGRI. Cabe señalar que las entidades arbóreas identificadas, no constituyen bosque ni conforman formaciones xerofíticas o singularidades que requieran algún permiso ambiental sectorial.

---

### 5.3 VEGETACIÓN

De acuerdo a la prospección realizada en base a la aplicación de la metodología de la Carta de Ocupación de Tierras (COT), se pudo constatar que el área de influencia del Proyecto corresponde a una pradera utilizada como pastoreo, lo cual determina cuadros de vegetación sin importancia ni significancia biológica en términos de conservación de los recursos florísticos y vegetacionales nativos del país.

Las formaciones vegetacionales correspondientes a estratos vegetacionales del tipo biológico LA (Leñoso alto), poseen un rango de cubrimiento superior al 95%, LB (Leñoso bajo) 1% de estrata arbustiva y con un rango de cubrimiento de la estrata herbácea (H) cercano al 4%.

Se distinguen dos formaciones vegetacionales, la primera de ellas y dominante, corresponde a un cultivo agrícola intensivo (parcelas 1, 2 y 3). La segunda corresponde a una formación de árboles aislados (parcelas 4 y 5).

A continuación, en el siguiente set de fotografías N°2, se puede observar las formaciones vegetacionales presentes en el área de influencia del Proyecto.

**Set fotografías N°2. Vista formaciones vegetacionales**

*Fuente: Elaboración propia (2020);*

Respecto del grado de intervención y transformación del medio por acción antrópica existe un alto grado de artificialización, con elevada presencia de especies introducidas, de esta forma, el área de influencia se incluye dentro de la tipología “Zona Agrícola” descritas en la Carta de Ocupación de Tierras (COT) realizada, la cual se puede apreciar en el Apéndice N° B presente documento.

#### 5.3.1 Instrumentos de Protección Nacional

En relación a la revisión de la Estrategia y Plan de Acción para la Conservación y Uso Sustentable de la Diversidad Biológica de la Región del Libertador General Bernardo O’Higgins (CONAMA, 2002), sus actualizaciones de la OF. ORD. D.E. Nº 103008 del 28 de septiembre de 2010 del Servicio de Evaluación Ambiental (SEA) que "Imparte Instrucciones sobre Sitios Prioritarios para la Conservación de la Biodiversidad", como también el OF. ORD. D.E. Nº100143 del 15 de noviembre de 2010 del SEA, correspondiente al Instructivo "Sitios Prioritarios para la Conservación en el Sistema de Evaluación de Impacto Ambiental", donde se actualiza la información de los 64 Sitios Prioritarios para efectos del SEIA, y en base a la cobertura de “Sitios Prioritarios Para La Conservación de la Biodiversidad”, disponible en el sitio web del Sistema Nacional de Información Ambiental (SINIA), se pudo corroborar que el Proyecto “Parque Solar Santa Teresita” no se encuentra dentro de algún sitio prioritario.
...
En cuanto a la presencia de humedales en el área de emplazamiento del Proyecto, se indica que el Proyecto no se encuentra inserto en humedales adscritos a la convención RAMSAR y/o con algún grado de protección.
...
En base a la información recopilada, para el componente flora y vegetación, es posible determinar que el área de influencia está definida como una zona agrícola, con una producción intensiva de *Malus domestica* (Manzano) razón que determina una carencia de vegetación natural y una composición florística basada esencialmente en especies introducidas (adventicias).

En términos de diversidad, el área de estudio presenta una riqueza florística muy baja (11 taxa), lo cual tiene relación con el efecto que produce la intervención de espacios para fines agrícolas, que limita el desarrollo de especies. La riqueza florística está definida principalmente por especies alóctonas, no existiendo especies nativas prospectadas.
...
Finalmente, es posible establecer que el grado eventual de afectación de la estructura vegetacional no es importante considerando significancia ambiental que representan los ambientes caracterizados en el Proyecto. De esta forma, el área en general no manifiesta la existencia de especies vasculares de plantas ni sistemas vegetacionales que tengan algún grado mayor de consideración en términos de conservación y protección que deban ser incluidos en la presente caracterización ambiental.
...
| Especie                        | División        | Clase           | Familia        | Género      | Origen   | Hábito      | Crecimiento |
|--------------------------------|-----------------|-----------------|---------------|-------------|----------|-------------|-------------|
| Acer pseudoplatanus L          | Sapindaceae     |                 | Acer          |             |          |             |             |
...
| Agrostis capillaris L.         | Magnoliophyta   | Liliopsida      | Poaceae       | Agrostis    |          |             |             |
| Malus Domestica                |                 |                 | Rosaceae      | Malus       |          |             |             |
| Populus nigra                  |                 |                 | Salicáceas    | Populus     |          |             |             |
| Geranium robertianum L         |                 |                 | Geraniaceae   | Geranium    |          |             |             |
| Leontodon saxatilis Lam        |                 |                 | Asteraceae    | Leontodon   |          |             |             |
| Rapistrum rugosum (L.)         | Magnoliophyta   | Magnoliopsida   | Brassicaceae  | Rapistrum   |          |             |             |
