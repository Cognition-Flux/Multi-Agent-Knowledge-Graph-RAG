...
| Ambientes Naturales | Praderas, Bosque Mixto, Herbazal, Matorral (Muy abierto 5 a 25%, Abierto 25 a 50% 0-100%, Semidenso 50 a 75% 0-100%, Denso 75 a 100%), Matorral con suculentas (Muy abierto 5 a 25%, Abierto 25 a 50% 0-100%, Semidenso 50 a 75% 0-100%, Denso 75 a 100%), Formación de Suculentas, Bosque Nativo (Muy abierto 10-25%, Abierto 25-50%, Semidenso 50-75%, Denso 75-100%), Humedales (presencia de agua en la superficie), Turberas, Bofedales, Vegas, Pajonales, Sin Vegetación (Desiertos, Altas cumbres y farellones, Nieves y Glaciares, Derrumbes, Deslizamientos, Conos, Aluviones, Cursos de agua, Ríos, Lagos, Lagunas) |
...
| Natural | Afloramiento rocoso |  | 0,19 | 8,04 |
| Natural | Cuerpo de agua | Cuerpo de agua | 0,01 | 0,35 |
| Natural | Estepa | Pradera | 0,60 | 25,07 |
| Natural | Estepa |  | 0,96 | 40,24 |
| Natural | Estepa |  | 0,25 | 10,56 |
...
En esta condición, se encuentra una forma de uso del suelo: Camino-Estacionamientos. Este uso concierne principalmente al camino correspondiente a la ruta 11-CH, corresponde a un área ubicada contigua a la ruta, donde cumple como objetivo ser una zona para el estacionamiento de vehículos.
...
| Magnoliophyta | Magnoliopsida | Asteraceae | Werneria glaberrima Phil. | Poposa | Endémica | Hierba perenne | | | |
...
| Origen | Forma Biológica | Arbusto | Herbáceas | Total |
|--------|-----------------|---------|-----------|-------|
| Adventicia | 0 | 0 | **0** |
| Endémica | 0 | 1 | **1** |
| Nativa | 1 | 3 | **4** |
...
Respecto al espectro biológico (Tabla 5-4 y en la Figura 5-3), las formas de vida más abundante corresponde a las plantas de hábito herbáceo (80%) y arbustivo (33%) lo que resulta normal para un área donde, como se vio en el punto anterior de vegetación, las condiciones geográficas y climáticas dificultan el establecimiento de otras especies.
...
Dentro del área de estudio no se registraron especies en categoría de conservación clasificada en listados nacionales de acuerdo al Reglamento de Clasificación de Especies (RCE). En el Libro Rojo Nacional no se registran especies en categoría de conservación. De igual forma, en el Boletín N°47 como el D.S. N°68 no registran ninguna de las especies identificadas en el área de estudio.
...
El área de estudio de la DIA del proyecto “Instalación de torre para Telecomunicaciones Sitio NEWPOLI280F1 – Av. Simon Bolivar R11 - Putre 4”, tiene una superficie de 2,39 ha, de las cuales el 75,87% corresponde a ambientes naturales predominados por praderas. Del área de estudio prospectada (AE), 2,39 hectáreas de las cuales el 97,88% (2,34 ha) corresponden a ambientes naturales, de el se desprende afloramiento rocoso con 21,66% (0,52 ha), cuerpo de agua con 0,35% (0,01 ha) y el 75,87 (1,81 ha) se encuentra cubierta por vegetación (praderas). La formación predominante corresponde a pradera, su origen proviene de la aparición de herbáceas en coberturas variables y donde la vegetación dada las condiciones ambientales no se desarrollan con normalidad.

Se registró un total de 5 taxa, que se agrupan en 5 familias. Del total de especies registradas el 75% corresponde a flora nativa y el 25% a flora endémica representada por una especie, la flora advena no tiene representatividad. Se identificó una especie endémica en el área de estudio.

Los tipos biológicos con mayor representación corresponde a las plantas de hábito herbáceo (80%) y arbustivo (20%), este último se encontró de manera escasa a orillas de la ruta 11-CH.
