...
4. Resultados ........................................................................................................................... 9
   ...
   4.2. Análisis mediante información satelital ...................................................................... 10
...
El Proyecto Parque solar fotovoltaico La Gamboína, ubicado en la provincia de Cachapoal, comuna de Rancagua, corresponde a un proyecto del tipo PMGD de Energía Renovable No Convencional que proporcionará su energía al Sistema Eléctrico Nacional (SEN), aportando energía limpia a la matriz energética nacional.
...
El proyecto se encuentra emplazado en la Región de O´Higgins, Provincia de Cachapoal, comuna de Rancagua, tal como se indica en la siguiente ilustración:
...
Para este caso, se definió como área de influencia el área del proyecto más un buffer de 10 metros para la identificación de flora (por individuo), lo que dio como resultado un área de influencia total de 13,42 ha. Cabe indicar que la justificación del área de influencia se debe al alcance predominante de levantamiento de polvo producto de la construcción del Proyecto.
...
**III. Visita a terreno:** Una vez completados los puntos anteriores, se realizó una visita a terreno el día 23 de diciembre de 2020, cuyo fin fue realizar un reconocimiento de especies, su diversidad y abundancia.
...
Según Squeo, Arancio, & Gutierrez (2001), según corresponda a la distribución de origen geográfico de una especie, se pueden clasificar en:
...
| Sur del río Elqui hasta el límite sur de la Región Metropolitana | 1 | 40 | Carácter xerofítico | 300 |
| Región Metropolitana hasta la Región del Bio Bío, incluida la Región Metropolitana de Santiago | 1 | 40 | Carácter xerofítico | 500 |
...
Respecto al piso vegetacional de la zona, en base a lo descrito por Luebert y Pliscoff, este corresponde a una formación de bosque espinoso mediterráneo de *Acacia caven* y *Prosopis chilensis*, el que se caracteriza por ser un bosque espinoso abierto, con estrata arbustiva compuesta principalmente por *Cestrum parqui*, *Muehlenbeckia hastulata*, *Schinus polygamus*, *Solanum ligustrinum* y *Proustia cuneifolia*. En la estrata herbácea destacan las plantas introducidas como *avene barbata* y *Cynara cardunculus*, que reflejan el fuerte nivel de degradación que presenta.

Dada la extensión de los pisos vegetacionales definidos por Luebert y Pliscoff, se presenta en la siguiente imagen el área del Proyecto con los distintos pisos vegetacionales que se logran identificar en el sector. Complementariamente, cabe recalcar que el piso vegetacional correspondiente a bosque espinoso mediterráneo de *Acacia caven* y *Prosopis chilensis* tiene una superficie de 340,279 hectáreas, mientras que el área de influencia del Proyecto tiene 13,42 hectáreas, quiere decir que el Proyecto solo afectará un 0,004 % del piso vegetacional de la zona.
...
El área del Proyecto se encuentra inmerso en la región y sub región del mismo nombre, del bosque esclerófilo, específicamente en la formación Bosque esclerófilo andino.

### 4.2. Análisis mediante información satelital

De acuerdo a la información entregada por las plataformas Google Earth y otros sistemas de imágenes satelitales, se logró constatar la ausencia de grandes formaciones vegetaciones arbóreas relevantes y de formaciones de bosque; además de amplias áreas desprovistas de vegetación. Es por lo anterior que se determinó la necesidad de utilizar el método de transectas para el área del proyecto.

### 4.3. Trabajo en terreno

Con fecha 23 de diciembre de 2020, se realizó una visita a terreno con el objetivo de identificar tanto las formaciones vegetacionales como los individuos de flora al interior del área de estudio. Las transectas utilizadas para dicho trabajo se presentan en la Ilustración 5: Transectas en área de estudio.
...
|------------------------|-------------------|-------------------|------------|--------------------------|---------------------|
| Acacia capensis        |                   | Arbórea           |            |                          |                     |
| Populus nigra          | Álamo             | Arbórea           |            |                          |                     |
| Prunus domestica       | Ciruelo           | Arbórea           |            |                          |                     |
| Robinia pseudoacacia   | Falsa acacia      | Arbórea           |            |                          |                     |
| Zea mays               | Maiz              | Herbácea          |            |                          |                     |
| Salix babylonica       | Sauce             | Arbórea           |            |                          |                     |
| Rubus plicatus         | Zarzamora         | Arbustiva         |            |                          |                     |
...
Unidad vegetacional marcada por la actividad agrícola, se encuentra conformada por un cultivo de *Zea mays* (maiz).
...
Unidad de vegetación que se encuentra formada en su totalidad por especies de *Acacia capensis*, las que en el terreno se encuentran utilizadas como cortina vegetal o cerco perimetral.

*Ilustración 8: formación arbórea de Acacia capensis*

#### Formación arbórea de Robinia pseudoacacia

Unidad vegetacional compuesta en mayor proporción por la especie arbustiva nativa de *Robinia pseudoacacia* (falsa acacia), con presencia de *Rubus plicatus* (zarzamora). Al igual que la formación anterior, se encuentran utilizadas como cortina vegetal o cerco perimetral.

*Ilustración 9: Formación de Robinia pseudoacacia*

#### Formación arbórea de Populus nigra

Unidad vegetacional compuesta en mayor proporción por la especie arbustiva nativa de *Populus nigra* (Álamo), con presencia de *Salix babylonica* (sauce). Al igual que la mayoría de las formaciones anteriores, es utilizada como cortina vegetal o cerco perimetral.
...
Unidad vegetacional remanente de plantaciones previas en el área del proyecto, dado que actualmente el predio presenta otro tipo de plantación agrícola. Esto es debido a que las especies solo han permanecido en el sector lateral del predio, en un área muy limitada, adoptando la condición de cerco o límite vegetal.
...
Estas áreas corresponden a zonas desprovistas de vegetación, tales como zonas de acopio de materiales o caminos al interior del área del proyecto.

*Ilustración 14: Áreas sin vegetación*

*Ilustración 15: Áreas sin vegetación*

La ubicación de las UVH descritas anteriormente se encuentra en la Ilustración 16: Unidades vegetacionales homogéneas.
...
|--------------------------------------------|---------------|----------------|
| Plantación agrícola                        | 100,230       | 74.68          |
| Formación arbórea de Acacia capensis       | 6,004         | 4.48           |
| Formación arbórea de Robinia pseudoacacia  | 11,112.4      | 8.28           |
| Formación arbórea de Populus nigra         | 5,118.2       | 3.81           |
| Formación arbórea de Prunus domestica      | 4,642         | 3.46           |
| Área sin vegetación                        | 7,093.4       | 5.29           |
...
Al definir el contexto biogeográfico se determinó que el área de influencia del proyecto se encuentra inmerso en la región y sub región del mismo nombre del Bosque esclerófilo, específicamente en la formación Bosque esclerófilo andino (Gajardo, 1994) y del Piso Vegetacional Bosque espinoso mediterráneo interior de *Acacia caven* y *Prosopis chilensis* (Federico Luebert, 2017).
...
Fue posible delimitar 6 unidades de formación vegetacional homogéneas, tales como la formación Plantación agrícola con 10.02 hectáreas, formación arbórea de *Acacia capensis* con 0.6 hectáreas, formación arbórea de *Robinia pseudoacacia* con 1.11 hectáreas, formación arbórea de *Prunus domestica* con 0.51 hectáreas y áreas sin vegetación con 0.7 hectáreas.
