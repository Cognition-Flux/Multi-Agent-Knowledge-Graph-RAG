...
La flora de la Región de Antofagasta (II) consta de unas 1050 especies; una parte importante de ellas crecen en sus áreas cordilleranas, tanto en el cordón occidental, como en el oriental que sirve de límite con los países vecinos; al respecto se han reportado sectores andinos donde se han colectado más de 200 especies de plantas vasculares (Marticorena *et al*., 1998).

Respecto de la distribución por altitud de la flora vascular, Villagrán et al. (1981) llevó a cabo un estudio de la flora y de la vegetación de la zona de Toconce (22°06 S-22°22’S); en ese trabajo se describieron un gradiente de altitud en la distribución de la vegetación; al respecto, los autores distinguieron los siguientes pisos:

- **Prepuneño**: dominancia de arbustos como *Adesmia atacamensis*, *Atriplex imbricata* y *Ambrosia artemisioides*.
- **Puneño**: predominan arbustos como *Fabiana ramulosa (=Fabiana densa)*, *Fabiana denudata* y *Baccharis boliviensis*.
- **Andino**: predominan los pajonales de gramíneas como *Festuca chrysophylla* y *Stipa frigida*.
...
En el sector del valle del río Loa, son importantes las especies como *Cortaderia speciosa (=C. atacamensis)*, *Distichlis spicata*, *Tessaria absinthioides*, *Baccharis scandens (=B. petiolata)* y *Baccharis juncea* (Reiche, 1934).
...
El objetivo de este trabajo es caracterizar la flora y la vegetación existente en las áreas donde se pretende modificar la ubicación de la subestación El Abra, (ahora S/E Gis Conchi), que incluye el sitio de Instalación de Faena, y modificar el trazado de la línea eléctrica que llega hasta la S/E Gis Conchi.

Dicha caracterización tiene por finalidad entregar información que permita evaluar el sector en el marco de la presente Declaración de Impacto Ambiental (DIA) que se ingresa al Sistema de Evaluación Ambiental (SEIA).

Para el caso de la flora el objetivo específico es obtener la lista de las especies de plantas vasculares que crecen en el área del proyecto, en el caso de la vegetación, los objetivos son la clasificación de las comunidades vegetales y su cartografía.

---

# 3. ÁREA DE INFLUENCIA

Se incluyó en el área de influencia de esta presentación el sector de la nueva S/E Gis Conchi en el sector de la mina El Abra, el sitio de Instalación de Faena y una franja de 50 m a cada lado de la nueva propuesta de trazado de la LTE en este sector.
...
El sitio estudiado incluyó los sectores donde se han propuesto modificaciones a la ubicación de la Subestación Eléctrica e Instalación de Faena en el sector El Abra y en el trazado de la Línea de Transmisión Eléctrica (LTE) desde el lado poniente del río Loa a la S/E Gis Conchi.

La modificación al trazado corresponde a 4,57 km aprox. proyectado desde la torre 205 hasta la torre 219 que llegará a la nueva S/E Gis Conchi. En la figura 1 se muestra la ubicación de la nueva Subestación Eléctrica, la Instalación de Faena y la llegada del trazado de la LTE; en color morado el trazado original del proyecto, aprobado mediante la RCA N° 168/2013, y en color celeste la propuesta de modificación al trazado evaluado en esta presentación.
...
El trabajo realizado en terreno consistió en la identificación y colección de material de aquellos ejemplares no identificados en terreno, para su posterior identificación en gabinete.

Para cada especie de flora, identificada en cada sitio de estudio se indica el nombre científico y la familia de acuerdo a lo propuesto por Marticorena & Quezada (1985), Marticorena *et al*. (1998) y Zuloaga *et al*. (on line 2015).

Los nombres vernaculares o vulgares se indican de acuerdo con Aldunate *et al*. (1983), Gajardo (1994) y Villagrán & Castro (2004).
...
Las categorías de conservación se asignan de acuerdo con las propuestas de la Secretaria General de la Presidencia de la República (SEGPRES)-CONAMA y del Ministerio del Medio Ambiente en sus procesos de 2005 a 2014; la clasificación de especies en el Libro Rojo (Benoit, 1989); y las listas publicadas en el Boletín 47 del Museo Nacional de Historia Natural, en particular, la de Belmonte *et al*. (1998), como referencia auxiliar para la conservación de los cactus.

## 4.2 Vegetación

La clasificación de las comunidades vegetales locales se basa en la metodología de elaboración de las Cartas de Ocupación de Tierras (Etienne & Prado, 1982). En ella se mapean las unidades de vegetación que se distinguen según criterios de dominancia y fisonomía. La abundancia de las especies se estima visualmente. Las unidades cartografiadas se denominan “formaciones de vegetación” y se caracterizan mediante tipos biológicos, especies dominantes y niveles de cobertura por estrato.

Para el área de influencia, los tipos biológicos (fisionómicos) considerados son: “leñoso bajo” (LB), para los arbustos de más de dos metros de altura; “suculento” (S), para las cactáceas y “herbáceo” (H), para las hierbas perennes y anuales.
...
La visita al sector dio cuenta de unas 25 especies de plantas vasculares, cuya lista se muestra en la Tabla 1. Todas las especies son nativas: ocho, endémicas de Chile y una de ellas, *Menonvillea rollinsii* (Cruciferae), endémica de la Región de Antofagasta.
...
- *Maihueniopsis glomerata* (Fotografía 2) clasificado como una especie “casi amenazada” (DS 13/2013 MMA). En la RCA N° 168/2013 existe un compromiso de relocalización en caso de que sea afectado por las obras. En el área con la nueva propuesta crecen unos ocho ejemplares en el trazado de la LTE, el más cercano se ubica unos 45 m de una de las torres (205);
...
| científico                  | Familia         | vulgar         | Forma de crecimiento | Origen geográfico | Categoría de conservación |
|----------------------------|-----------------|---------------|---------------------|-------------------|--------------------------|
| Tetragonia microcarpa      | Aizoaceae       | Aguanosa      |                     |                   |                          |
| Argylia tomentosa          | Bignoniaceae    |               | Hierba perenne      |                   |                          |
| Cryptantha sp.             | Boraginaceae    | Dicha         | Indeterminada       |                   |                          |
| camachoi                   | Cactaceae       |               | Suculenta           |                   | Vulnerable (Hoffmann & Walter, 2004) |
|                            | Cactaceae       |               | Suculenta           |                   | (DS 13/2013 MMA)         |
| Oreocereus variicolor      | Cactaceae       | Chastudo peludo| Suculenta           |                   | Preocupación menor (DS 13/2013 MMA) |
|                            | Cactaceae       | Cardón        | Suculenta           |                   | (DS 41/2011 MMA)         |
| Hoffmanseggia doellii      | Caesalpinaceae  | Porotillo     | Hierba perenne      |                   |                          |
| Atriplex imbricata         | Chenopodiaceae  | Pilaya        |                     |                   |                          |
| Haplopappus rigidus        | Compositae      | Baylahuén     |                     |                   |                          |
| Helogyne macrogyne         | Compositae      |               |                     |                   |                          |
| Polyachyrus sphaerocephalus| Compositae      |               |                     |                   |                          |
| Trichocline caulescens     | Compositae      | Flor del desierto|                   |                   |                          |
| Menonvillea rollinsii      | Cruciferae      | -             | Endémica regional   |                   |                          |
| Neuntobotrys tarapacana    | Cruciferae      | Lata lata     | Hierba perenne      |                   |                          |
| Ephedra breana             | Ephedraceae     | Pingo pingo   |                     |                   |                          |
| Adesmia                    | Fabaceae        | Allaval       |                     |                   |                          |
| Adesmia erinacea           | Fabaceae        |               |                     |                   |                          |
| Phacelia pinnatifida       | Hydrophyllaceae | Sobaco        |                     |                   |                          |
| Cistanthe cabrerae         | Portulacaceae   | Renilla       |                     |                   |                          |
| Cistanthe celosioides      | Portulacaceae   | -             |                     |                   |                          |
| Cistanthe salsoloides      | Portulacaceae   | -             | Hierba perenne      |                   |                          |
| Fabiana ramulosa           | Solanaceae      | Checal        |                     |                   |                          |
| Acantholippia deserticola  | Verbenaceae     | Rica rica     |                     |                   |                          |

### Tabla 2. Ubicación de los ejemplares de las especies clasificadas como “casi amenazadas” - Sector El Abra

| científico                | Categoría de conservación | Sector | Coordenada E | Coordenada N | N° de ejemplares |
|--------------------------|---------------------------|--------|--------------|--------------|------------------|
|                          |                           |        | 532274.63 m  | 7570697.33 m | 7                |
|                          |                           |        | 528894.81 m  | 7569184.91 m |                  |
|                          |                           |        | 531334.31 m  | 7570717.03 m |                  |
|                          |                           |        | 531685.03 m  | 7570664.31 m |                  |
|                          |                           |        | 531709.22 m  | 7570675.56 m |                  |
|                          |                           |        | 532034.78 m  | 7570692.17 m | 2                |
|                          |                           |        | 529003.25 m  | 7569373.76 m |                  |
|                          |                           |        | 529291.23 m  | 7569910.40 m | 4                |
|                          |                           |        | 529331.00 m  | 7570028.86 m |                  |
|                          |                           |        | 529398.75 m  | 7569988.89   | 3                |
|                          |                           |        | 529970.77 m  | 7570570.25 m |                  |
...
Se trata de un matorral de hasta 40 cm de altura, cuya cobertura que rara vez supera un 5 %. Las especies dominantes son el arbusto *Atriplex imbricata*, la suculenta *Maihueniopsis camachoi* y las hierbas *Cistanthe celosioides* y *Tetragonia microcarpa*. Se ubica en los terrenos más o menos llanos, entre las escorrentías y los otros cursos menores de agua. En la formación crecen algunos ejemplares de *Maihueniopsis glomerata* y *Trichocereus atacamensis*, cactus clasificados como “casi amenazados”. La distribución en el área de la formación se muestra en la Figura 4. Un aspecto del paisaje en la formación, en la Fotografía 6.

### b) Matorral con *Atriplex imbricata* y *Helogyne macrogyne* (LB2 H2 S1 e)

Esta formación tiene la fisionomía de un matorral de hasta 40 cm de altura, con una cobertura que alcanza hasta 10% (Fotografía 7). Las especies dominantes son los arbustos *Atriplex imbricata*, *Helogyne macrogyne* y *Adesmia atacamensis*. Se ubica en algunas de las escorrentías que presentan los sitios llanos. En la formación crecen algunos ejemplares de *Maihueniopsis glomerata*, cactus clasificado como “casi amenazado”. La distribución en el área de la formación se muestra en la Figura 4.

### c) Matorral con *Atriplex imbricata* y *Haplopappus rigidus* (LB 2 H1 S1 e)

Este tipo de vegetación tiene un carácter de matorral, con una altura que no supera los 50 cm y una cobertura de la vegetación total que puede llegar al 10% (Fotografía 8). Las especies dominantes son los arbustos *Atriplex imbricata*, *Haplopappus rigidus* y *Ephedra breana* (pingo-pingo). Se lo encuentra en las quebradillas un poco más profundas. En la formación crecen algunos ejemplares de *Maihueniopsis glomerata* cactus clasificado como “casi amenazado”. La distribución en el área de la formación se muestra en la Figura 4.

### d) Matorral con *Atriplex imbricata* y *Trichocereus atacamensis* (LB1 H1 S2 e)

Este tipo de vegetación tiene la fisonomía de un matorral de hasta 50 cm de altura, que incluye un número importante de ejemplares con baja cobertura del cactus *Trichocereus atacamensis* (cardón); la cobertura de la vegetación alcanza excepcionalmente hasta un 10% (Fotografía 9). Otras especies presentes en la formación son *Helogyne macrogyne* y *Ephedra breana*; entre las herbáceas destaca *Cistanthe cf. cabrerae*, entre las suculentas, el cactus columnar *Oreocereus variicolor*. Se ubica en quebradas no muy profundas con las laderas con suelo rocoso. En la formación es característica *Trichocerus atacamensis* (cardón) y también crece *Maihueniopsis glomerata*, ambas especies clasificadas como “casi amenazadas”. La distribución en el área de la formación se muestra en la Figura 4.

### e) Matorral con *Atriplex imbricata* (LB1 H1 S1 me)

La vegetación es homogénea y está dominada por el arbusto *Atriplex imbricata*, con una altura de hasta 50 cm y una cobertura de hasta 5% (Fotografía 10). Otras especies presentes son los arbustos *Acantholippia deserticola* (rica rica) y *Adesmia atacamensis* (allaval). Se ubica en quebradillas y laderas bajas con poca pendiente. En la formación crecen algunos ejemplares de *Maihueniopsis glomerata* cactus clasificado como “casi amenazado” y *Menonvillea rollinsii*, único endemismo regional en el trazado. La distribución en el área de la formación se muestra en la Figura 4.

### f) Matorral con *Atriplex imbricata y Adesmia atacamensis* (LB2 H1 S1 e)

La vegetación corresponde a un matorral de hasta 60 cm de altura, con una cobertura de hasta un 10% (Fotografía 11). A los arbustos dominantes se suman *Acantholippia deserticola*, *Adesmia erinacea* y *Ephedra breana*, entre las plantas herbáceas aparecen *Cistanthe celosioides*, *C. salsoloides* y *Neuontobotrys tarapacana*. Se ubica en un fondo de quebrada. *Maihueniopsis glomerata* especie casi amenazada, crece en algunos sectores de la formación. La distribución en el área de la formación se muestra en la Figura 4.
...
| Color | Número | Formación         | Dominantes         | Suelo desnudo | Nombre formación                        | Hábitat           |
|-------|--------|------------------|--------------------|--------------|------------------------------------------|-------------------|
| LB 1 H 1 S 1 me | Ai, cs, tm, mC | 95% | *imbricata* y *Maihueniopsis camachoi* | Llano rocoso      |
| 2     | LB 2 H 2 S 1 e | Ai - Aa - Hm | 90-95% | *imbricata* y *Helogyne macrogyne* | Escorrentías en llanos |
| 3     | LB 2 H 1 S 1 e | Ai, Eb, Hr, pp | 90-95% | *imbricata* y *Haplopappus rigidus* | Quebrada          |
| 4     | LB 1 H 1 S 2 e | Ai, cc, tA | 90-95% | *imbricata* y *Trichocereus*         | Ladera rocosas    |
| 5     | LB 1 H 1 S 1 me | Ai, cs, cc | 90-95% | *imbricata*                          | Ladera baja y quebradillas |
| 6     | LB 2 H 1 S 1 e | Ai, Aa, cs, mB | 85-90% | *imbricata* y *Adesmia*             | Quebrada abierta  |
| ZI    | ZONA INDUSTRIAL |            |              |              |                                          |                   |

**Arbustos**

- Aa: *Adesmia*
- Ai: *Atriplex imbricata*
- Eb: *Ephedra breana*
- Hr: *Haplopappus rigidus*
- Hm: *Helogyne macrogyne*
- Mr: *Menonvillea rollinsii*

**Hierbas**

- cc: *Cistanthe cabrerae*
- cs: *Cistanthe celosioides*
- pp: *Phacelia pinnatifida*
- tm: *Tetragonia microcarpa*

**Cactus**

- mC: *camachoi*
- mG: *Maihueniopsis glomerata*
- tA: *Trichocereus atacamensis*

**Código de rango de cobertura**
...
En el sector El Abra, las comunidades de vegetación difieren un poco de la versión inicial del trazado y la ubicación de la subestación eléctrica. En ese sector, en términos de la flora la diferencia principal es la aparición de cactus de tipo columnar, tales como *Trichocereus atacamensis* y *Oreocereus variicolor*, ausentes en el trazado anterior; ejemplares de ambas especies crecen aledaños a la nueva propuesta de trazado de la LTE, pero no habrá impactos sobre ellos.

La formación de vegetación más extendida del sector El Abra es un matorral bajo desértico de baja densidad con *Atriplex imbricata* como dominante; este tipo de vegetación ha sido incluido por Gajardo (1994) en su formación del Desierto de la Cuenca Superior del Río Loa endémica de la cuenca del río Loa, aunque las especies que la caracterizan sean de amplia distribución en la pre-puna del norte de Chile; de acuerdo con la composición de la flora, la asociación presente en el área sería la de *Atriplex imbricata* (ojalar o pilaya). En las quebradas más profundas se encuentra una comunidad con presencia de especies de la formación de la Estepa Arbustiva Pre-puneña, también de amplia distribución en las cordilleras de la I y II Región. Las quebradas ofrecen en el área refugio a este tipo de vegetación que es la dominante a mayor altitud, la asociación presente en el área es similar a la de *Fabiana ramulosa* (*F. densa*, checal)-*Baccharis boliviensis* (lejía).

En relación con la propuesta de Luebert & Pliscoff del piso del Matorral bajo desértico tropical andino con *Atriplex imbricata* y *Acantholippia punensis* (=A. deserticola) ampliamente representado en la pre-puna del altiplano en Chile. La comunidad de las quebradas, en tanto, correspondería a vegetación del piso del matorral bajo tropical andino de *Fabiana denudata* y *Chuquiraga atacamensis* que en el sector encuentra mejores condiciones hídricas en las quebradas, donde se refugia, y se hará dominante sobre los 3400 msnm.

---

# 7. CONCLUSIONES

Los sitios de la nueva propuesta de ubicación de la Subestación Eléctrica, Instalación de Faena y parte final del trazado de la LTE tienen una flora vascular y comunidades de vegetación que en general son similares a las de la propuesta ya aprobada en el EIA de la LTE Cerro Pabellón (RCA 168/2013), salvo en algunas quebradas cercanas a la S/E Gis Conchi donde crece vegetación correspondiente a una asociación de *Fabiana ramulosa* y *Baccharis boliviensis*, pero que no serán intervenidas por las obras el proyecto.
