...
## PLANTA DE TRATAMIENTO Y ESTERILIZACIÓN DE RESIDUOS HOSPITALARIOS HIMCE

### ANEXO 7: ESTUDIO DE FLORA Y VEGETACIÓN

**Elaborado para:** MAYO 2020
...
5. METODOLOGÍA ........................................................................................................... 9
   ...
   - 5.2 Levantamiento de información en terreno ........................................................... 9
     - 5.2.1 Definición y delimitación de las unidades homogéneas de vegetación ........ 13
   - 5.3 Descripción de la Flora Terrestre ....................................................................... 15
   - 5.4 Origen y Endemismo .......................................................................................... 17
   - 5.5 Estado de conservación ...................................................................................... 17
   - 5.6 Formaciones Vegetacionales Reguladas por la Ley N° 20.283/08 ...................... 17
   - 5.7 Singularidades ambientales ............................................................................... 19
6. RESULTADOS ............................................................................................................. 21
   - 6.1 Área de Influencia (AI) ....................................................................................... 21
   - 6.2 Antecedentes bibliográficos .............................................................................. 21
   - 6.3 Levantamiento de información en terreno ......................................................... 24
     - 6.3.1 Caracterización general del terreno ............................................................ 24
     - 6.3.2 Vegetación .................................................................................................. 25
     - 6.3.3 Flora ........................................................................................................... 27
7. CONCLUSIONES ......................................................................................................... 30
8. REFERENCIAS BIBLIOGRÁFICAS ................................................................................. 32
9. ANEXO FOTOGRÁFICO .............................................................................................. 33
...
- Tabla 6. Categorías de recubrimiento del suelo ............................................................... 13
- Tabla 7. Definición de categorías de uso de suelo y Formaciones vegetales .................... 14
- Tabla 8. Regiones Vegetacionales en Chile ...................................................................... 22
- Tabla 9. Resultados Carta de Ocupación de Tierras ......................................................... 25
- Tabla 10. Especies dominantes descritas en la COT ......................................................... 25
- Tabla 11. Listado de especies vegetales registradas en el área de estudio ....................... 27
...
- Figura 3. Área de Influencia del proyecto (AI) .................................................................. 21
- Figura 4. Resultados SIT CONAF ..................................................................................... 24
- Figura 5. Resultados COT ............................................................................................... 26
- Figura 6. Características del área de estudio ................................................................... 26
- Figura 7. Características del área de estudio (octubre 2019) ........................................... 27
- Figura 8. Hábito de especies vegetales registradas en el área de estudio ........................ 28
- Figura 9. Cardo mariano (*Silybum marianum*) ............................................................... 33
- Figura 10. Galega (*Galega officinalis*) ............................................................................ 33
- Figura 11. Totoras (*Typha angustifolia*) ......................................................................... 34
- Figura 12. Dedal de oro (*Eschscholzia californica*) .......................................................... 34
- Figura 13. Cardilla (*Carduus pycnocephalus*) .................................................................. 35
- Figura 14. Sauce llorón (*Salix babylonica*) ...................................................................... 35
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto inmobiliario “Planta de Tratamiento y Esterilización de Residuos Hospitalarios HIMCE”, en la ciudad de Los Ángeles, comuna homónima, región del Biobío.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Planta de Tratamiento y Esterilización de Residuos Hospitalarios Himce”, ubicado en la ciudad de Los Ángeles.
...
El Proyecto “Planta de Tratamiento y Esterilización de Residuos Hospitalarios HIMCE” se emplaza al sudeste de la comuna de Los Ángeles, Provincia de Biobío, Región del Biobío (Figura 1).
...
- **Carta:**
- **Escala:** 1:300,000
- **Simbología:** Ubicación georreferenciada del proyecto
- **Proyección:** WGS 1984 UTM H19S
...
- **Proyección:** WGS 84 UTM H19S
- *Fuente: Elaboración propia.*

**Tabla 1. Ubicación Georreferenciada del área del proyecto (polígono total).**

| Vértice | Coordenadas UTM Datum WGS84 19S | Este   | Norte   |
|--------|----------------------------------|--------|---------|
| A      |                                  | 735930 | 5855218 |
| B      |                                  | 735961 | 5855221 |
| C      |                                  | 735954 | 5855323 |
...
Las actividades en terreno se ejecutaron durante el día 9 de noviembre de 2019, se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
| 16 – 32 m               |        | 1 – 2 m                 |        |
| Más de 32 m             |        |                         |        |
| Tipo Herbáceo           |        | Tipo Suculento          | S      |
| 0 – 25 cm               |        | 0 – 25 cm               | S      |
| 25 – 50 cm              |        | 25 – 50 cm              | S      |
| 50 – 100 cm             |        | 50 – 100 cm             | S      |
| 1 – 2 m                 |        | 1 – 2 m                 |        |
...
Dada las características homogéneas de la cobertura vegetacional, se definieron transectos de recorrido de 4x100 m cada uno considerando los lugares más representativos de los distintos tipos vegetacionales para la identificación directa de las especies.

Se realizó una descripción cualitativa de la flora y vegetación presente en cada uno de los transectos. Se caracterizó a los tipos vegetacionales presentes, mediante la metodología de Carta de Ocupación de Tierras (COT) y se obtuvo documentación fotográfica de plantas y formaciones vegetales.

Cabe indicar que, los parámetros metodológicos utilizados, se encuentran en línea con los definidos en la Guía de evaluación ambiental, componente flora y vegetación (SAG 2010; CONAF 2014) y la metodología de campo de acuerdo con la “Guía para la descripción del área de influencia componentes suelo, flora y fauna de ecosistemas terrestres en el SEA” (2015).

#### 5.2.1 Definición y delimitación de las unidades homogéneas de vegetación

Para esta etapa, cabe señalar que primeramente se generaron polígonos preliminares de vegetación, mediante la delimitación de unidades homogéneas de vegetación, realizada a través de la fotointerpretación, apoyada sobre la base del uso de imágenes satelitales de alta resolución en color verdadero, disponibles a través del programa “Google EarthTM”.

Esta delimitación se realiza en función de las características de textura y color observadas en la imagen, las cuales sustentan la digitalización de dichas unidades a través del uso de Sistemas de Información Geográfica (SIG). Las unidades cartográficas definidas para la vegetación fueron homologadas a las categorías de recubrimiento de suelo disponibles en el sistema de información territorial (CONAF, 2016). Estas categorías, junto con sus definiciones, se detallan a continuación en la Tabla 6 y 7 respectivamente.

**Tabla 6. Categorías de recubrimiento del suelo**
...
*Fuente: SIT CONAF, 2019. Elaboración propia.*

**Tabla 7. Definición de categorías de uso de suelo y Formaciones vegetales.**

| Categoría                        | Definición |
|----------------------------------|------------|
| Áreas urbanas e industriales     | Sectores ocupados por instalaciones industriales, caminos y/o suelos removidos por maquinaria pesada. |
| Terrenos agrícolas               | Zonas destinadas a la producción agropecuaria. |
| Estepa Andina Central            | Estepa caracterizada por matorrales bajos (50 cm), clima continental, sobre 2,000 msnm. |
| Praderas anuales y perennes      | Praderas donde la cobertura herbácea supera el 25% y la de árboles/arbustos es menor al 25%. |
| Matorral Pradera                 | Cobertura arbórea <25%, arbusto 25-100%, herbáceo 25-100%. |
| Matorral                         | Arbóreo <5%, arbustivo dominante (5-75%), herbáceo 0-100%. |
| Matorral arborescente            | Árboles >2m, arbóreo 10-25%, arbusto 10-100%, herbáceas 0-100%. |
| Plantación                       | Terrenos plantados con especies forestales para fines industriales. |
| Plantación con exóticas asilvestradas | Bosque dominado por especies exóticas establecidas espontáneamente. |
| Bosque Nativo                    | Formaciones vegetales conformadas por especies nativas, predominio arbóreo, superficie >0.5 ha, ancho mínimo 40 m, cobertura de copa arbórea >10% (áridas) o >25% (favorables). |
| Bosque Mixto                     | Mezcla de bosque nativo y especies forestales plantadas (33-66% cada una). |
| Humedales                        | Superficies cubiertas de aguas naturales o artificiales, permanentes o temporales. |
| Áreas desprovistas de vegetación | Sectores donde la cubierta vegetal es nula o inferior al 5%. |
| Nieves y Glaciares               | Terrenos cubiertos por nieves permanentes. |
| Cuerpos de Agua                  | Cuerpos de aguas continentales. |
...
Para la componente Flora y Vegetación el Área de Influencia de este proyecto está definida como la superficie que coincide con la totalidad del terreno a utilizar para la construcción y operación del proyecto junto a una proyección de 50 metros (Figura 3).
...
- **Carta:**
- **Escala:** 1:3,000
- **Simbología:** Límites del proyecto, Área de influencia
- **Proyección:** WGS 1984 UTM H19S
- *Fuente: Elaboración propia.*
...
Según la clasificación de la vegetación natural chilena de Gajardo (1994), el área del proyecto se sitúa en la región del Bosque Caducifolio, que se extiende través de la zona centro sur de Chile, desde la V a la X región. La característica principal de esta zona es su clima mediterráneo de interior de estaciones muy marcadas, con períodos secos y lluviosos de duración semejante.

Debido a que esta es la zona del país con mayor población, el paisaje original ha sido modificado en gran parte siendo difícil encontrar muestras de vegetación inalteradas. Debido a las intervenciones humanas, principalmente plantaciones forestales, actualmente la vegetación natural de esta zona se presenta en forma de renuevos por monte bajo.

Particularmente en la región, el tipo forestal ha ocupado de preferencia una gran proporción de los terrenos planos y lomajes suaves, por lo cual, históricamente, ha sido talado para establecer siembras agrícolas, viñedos, terrenos para la crianza de ganado y asentamientos humanos. De esta forma, en la actualidad el área de estudio presenta también rasgos de terrenos agrícolas o de cultivo y matorral. Además, cabe mencionar que la zona estudiada perteneciente al área de influencia del proyecto, es un lugar altamente intervenido, ubicándose en un sector altamente urbanizado.

Por otra parte, de acuerdo a la clasificación de Gajardo (1994) Biobío se ubica en la subregión del Bosque Caducifolio del llano, específicamente, en el piso vegetacional Bosque Caducifolio de la Frontera, siendo éste una formación boscosa abierta, que se distribuye sobre suelos planos y lomajes en el sur este de la VIII Región. Está totalmente desaparecida por el uso de suelo en cultivos, praderas y plantaciones forestales.

Las composiciones de estos suelos de pradera muestran comunidades herbáceas muy frecuentes de los suelos erosionados y en situaciones de postcultivo. La mayor parte de sus componentes florísticos son introducidos, ruderales. Las especies representativas corresponden a *Agrostis tenuis, Avena fatua, Crepis capillaris, Rumex acetosella* y *Vicia sativa*. Especies acompañantes incluyen a *Anthemis cotula, Briza minor, Cynosorus echinatus, Lolium multiflorum, Polygonium aviculare, Silene gallica, Trifolium repens* y *Viola maculata*. Las formaciones arbustivas, muestran comunidades de matorrales abiertos que se encuentran en lugares degradados; las especies representativas incluyen *Aristotelia chilensis, Baccharis racemosa, Muehlenbeckia thamnifolia* y *Rubus ulmifolius*. Las especies acompañantes corresponden a *Berberis buxifolia, Dactylis glomerata, Berberis darwinii, Nothofagus obliqua* y *Rosa moschata*. Finalmente, la comunidad pratense, ruderal y de postcultivo frecuente en suelos erosionados tiene como especie representativa a *Echium vulgare*. Las especies acompañantes *Agrostis tenuis, Briza minor, Cynosorus echinatus* y otras comunes como *Hypericum perforatum, Lolium multiflorum, Verbascum thapsus* y *Vulpia megalura*.

Las especies ruderales que se encuentran en la zona en orillas de caminos, ríos y quebradas, prácticamente corresponden todas a especies introducidas, donde dominan *Acacia dealbata, Cytisus monspessulanus, Rubus ulmifolius* y *Sarothamus scoparius*.

### 6.3 Levantamiento de información en terreno

#### 6.3.1 Caracterización general del terreno

Según el Sistema Informativo territorial, las superficies por uso dentro de la comuna de Los Ángeles corresponden en total a 175,099 ha, de las cuales 65,434.5 ha corresponden a Bosques, 13,119.7 ha pertenecen a Praderas y matorrales, 4,485.9 ha son utilizadas como Áreas urbanas e Industriales, 88,964.7 ha son ocupados como Terrenos agrícolas, 373.5 ha corresponden a Áreas sin vegetación, mientras que 2,609.3 ha pertenecen a Cuerpos de agua, finalmente 111.8 ha corresponden a Humedales.

Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo que corresponde a terrenos agrícolas en su mayor superficie, así mismo en menor porcentaje a Praderas y matorrales, el cual al momento de la visita corresponde en su totalidad a una pradera de uso agrícola, predominando especies herbáceas de tipo maleza.

**Figura 4. Resultados SIT CONAF.**

- **Consultor:**
- **Carta:**
- **Escala:** 1:2,500
- **Simbología:** Límites proyecto, Rotación cultivo-Pradera, Infraestructura urbana
- **Proyección:** WGS 84 UTM H18S
- *Fuente: Elaboración propia*

#### 6.3.2 Vegetación

Mediante la metodología de la Carta de Ocupación de Tierras (COT) no se obtuvieron resultados significativos en relación a una diferenciación de unidades ambientales (Figura 5), la unidad ambiental identificada en el área del proyecto es tipo Pradera agrícola en desuso, la que muestra signos de haber acumulado humedad y donde predominan especies herbáceas denominadas malezas como *Carduus pycnocephalus, Sisymbrium officinale, Aira caryophyllea* y *Hordeum murinum*, además de la especie arbustiva *Rubus ulmifolius* entre otras más de origen exótico; la mayoría con características invasoras.

Además, se identificaron abundantes formaciones de *Typha angustifolia* asociados a las áreas cercanas al canal, también existe presencia escasa del estrato arbóreo, observándose individuos dispersos dentro del terreno o asociados al cuerpo de agua existente en el límite norte.
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| Pradera Agrícola | cp               | Zona Periurbana     | Herbáceo. Poco densa.     |                   |
|                  | so               | Herbáceo. Poco densa|                           |                   |
|                  | ac               | Herbáceo. Poco densa|                           |                   |
|                  | hm               | Herbáceo. Poco densa|                           |                   |
|                  | ta               | Herbáceo. Poco densa|                           |                   |
| LB               | Ru               | Arbustivo. Poco denso|                          |                   |
...
|---------------|--------------------------|-------|
| Herbáceo      | Carduus pycnocephalus    | cp    |
| Herbáceo      | Sisymbrium officinale    | so    |
| Herbáceo      | Aira coryophyllea        | ac    |
| Herbáceo      | Hordeum murinum          | hm    |
| Herbáceo      | Typha angustifolia       | ta    |
| Arbustivo     | Rubus ulmifolius         | Ru    |
...
- **Carta:**
- **Escala:** 1:1,000
- **Simbología:** Límites proyecto, Pradera agrícola, Infraestructura urbana
- **Proyección:** WGS 84 UTM H18S
- *Fuente: Elaboración propia*
...
La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 30 especies de plantas pertenecientes a 16 familias (Tabla 11). Todas las plantas registradas corresponden a especies introducidas. Mientras que el 77% de las especies pertenecen a formaciones con hábito herbáceo, 13% a arbóreo y 10% a formaciones con hábito arbustivo.

**Tabla 11. Listado de especies vegetales registradas en el área de estudio.**

| Familia         | Especie                   | Nombre común         | Origen | Hábito    |
|-----------------|--------------------------|----------------------|--------|-----------|
| Asteraceae      | Anthemis cotula          | Manzanilla bastarda  |        |           |
|                 | Carduus pycnocephalus    | Cardilla             |        |           |
|                 | Cirsium vulgare          | Cardo negro          |        |           |
|                 | Leontodon saxatilis      | Chinilla             |        |           |
|                 | Senecio vulgaris         | Hierba cana          |        |           |
|                 | Silybum marianum         | Cardo mariano        |        |           |
| Brassicaceae    | Sisymbrium officinale    | Mostacilla           |        |           |
| Convolvulaceae  | Convolvulus arvensis     | Correhuela           |        |           |
| Fabaceae        | Acacia dealbata          | Aromo                |        | Arbórea   |
|                 | Galega officinalis       | Galega               |        |           |
|                 | Robinia pseudoacacia     | Falsa acacia         |        | Arbórea   |
|                 | Teline monspessulana     | Retamilla            |        | Arbustiva |
|                 | Trifolium repens         | Trébol blanco        |        |           |
| Fumariaceae     | Fumaria capreolata       | Hierba de la culebra |        |           |
| Malvaceae       | Malva nicaeensis         | Malva común          |        |           |
|                 | Modiola caroliniana      | Pila-pila            |        |           |
| Papaveraceae    | Eschscholzia californica | Dedal de oro         |        |           |
| Plantagenaceae  | Plantago lanceolata      | Siete venas          |        |           |
| Poaceae         | Aira caryophyllea        | Pasto primavera      |        |           |
|                 | Briza minor              | Temblaredilla        |        |           |
|                 | Hordeum murinum          | Cebadilla            |        |           |
| Polygonaceae    | Rumex acetosella         | Vinagrillo           |        |           |
|                 | Rumex crispus            | Romaza               |        |           |
| Rosaceae        | Rosa rubiginosa          | Rosa mosqueta        |        | Arbustiva |
|                 | Rubus ulmifolius         | Zarzamora            |        | Arbustiva |
| Salicaceae      | Populus nigra            | Álamo                |        | Arbórea   |
|                 | Salix babylonica         | Sauce llorón         |        | Arbórea   |
| Scrophulariaceae| Veronica serpyllifolia   | Verónica             |        |           |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto Planta de tratamiento y esterilización de Residuos Hospitalarios HIMCE en términos de diversidad y presencia de especies de interés.
...
La flora y vegetación está compuesta principalmente por especies de formaciones herbáceas con abundante presencia de especies introducidas, muchas de ellas consideradas plantas invasoras. Las formaciones boscosas y arbustivas son escasas y de pobre representatividad, restringiéndose a 3 especies en el caso de los arbustos y cuatro especies en caso de los árboles, estos últimos ocupan una superficie inferior al 5% del terreno que ocupará el proyecto.

Las características vegetacionales del área de estudio están definidas por el alto grado de intervención antrópica (pastizal y presencia de escombros provenientes de construcción) facilitando el establecimiento de especies vegetales invasoras, las cuales no permiten el crecimiento de flora nativa.

La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación, estableciéndose unidades homogéneas en cuanto a su fisionomía (formación vegetal) y especies dominantes, de esta forma fue posible determinar que la unidad ambiental corresponde a una Pradera agrícola en desuso, la que muestra signos de haber acumulado humedad y donde predominan especies herbáceas denominadas malezas como *Carduus pycnocephalus, Sisymbrium officinale, Aira caryophyllea* y *Hordeum murinum*, además de la especie arbustiva *Rubus ulmifolius* entre otras más de origen exótico; la mayoría con características invasoras. Además, se identificaron abundantes formaciones de *Typha angustifolia* asociados a las áreas cercanas al canal, también existe presencia escasa del estrato arbóreo, observándose individuos dispersos dentro del terreno o asociados al cuerpo de agua existente en el límite norte.

La importancia y significación de la vegetación, no se centra únicamente en el papel que desempeña este elemento como asimilador básico de la energía solar, constituyéndose así en productor primario de casi todos los ecosistemas, sino también en la existencia de importantes relaciones con el resto de los componentes bióticos y abióticos del medio, generando funciones que se pueden traducir en servicios ecosistémicos: la vegetación es estabilizadora de pendientes, reduce la erosión, influye en la cantidad y calidad del agua, mantiene microclimas locales, filtra la atmósfera, atenúa el ruido, ayuda a resistir los efectos de plagas y enfermedades, es el hábitat de especies animales, etc.

Sin embargo, debido a la fuerte presión antropogénica del entorno se ha generado un terreno en constante degradación ecológica lo que permite la utilización de estos espacios para otros fines que contribuyan al desarrollo urbano de la comuna.

Finalmente, de acuerdo a los resultados de este estudio y las características del terreno en general, se concluye que el proyecto no presenta efectos significativos sobre la vegetación descrita para el área de influencia determinada.
...
- **Figura 9. Cardo mariano (*Silybum marianum*)**
- **Figura 10. Galega (*Galega officinalis*)**
- **Figura 11. Totoras (*Typha angustifolia*)**
- **Figura 12. Dedal de oro (*Eschscholzia californica*)**
- **Figura 13. Cardilla (*Carduus pycnocephalus*)**
- **Figura 14. Sauce llorón (*Salix babylonica*)**
