...
- BIBLIOGRAFÍA ...................................................................................................................31
- APÉNDICE 1 .............................................................................................................................35
  - 6.1 LISTADO TAXONÓMICO DE ESPECIES IDENTIFICADAS EN EL ÁREA DE INFLUENCIA .........35
...
| Tabla | Descripción |
|-------|-------------|
| 1 | Puntos de Muestreo realizados en Campaña de Primavera |
...
| 9 | Abundancia de las especies identificadas en parcelas de muestreo con cobertura igual o superior a 1%. |
| 10 | Tipos Biológicos de la Flora Vascular presente en el área de estudio. |
| 11 | Origen geográfico de la Flora registrada |
| 12 | Listado Taxonómico de Especies identificadas en el Área de Influencia |
...
- Figura 5. Fotografías correspondientes a la Unidad Vegetacional de “Cortina de árboles exóticos” identificada en el AI del Proyecto.
- Figura 6. Fotografías correspondientes a la Unidad Vegetacional de “Pradera de exóticas asilvestradas” identificada en el AI del Proyecto.
- Figura 7. Fotografías correspondientes a la Unidad Vegetacional de “Otros usos de suelo” identificada en el AI del Proyecto.
...
El presente informe da cuenta de la caracterización ambiental del componente flora y vegetación para el proyecto Rengo Solar, en adelante el “Proyecto”. Dicha caracterización se realizó de acuerdo con la información bibliográfica disponible y a la información técnica recopilada durante la ejecución de una campaña de terreno realizada en época de primavera 2020, el día 05 de octubre de dicho año. El Proyecto se ubica en la comuna de Rengo, Provincia de Cachapoal, Región del Libertador Bernardo O’Higgins, aproximadamente a 2 Km al Sur del centro urbano de dicha comuna.
...
En este sentido, el AI corresponde a aquella superficie de emplazamiento de las obras permanentes y temporales del Proyecto, más un área buffer de 20 metros alrededor de las obras perimetrales (cierre perimetral y líneas de evacuación eléctrica aérea, con su respectiva servidumbre), cuyo tamaño total es de 31,3 ha aproximadamente. De esta forma, el AI incluye la ubicación de los paneles fotovoltaicos y la línea de media tensión. En la Figura 1 se muestra la ubicación geográfica del AI (UTM DATUM WGS-84, Huso 19S).
...
|----------------|---------------|-------------|
| LA n           | 1:00          | Leñoso alto, con cubrimiento n (5 – 10%) Ralo |
| LB n           | 2:00          | Leñoso bajo, con cubrimiento n (10 – 25%) Muy abierto |
| H n            | 3:00          | Herbáceo, con cubrimiento n (25 – 50%) Abierto |
| S n            | 4:00          | Suculento, con cubrimiento n (50 – 75%) Semidenso |
| n = Cobertura (%) | 5:00        | > 75 Denso |

Fuente: Centre d'Etudes Phytosociologiques et Ecologiques Louis Emberger/Centre National de la Recherche Scientifique. Francia.
...
| MATORRAL ARBORESCENTE (Matorral con árboles) |      |         |          |           |            |               |
...
Desde la región de Valparaíso hasta la región del Biobío, incluida la Región Metropolitana de Santiago, los individuos en estado adulto deberán tener una altura mínima de un metro.
...
De acuerdo con los autores Luebert & Pliscoff (2006), el área de influencia se inserta dentro del piso vegetacional “Bosque espinoso mediterráneo interior de *Acacia caven* y *Prosopis chilensis*”, siendo éste un bosque espinoso abierto dominado por *Prosipos chilensis* y *Acacia caven*, que presenta una estrata arbustiva dominada por *Cestrum parqui, Muehlenbeckia hastulata, Schinus polygamus, Solanum ligustrinum* y *Proustia cuneifolia*. La estrata herbácea se encuentra dominada por especies alóctonas, tales como *Avena barbata* y *Cynara cardunculus*, reflejando el fuerte nivel de degradación que presenta este piso vegetacional. También presenta, de forma ocasional, especies esclerófilas como *Quillaja saponaria* y *Lithrea caustica*.

En cuanto a su composición florística, está conformado por *Acacia caven, Avena barbata, Baccharis linearis, B. paniculata, Bromus berterianus, Cestrum parqui, Colliguaja odorífera, Cynara cardunculus, Echinopsis chiloensis, Ligaria cuneifolia, Lithrea caustica, Maytenus boaria, Muehlenbeckia hastulata, Porlieria chilensis, Prosopis chilensis, Proustia cuneifolia, Quillaja saponaria, Schinus polygamus* y *Solanum ligustrinum*.

Con relación a la distribución, este ecosistema se encuentra en sectores planos o con pendiente suave en la depresión intermedia, en las regiones de Valparaíso, Metropolitana y de O´Higgins, entre los 200 y 800 m.s.n.m. Se encuentra en los pisos bioclimáticos termomediterráneo semiárido inferior y mesomediterráneo inferior semiárido y seco oceánico.

### 5.2 Resultado de la Prospección

#### 5.2.1 Vegetación

En función de lo prospectado en terreno, tras la corroboración de las unidades vegetacionales obtenidas de la fotointerpretación de imágenes satelitales, y las formaciones observadas, se determinaron tres Formaciones vegetacionales, correspondientes a:
...
|-------|-------------------------|------------------------------------------|-----------------------------------------|
| 1     | Cortina de árboles exóticos | 2,6 | 8,3 |
| 2     | Cultivos agrícolas | 1,9 | 6,1 |
| 3     | Pradera de exóticas asilvestradas | 25,7 | 82,1 |
| 4     | Otros usos de suelo | 1,1 | 3,5 |
| Total |                         | 31,3 | 100% |
...
Esta formación, dominada por especies exóticas, se presentó en los límites del AI, formando cortinas arbóreas (cerco vivo) bordeando caminos y limitando cultivos agrícolas (Figura 5).

En algunos puntos, se presentó una cortina de *Olea europea*, en donde dicha especie registró coberturas entre 25% y 50% y altura promedio entre 4 y 6 metros. El estrato arbóreo también presentó *Robinia pseudoacacia* y *Populus nigra*, con coberturas entre 5% y 15%. En algunos sectores se registró *Rubus ulmifolius*, con coberturas entre 5% y 15%. También se presentó un estrato herbáceo dominado por *Fumaria parviflora*, *Eschscholzia californica* y *Vulpia* sp., cuyas coberturas fluctuaron entre un 5% y un 25%.

En otros sectores, esta unidad formaba cortinas de *Populus nigra*, con coberturas entre 15% y 25%, y alturas entre 18 y 20 metros. Se registró la especie nativa *Maytenus boaria* en esta formación. También se presentó *Rubus ulmifolius* en dichos sectores, con coberturas entre 15% y 25%, y un estrato herbáceo dominado por *Raphanus raphanistrum, Fumaria parviflora, Lactuca virosa* y *Vulpia* sp., cuyas coberturas fluctuaron entre un 5% y un 25%. También se presentaron cortinas de *Robinia pseudoacacia*, con coberturas entre 15% y 25% y alturas superiores a 10 metros. El estrato arbóreo también presentó *Populus nigra* y *Salix babylonica*, con coberturas entre 5% y 15%, y en algunos sectores se encontraban cubiertos por *Rubus ulmifolius*, con coberturas entre 15% y 25%.
...
Esta formación se presentó únicamente en el buffer del AI, tanto del área de emplazamiento directo como en el área de servidumbre eléctrica, fuera del cierre perimetral del Proyecto, correspondiendo a cultivos agrícolas aledaños al área de emplazamiento de este.

Este tipo vegetacional comprende una superficie de 1,9 ha, que equivale al 6,1% del AI.

#### Pradera de exóticas asilvestradas

Formación dominante en el AI del Proyecto. A diferencia de la formación de cultivos agrícolas, este ambiente posee una dominancia de especies asilvestradas, formando una “pradera natural antropizada” (Figura 6). Las especies dominantes en este ambiente son *Eschscholzia californica* y *Erodium cicutarium*, en donde la primera presentó una cobertura promedio entre 25% y 50%, mientras que la segunda presentó coberturas entre 15% y 25% en algunos sectores, y en otros entre un 50% y un 75%. Otras especies codominantes en esta formación fueron *Rapistrum rugosum* y *Lactuca virosa*, con coberturas entre 5% y 25%, y *Carduus pycnocephalus*, con coberturas entre 5% y 15%.

En esta formación también se registró *Vittis* sp., en un punto de muestreo, presentando una cobertura entre 5% y 15%.
...
Esta unidad está conformada principalmente por caminos, edificaciones y cuerpos de agua. Presenta una superficie de 1,1 ha, lo que representa el 3,5% del AI (Figura 7).
...
Según los antecedentes recopilados en gabinete y tras las campañas realizadas en terreno, se pudo evidenciar la presencia de áreas con formaciones boscosas en el AI del Proyecto, sin embargo, estas formaciones son dominadas por especies alóctonas (*O. europea*, *P. nigra*, *R. pseudoacacia*). Si bien se registraron especies nativas, ninguna de éstas se encontraba formando un bosque (con una superficie mínima de 5.000 m2).

El resto del AI se compone principalmente de especies herbáceas y arbustivas exóticas asilvestradas, por lo que no existe presencia de formaciones xerofíticas. Dicho lo anterior y de acuerdo con el análisis de la normativa legal se ha determinado que:
...
En base a los resultados bibliográficos y los registros de terreno, no se registraron singularidades vegetacionales y florísticas encontradas en el AI del Proyecto de acuerdo con lo expresado en la “Guía de descripción de los componentes suelo, flora y fauna de los ecosistemas terrestres en el SEIA (SEA, 2015)”.

#### 5.2.4. Flora

##### 5.2.4.1. Riqueza Florística y Nomenclatura Taxonómica

La diversidad Florística presente en el área de influencia se determinó mediante la realización de 8 puntos de muestreo, anteriormente señalados, dentro del área de influencia del Proyecto abarcando la mayor cantidad de ambientes y/o unidades Vegetacionales. La riqueza total del AI fue de 30 especies (ver Tabla 12 más abajo).

La taxonomía de la diversidad florística identificada está definida sólo por la división *Magnoliophyta*, de las cuales 28 especies pertenecen a la clase *Magnoliopsida* y dos pertenecen a la clase *Liliopsida*. La clase *Magnoliopsida* está representada por especies representantes de 17 familias. De estas, destaca la familia *Asteraceae*, por presentar la mayor cantidad de especies, con 4 representantes.

Con respecto a la clase *Liliopsida*, ésta se encuentra representada sólo por la familia *Poaceae*, con dos representantes. La Figura 8 indica la composición de familias registradas en el AI del Proyecto.
...
De las 30 especies registradas en el área de estudio, se calculó la cobertura de cada una de éstas en función del promedio de cobertura por especie en el total de las 8 parcelas prospectadas.

Las especies de mayor abundancia son de origen Adventicio, y ninguna especie nativa presentó una cobertura total superior a un 1%. La especie con mayor cobertura fue *Eschscholzia californica*, con una cobertura entre 5% y 15%, lo cual se condice con la información extraída de la COT, cuyos resultados indicaron dominancia de la formación Pradera, en la que *E. californica* presentó la mayor cobertura. El resto de las especies registradas presentaron coberturas totales inferiores a un 5%.

En la Tabla 9 se presenta el índice de abundancia según Bran-Blanquet (1979), con la lista de especies que registraron una cobertura igual o mayor a 1%. Las especies que no se listan en esta tabla obtuvieron un índice de abundancia menor a 1% (“+” o “r”).
...
Respecto de los tipos biológicos identificados, se destaca que la composición florística y estructura vegetacional presente en el área de influencia, está definida principalmente por especies del tipo Herbáceo, con el 70,0%, seguido por el tipo Arbóreo, con 20,0%, y el tipo Arbustivo, con un 10,0%. A continuación, se presenta una tabla resumen de la proporción de los distintos tipos biológicos registrados en el área de influencia (Tabla 10).
...
Del total de especies registradas, un 86,7% es de origen Alóctono, un 13,3% de origen Nativo, mientras que no se registraron especies endémicas. La Tabla 11 entrega el resumen del origen geográfico de las especies detectadas y el porcentaje de contribución de cada grupo para el área en estudio.
...
Del total de especies prospectadas, sólo una se encuentra en la nómina de especies arbóreas o arbustivas originarias del país (D.S. 68/2009 del Ministerio de Agricultura), correspondiente al **maitén** (*Maytenus boaria* Molina).
...
En el área de influencia del Proyecto se presentan cuatro formaciones vegetales: Cortina de árboles exóticos, Cultivos agrícolas, Pradera de exóticas asilvestradas y Área con otros usos de suelo (no registrando formaciones nativas), en donde la pradera de exóticas asilvestradas, dominada por *Eschscholzia californica* y *Erodium cicutarium*, presentó la mayor cobertura, lo que demuestra que el AI se encuentra fuertemente intervenida y los ecosistemas naturales han sido sustituidos.

El Proyecto no afectará bosque nativo ni formaciones tipificadas en la legislación vigente. El área de estudio tampoco presenta las formaciones vegetales descritas por Luebert y Pliscoff. No se registraron singularidades ambientales ni formaciones xerofíticas en el AI del Proyecto.

El área de estudio presenta una vegetación predominantemente herbácea (70% de las especies registradas), lo que se rectifica con la COT, en donde dominan los ecosistemas de pradera (82,1% de la superficie COT corresponde a pradera de exóticas asilvestradas). Por este motivo, el Proyecto no afectará de forma significativa a la vegetación de la zona, pues la mayoría de las especies son plantas forrajeras, especies de producción agrícola y malezas.

En términos generales de la flora presente en el AI, la gran mayoría de las especies son exóticas (86,7%). Esto demuestra que en el área dominan ecosistemas antropizados, en donde el paisaje natural fue sustituido, dando la posibilidad del establecimiento de praderas naturales antrópicas.

No se registraron especies endémicas en el AI del Proyecto.

Se identificó una especie incluida en la nómina de especies arbóreas o arbustivas originarias del país (D.S. 68/2009 del Ministerio de Agricultura), correspondiente a *M. boaria*, la cual no se encuentra en categoría de conservación.

En cuanto a los decretos supremos y listados nacionales de Clasificación de Especies, no se registraron especies bajo Categoría de Conservación en el AI del Proyecto.

Finalmente, el Proyecto afectará principalmente en las áreas en donde se construirán los paneles y las áreas en donde existirá servidumbre eléctrica. Sin embargo, estas áreas no presentan vegetación singular, pues la mayoría de los puntos en donde se ubicarán paneles o cableado eléctrico se encuentran insertos en áreas de pradera o cerca de cortinas de vegetación exótica, sin afectar formaciones con dominancia de especies nativas.
...
|-------------------|--------------|----------|-------|---------|-----------------------|----------------------|
| Acacia dealbata Link | Aromo europeo | Fabaceae | | | | |
| Capsella bursa-pastoris L. | Bolsita del pastor | Brassicaceae | | | | |
| Carduus pycnocephalus L. | Cardo borriquero | Asteraceae | | | | |
| Cestrum parqui L'Hér. | Palqui | Solanaceae | Nativa | | Arbustiva |
| Conium maculatum L. | Cicuta | Apiaceae | | | | |
| Convolvulus arvensis L. | Correhuela | Convolvulaceae | | | | |
| Erodium cicutarium (L.) L’Hér. ex Aiton | Alfirelillo | Geraniaceae | | | | |
| Eschscholzia californica Cham. | Amapola de California | Papaveraceae | | | | |
| Fumaria parviflora Lam. | Hierba del lagarto | Papaveraceae | | | | |
| Galega officinalis L. | Galega | Fabaceae | | | | |
| Galium aparine L. | Lengua de gato | Rubiaceae | | | | |
| Geranium core-core Steud. | Core-core | Geraniaceae | Nativa | | |
| Hordeum sp. | - | Liliopsida | Poaceae | | | |
| Lactuca virosa L. | Lechuga silvestre | Asteraceae | | | | |
| Lamium amplexicaule L. | Ortiga mansa | Lamiaceae | | | | |
| Leontodon saxatilis L. | Chinilla | Asteraceae | | | | |
| Maytenus boaria Molina | Maitén | Celastraceae | Nativa | | |
| Olea europea L. | Olivo | Oleaceae | | | | |
| Oxalis laxa Hook. & Arn. | Vinagrillo | Oxalidaceae | Nativa | | |
| Papaver somniferum L. | Amapola | Papaveraceae | | | | |
| Populus nigra L. | Álamo negro | Salicaceae | | | | |
| Raphanus raphanistrum L. | Rabano silvestre | Brassicaceae | | | | |
| Rapistrum rugosum L. | Falso yuyo | Brassicaceae | | | | |
| Robinia pseudoacacia L. | Falso acacio | Fabaceae | | | | |
| Rubus ulmifolius Schott. | Zarzamora | Rosaceae | | | Arbustiva |
| Salix babylonica L. | Sauce | Salicaceae | | | | |
| Silybum marianum (L.) Gaertn. | Cardo mariano | Asteraceae | | | | |
| Urtica urens L. | Ortiga | Urticaceae | | | | |
| Vitis sp. | Parra | Vitaceae | | | Arbustiva |
| Vulpia sp. | - | Liliopsida | Poaceae | | | |
