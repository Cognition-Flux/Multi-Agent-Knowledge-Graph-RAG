...
4. DETERMINACIÓN Y JUSTIFICACIÓN DEL ÁREA DE INFLUENCIA .............................................. 10
    4.1 Determinación y justificación del área de influencia .............................................................. 10
5. METODOLOGÍA ....................................................................................................................... 12
    5.1 Vegetación potencial del área de estudio .............................................................................. 12
    5.2 Identificación y caracterización de las unidades vegetacionales ............................................ 12
        5.2.1 Antecedentes de la metodología COT .................................................................................... 12
    5.3 Cartografía del componente vegetacional ............................................................................. 13
    5.4 Catastro de la flora presente en el área de estudio ............................................................... 13
        5.4.1 Determinación de la composición y riqueza florística ............................................................ 13
        5.4.2 Origen fitogeográfico .............................................................................................................. 14
        5.4.3 Tipos biológicos ....................................................................................................................... 15
        5.4.4 Distribución en Chile ............................................................................................................... 15
        5.4.5 Especies en categoría de conservación................................................................................... 15
    5.5 Cumplimiento de la Ley 20.283 .............................................................................................. 16
    5.6 Singularidades ambientales .................................................................................................... 16
6. RESULTADOS ........................................................................................................................... 18
    6.1 Vegetación potencial en el área de estudio............................................................................ 18
    6.2 Vegetación presente en el área de estudio ............................................................................ 19
        ...
        6.2.2 Caracterización de las unidades vegetacionales ..................................................................... 20
            - Uso agrícola ............................................................................................................................. 20
            - Pradera ................................................................................................................................... 21
            - Plantación de *Eucalyptus camaldulensis* .............................................................................. 21
        Cartografía de unidades vegetacionales ................................................................................. 22
    6.3 Catastro de la flora presente en el área de estudio ............................................................... 23
        6.3.1 Composición y riqueza florística ............................................................................................. 26
        6.3.2 Origen fitogeográfico .............................................................................................................. 26
        6.3.3 Tipo biológico .......................................................................................................................... 27
        6.3.4 Distribución en Chile .............................................................................................................. 27
        6.3.5 Especies en categoría de conservación................................................................................... 28
    6.4 Ley 20.283 sobre recuperación del bosque nativo y fomento forestal .................................. 28
    6.5 Singularidades ambientales .................................................................................................... 28
        6.5.1 Presencia de formaciones vegetales únicas o de baja representatividad nacional ............... 28
        6.5.2 Presencia de formaciones vegetales relictuales ..................................................................... 29
        6.5.3 Presencia de formaciones vegetales remanentes .................................................................. 29
        6.5.4 Presencia de formaciones vegetales frágiles .......................................................................... 29
        6.5.5 Presencia de bosques de preservación ................................................................................... 29
        6.5.6 Presencia de ejemplares de especies vegetales clasificadas en categorías de conservación 30
        6.5.7 Presencia de especies vegetales protegidas por regulaciones especiales ............................. 30
        6.5.8 Presencia de especies endémicas ........................................................................................... 30
        6.5.9 Presencia de especies de distribución restringida .................................................................. 30
        6.5.10 Localización en o cercano al límite de distribución geográfica de la especie ......................... 30
        6.5.11 Localización en o cercano al límite altitudinal de la especie .................................................. 30
        6.5.12 Actividad en o colindante con sitios prioritarios para la conservación de la diversidad ........ 31
        6.5.13 Actividad en o colindante con áreas bajo protección oficial .................................................. 31
        6.5.14 Actividad en o colindante con Áreas Protegidas Privadas (App) ............................................ 32
        6.5.15 Actividad en o colindante con áreas de protección (Ley N°18.378) ....................................... 32
        6.5.16 Actividad en o colindante con o aguas arriba de Humedales ................................................. 32
7. CONCLUSIONES ....................................................................................................................... 33
8. BIBLIOGRAFÍA .......................................................................................................................... 34
...
- Tabla 1. Criterios para clasificar una formación vegetal compleja en zonas semi áridas y subhúmedas ............................................................................................................................................ 13
- Tabla 2. Codificación “abundancia relativa de flora” según criterio de BRAUN & BLANQUET. ........ 14
- Tabla 3. Origen fitogeográfico de la flora. ......................................................................................... 14
- Tabla 4. Tipos Biológicos de la Flora Vascular ................................................................................... 15
- Tabla 5. Formaciones vegetales presentes en el área del proyecto ................................................ 20
- Tabla 6: Listado florístico de especies presentes en el área del proyecto ........................................ 24
- Tabla 7: Resumen de la flora vascular presente en el área de estudio según clase taxonómica ..... 26
- Tabla 8. Familias con mayor número de especies respecto a área de estudio. ................................ 26
- Tabla 9. Usos de Suelo de la Región equivalentes con las formaciones del área de estudio ........... 28
- Tabla 10. Criterios de comparación de las formaciones vegetacionales presentes en el área de estudio respecto del catastro de la vegetación nativa de Chile ....................................................... 29

---

## ÍNDICE DE IMÁGENES

- Imagen 1: Vista general del Área de Estudio ...................................................................................... 6
- Imagen 2. Ubicación espacial del proyecto ......................................................................................... 7
- Imagen 3. Área de influencia del proyecto ....................................................................................... 11
- Imagen 4. Formación vegetacional del Área de Estudio según Gajardo (1994). .............................. 18
- Imagen 5. Piso vegetacional del área de estudio según Luebert y Pliscoff (2006). .......................... 19
- Imagen 6. Vista general de la formación Uso Agrícola. .................................................................... 20
- Imagen 7. Vista general formación Pradera. .................................................................................... 21
- Imagen 8. Vista general formación vegetacional Plantación de *Eucalyptus camaldulensis* ............. 21
- Imagen 9: Formaciones vegetacionales presentes en el área de estudio. ....................................... 23
- Imagen 10: Origen fitogeográfico ..................................................................................................... 27
- Imagen 11: Tipo biológico ................................................................................................................. 27
- Imagen 12: Sitio prioritario distante al área de influencia del proyecto. ......................................... 31
...
El proyecto consistirá en la construcción y operación de una nueva planta del tipo central solar fotovoltaica (CSF) productora de energía eléctrica, a través de la transformación de la energía solar en energía eléctrica por medio de 31,320 paneles fotovoltaicos móviles de 330 W cada uno. La energía generada será evacuada a la red de distribución existente mediante una línea de evacuación de 13,2 kV, esta línea tendrá una longitud de 2,2 km, aproximadamente.

La PFV tendrá una potencia de 9 MW y será construida en una superficie de 25,9 ha. La planta se construirá en una etapa que tendrá una duración de 6 meses, para tener 30 años de vida útil, finalizando con una fase de cierre que tendrá una duración de 4 meses.

El proyecto estará ubicado administrativamente en la comuna de Vallenar, provincia de Huasco, Región de Atacama.

**Imagen 1: Vista general del Área de Estudio**

En la Imagen 2. Ubicación espacial del proyecto se indican los vértices del polígono que demarcan el área de impacto directo del Proyecto sobre una superficie de 25,9 ha.
...
Realizar el levantamiento de la Línea de Base de Flora y Vegetación para el proyecto “Planta fotovoltaica Astillas”, comuna de Vallenar, Región de Atacama.
...
Con la información recopilada se determina que el área de influencia del proyecto para el componente flora y vegetación es de 28,12 ha en las cuales se desarrollan las obras y acciones del proyecto (imagen 3). Estas obras se agruparon en dos áreas, según las características propias de cada una:

- **Área Planta Fotovoltaica:** Área destinada la construcción y operación de los paneles fotovoltaicos transformadores de energía solar en eléctrica. Tiene una superficie de 25,92 ha lo que equivale al 92,2% del área de influencia del proyecto.
- **Área Línea de Evacuación:** En esta área se realizará la línea de conexión. El tendido tiene aproximadamente 2,192 m de largo y dado la formación vegetal de su alrededor se estimó un buffer de 5 m para cada lado del eje. Esto otorga una superficie de área de influencia de 2,19 ha, lo que representa el 7,8% del área de influencia.
...
Para definir las formaciones vegetacionales presentes en el área de estudio se realizó una campaña de terreno en otoño los días 01 y 02 de Agosto del año 2018.

El levantamiento de información de la vegetación se efectuó a escala 1:6,000 para toda el área analizada, por lo tanto, la cartografía presentada también se adecuó a dicha escala.
...
Según la tipología de GAJARDO R (1994), en “La Vegetación Natural de Chile”, la vegetación presente en el área de influencia se clasifica como la Región “del Desierto del Pacífico”, Sub-región “del Desierto del Pacífico”, formación “Desierto florido de los Llanos”. En términos generales, la Formación del Desierto Florido de los Llanos, se ubica en las llanuras arenosas entre Vallenar y Copiapó. Normalmente su fisonomía consiste en una cobertura rala de arbustos bajos, pero en su composición intervienen también numerosas hierbas efímeras o geófitas que surgen cuando las precipitaciones son abundantes en la época invernal. Las asociaciones presentes son las de *Skytanthus acutus* (cacho de cabra) - *Hippeastrum ananuca* (añañuca); *Skytanthus acutus*; *Encelia canescens* (como E. tomentosa) - *Nolana paradoxa*; *Nolana baccata* - *Cryptantha parviflora*.
...
El área de influencia del proyecto comprende una superficie total de 28,12 ha. El polígono corresponde principalmente en su extensión a terrenos agrícolas con 26,91 ha.

### 6.2.2 Caracterización de las unidades vegetacionales

#### Uso agrícola

Esta formación es la de mayor extensión en el área de estudio, abarcando 26,91 ha y se encuentra asociada a la planta fotovoltaica donde se ubicarán los paneles.

Se trata de un terreno para uso agrícola el cual presenta diferentes estados. Es posible observar plantaciones secas de maíz y plantaciones de lo mismo ya cosechadas.

Las especies herbáceas representativas son *Zea mayz* (Maíz) y algunos individuos aislados de *Baccharis linearis*, *Chenopodium ambrosoides* y *Asphodelus fistulosus*.

**Imagen 6. Plantaciones de Maíz**

#### Pradera

Esta formación se caracteriza por presentar un abundante pastizal de *Poa pratensis* la cual se mantiene por las aguas de los terrenos agrícolas superiores a esta. Abarca 0,7 ha equivalentes a 2,5% del área de influencia del proyecto.

Se pueden observar ejemplares de *Juncus articus* y varias herbáceas como *Brassica nigra* y *Plantago lanceolata*.

**Imagen 7. Vista general formación Pradera**

#### Plantación de *Eucalyptus camaldulensis*

Esta formación es la más pequeña del área de estudio, se ubicada en el sector oeste, con apenas 0,51 ha, lo cual representa el 1,8% del total del polígono. Se caracteriza por solo la presencia de especies arbóreas, específicamente individuos de *Eucalyptus camaldulensis*. Dado que esta formación se encuentra alejada del área de implantación de los paneles no se cortarán ni intervendrán los ejemplares presentes.

**Imagen 8. Vista general formación vegetacional Plantación de *Eucalyptus camaldulensis***

---

## Cartografía de unidades vegetacionales

De la fotointerpretación del terreno fue posible identificar 3 tipos vegetacionales. Cada una de estas unidades definidas *a priori*, fueron posteriormente verificadas en terreno y delimitadas mediante GPS, posteriormente verificadas y definidas mediante metodología COT. La cartografía se presenta en datum WGS 84, Huso 19S, a escala 1:6000, la que permite una adecuada apreciación del terreno (imagen 9).
...
Las especies que componen la unidad total del muestreo, diferenciadas por Clase, Familia, Nombre científico, Nombre Común, Tipo Biológico, Origen Fitogeográfico y el estado de conservación, se detallan en la siguiente tabla:

**Tabla 6: Listado florístico de especies presentes en el área del proyecto**

| Clase         | Familia         | Especie                        | Nombre Común         | Origen Fitogeográfico | Tipo Biológico | Est. de Conservación | RCE |
|---------------|----------------|--------------------------------|----------------------|----------------------|---------------|----------------------|-----|
| Gnetopsida    | Ephedraceae    | *Ephedra breana Phil.*         | Pingo Pingo          |                      |               |                      |     |
| Liliopsida    | Asphodelaceae  | *Asphodelus fistulosus L.*     | Varica de San José   |                      |               |                      |     |
| Liliopsida    | Juncaceae      | *Juncus articus Willd.*        | Junco                |                      |               |                      |     |
| Liliopsida    | Poaceae        | *Poa pratensis*                | Césped               |                      |               |                      |     |
| Liliopsida    | Poaceae        | *Zea mayz L.*                  | Maíz                 |                      |               |                      |     |
| Magnoliopsida |                | *Anthemis cotula L.*           | Manzanilla           |                      |               |                      |     |
| Magnoliopsida | Asteraceae     | *Baccharis linearis*           | Romerillo            |                      |               |                      |     |
| Magnoliopsida | Asteraceae     | *Cichorium intybus*            | Achicoria común      |                      |               |                      |     |
| Magnoliopsida | Asteraceae     | *Cynara cardunculus*           | Cardo                |                      |               |                      |     |
| Magnoliopsida | Asteraceae     | *Encelia canescens*            | Coronilla del fraile |                      |               |                      |     |
| Magnoliopsida | Geraniaceae    | *Erodium cicutarium*           | Alfilerillo          |                      |               |                      |     |
| Magnoliopsida | Brassicaceae   | *Brassica nigra*               | Mostaza negra        |                      |               |                      |     |
| Magnoliopsida | Brassicaceae   | *Nasturtium officinale*        | Berro                |                      |               |                      |     |
| Magnoliopsida | Chenopodiaceae | *Atriplex semibaccata*         |                      |                      |               |                      |     |
| Magnoliopsida | Chenopodiaceae | *Chenopodium ambrosoides*      | Paico                |                      |               |                      |     |
| Magnoliopsida | Fabaceae       | *Medicago sativa*              | Alfalfa              |                      |               |                      |     |
| Magnoliopsida | Fabaceae       | *Trifolium polymorphum*        | Trébol               |                      |               |                      |     |
| Magnoliopsida | Fabaceae       | *Vachellia caven*              | Espino               | Árbol                |               |                      |     |
| Magnoliopsida | Geraniaceae    | *Geranium core core*           | core core            |                      |               |                      |     |
| Magnoliopsida | Lamiaceae      | *Mentha piperita*              | Menta piperita       |                      |               |                      |     |
| Magnoliopsida | Myrtaceae      | *Eucalyptus camaldulensis*     | Eucalipto            | Árbol                |               |                      |     |
| Magnoliopsida | Plantaginaceae | *Plantago lanceolata*          | Siete venas          |                      |               |                      |     |
| Magnoliopsida | Plantaginaceae | *Veronica anagalis-Acuatica*   | Veronica Acuática    |                      |               |                      |     |
| Magnoliopsida | Plantaginaceae | *Veronica persica*             | Veronica             |                      |               |                      |     |
| Magnoliopsida | Primulaceae    | *Anagalis arvensis*            | Pimpinela escarlata  |                      |               |                      |     |
| Magnoliopsida | Solanaceae     | *Nicotiana glauca*             | Palqui extranjero    |                      |               |                      |     |
| Magnoliopsida | Chenopodiaceae | *Beta vulgaris* subsp. maritima| Acelga               |                      |               |                      |     |
| Magnoliopsida | Verbenaceae    | *Verbena litoralis*            |                      |                      |               |                      |     |

---

### 6.3.1 Composición y riqueza florística

La flora vascular del área del proyecto alcanza un total de 28 especies. Las especies registradas forman parte de 15 familias y 27 géneros.

De las 28 especies de plantas vasculares registradas, 1 corresponde a la Clase Gnetopsida, 4 corresponden a la Clase Liliopsida y 23 a la Clase Magnoliopsida.
...
|---------------|-----------------------------|----------------------------------------------------|------------------------|-------------------------------|
| Gnetopsida    | 1                           | 16                                                 | 3,6                    | 0,02                          |
| Liliopsida    | 2                           | 1,069                                              | 7,1                    | 0,04                          |
| Magnoliopsida | 25                          | 3,906                                              | 89,3                   | 0,49                          |
| Polypodiopsida|                             | 114                                                |                        |                               |
| **Total**     | **28**                      | **5,105**                                          | **100**                | **0,55**                      |

De acuerdo con la Tabla 7, la categoría taxonómica con mayor relevancia en cuanto a diversidad corresponde a la Clase Magnoliopsida con el 89,3% del total de especies registradas, mientras que la Clase Liliopsida representa el 7,1% de la flora del área de estudio.

Por otra parte, de las 15 familias registradas en el área de estudio (Tabla 6. Listado Florístico), las familias que registran la mayor diversidad de especies corresponden a Asteraceae, Fabaceae, Plantaginaceae y Chenopodiaceae cada una con tres especies, mientras que el resto abarca entre una y dos.
...
De las 28 especies, se determinó que 19 especies son introducidas (67,9%) y 9 especies son nativas de Chile (32,1%), no hay registro de especies endémicas.

**Imagen 10: Origen fitogeográfico**

### 6.3.3 Tipo biológico

Según la distribución por forma de crecimiento o tipo biológico de la flora presente en el área del proyecto las hierbas anuales son las más comunes, representando un 53,6% (15 especies), le siguen los tipos biológicos Hierba perenne con un 21,4% (6 especies), Arbusto con el 17,9% (5 especies), mientras que el tipo Árbol representa el 7,1% (2 especies).
...
### 6.3.4 Especies en categoría de conservación
...
De las especies identificadas y según el DS 68/2009 que establece, aprueba y oficializa la nómina de las especies arbóreas y arbustivas originarias, se detectó la presencia de 2 especies: *Vachellia caven* y *Baccharis linearis*. Para la primera especie solo se identificó un individuo y para la segunda solo individuos aislados en el terreno agrícola.
...
El análisis de la representatividad de las formaciones vegetacionales identificadas, se realizó a partir de una homologación entre las 3 formaciones vegetacionales descritas respecto de los antecedentes definidos de uso de suelo en el Catastro y Evaluación de Recursos Vegetacionales Nativos de Chile (CONAF 2016), para la Región de Valparaíso.

Si bien la información que presenta el Catastro y Evaluación de Recursos Vegetacionales Nativos de Chile fue levantada a una escala inferior a la utilizada en el presente estudio (Catastro 1:50,000 versus Estudio 1:5,000), presenta una referencia general de la vegetación de la Región (tabla 9).
...
|---------------------|-------------------------|
| Terrenos agrícolas  | 45,908.4                |
| Praderas            | 12,490.8                |
| Plantaciones        | Sin Información         |

Fuente: Sistema de Información Territorial, CONAF 2016.

Para el análisis de las formaciones vegetales se incluyeron las categorías Áreas urbanas e industriales, Pradera anual y Terrenos agrícolas. Los criterios utilizados para establecer la equivalencia se presentan en la Tabla 10.
...
|----------------------------------|---------------------------------------------------------------------------------------------------------|
| Uso agrícola                     | Para la presente formación es factible realizar la equivalencia con el uso denominado Terrenos agrícolas que para la Región de Atacama se definen con una superficie 45,908.4 ha |
| Pradera                          | Para la presente formación no existe equivalencia en el catastro dado que las praderas existentes en la Región de Atacama son Estepas andinas. |
| Plantaciones de *Eucalyptus camaldulensis* | Para la presente formación no existe equivalencia en el catastro ya que no existe superficie declarada con esta categoría |

El catastro vegetacional señala que los usos terrenos agrícolas cubren 45,908.4 ha de la Región de Atacama, de las cuales 27,27 ha se encuentran en el área de estudio, equivalentes al 0,06% de la superficie regional. Por lo tanto, no se registró la presencia de formaciones vegetales únicas o de baja representatividad nacional.
...
De acuerdo a las formaciones vegetales presentes el área del proyecto corresponde a terrenos agrícolas, es decir formaciones altamente intervenidas, no existen bosques de preservación en el área de estudio.
...
En el área de estudio no se identificaron especies endémicas.

### 6.5.9 Presencia de especies de distribución restringida
...
De acuerdo al listado florístico y a los antecedentes de la distribución geográfica de las especies identificadas en el proyecto, no se encontraron especies con límite en su distribución geográfica.
...
En el área de estudio se identificaron tres formaciones vegetales, que corresponden a “Terreno Agrícola”, “Pradera” y “Plantación de *Eucalyptus camaldulensis*”.

En total se registraron 28 especies vasculares, de las cuales 19 especies (67,9%) son introducidas y 9 (32,1%) son nativas. No se registraron especies endémicas.
...
- **D.S. 52** (2014). Décimo Proceso de Clasificación de especies Silvestres según su Estado de ...
