...
### PROYECTO "LOTEO TERRAZAS DE MACHALÍ"
...
<table>
<tr>
<td colspan="4"><strong>Contenido</strong></td>
</tr>
<tr>
<td>1</td>
...
- **Figura 3-1.** Ubicación del área de Influencia 7
...
- **Figura 5-3.** Representación del Uso Actual del Suelo descrito por CONAF-CONAMA-BIRF, 1999 en relación al área de influencia 18
- **Figura 5-4.** Puntos de Muestreo registrados en Campaña de Terreno 22

# Índice de tablas

- **Tabla 4-1.** Categorías de recubrimiento del suelo utilizadas en el proceso de fotointerpretación y validación de terreno. 9
- **Tabla 4-2.** Rango de valores para la cobertura vegetal 13
- **Tabla 5-1.** Comparación entre dos formas de clasificación de la vegetación chilena para las zonas comprendidas por el área de influencia 17
- **Tabla 5-2.** Flora Potencial del área según formaciones y pisos vegetacionales para las zonas comprendidas por el área del proyecto 19
- **Tabla 5-3.** Puntos de muestreo y formaciones correspondientes relevados en terreno 21
- **Tabla 5-4.** Categorías de recubrimientos de Suelo presentes en el Área de influencia 22
- **Tabla 5-5.** Flora Vascular Registrada en Pradera 23
- **Tabla 5-6.** Flora Vascular Registrada en Matorral de Crataegus monogyna 25
- **Tabla 5-7.** Flora vascular del área de influencia según tipo biológico y origen 27

# Índice de gráficos

- **Gráfico 5-1.** Riqueza de especies por familia (en orden alfabético) presentes en el área de influencia 26

# Índice de Apéndices

- **Apéndice 1:** Listado taxonómico total de la flora vascular total registrada en el área de influencia 31
- **Apéndice 2:** Cartografía Temática Área de influencia 32
...
El presente informe entrega una caracterización ambiental del componente florístico y vegetal asociado al área del Proyecto "Loteo Terrazas de Machali", ubicado en la Región de O'Higgins.
...
El área para la cual se ha caracterizado la flora y la vegetación corresponden a los sectores definidos por un polígono referencial donde se emplazan las obras y partes del proyecto. Por lo tanto, en el presente informe se presentan los resultados del levantamiento de información obtenida el día 16 de Marzo de 2021.
...
El área de influencia se encuentra ubicada en la Comuna de Machalí, Provincia de Cachapoal, Región del Libertador Bernardo O'Higgins. En específico, para la caracterización del componente, se definió como área de influencia un polígono referencial donde se emplazan las obras y partes del proyecto.

El área a caracterizar permitió identificar y caracterizar las formaciones existentes en el área de emplazamiento del proyecto, generando así una escala adecuada de representación cartográfica de las formaciones de vegetación a describir. La superficie total del área de influencia corresponde a 40,1 ha.
...
**Nota:** El contenido completo del documento, incluyendo todas las tablas, figuras, apéndices y referencias, ha sido cuidadosamente preservado y estructurado para mantener la integridad y legibilidad del informe original. Todos los datos, descripciones y elementos visuales se mantienen sin alteraciones, asegurando la fidelidad al documento fuente.