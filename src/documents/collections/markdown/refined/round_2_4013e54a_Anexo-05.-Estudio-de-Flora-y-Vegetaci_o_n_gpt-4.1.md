...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Valles de Lircay”, en la comuna de Talca, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Valles de Lircay”.
...
El proyecto “Valles de Lircay” se emplaza en el sector Norte de la ciudad de Talca (**¡Error! No se encuentra el origen de la referencia.**). El área de estudio se encuentra en una zona urbana que limita con la ruta K-510 que se conecta más adelante con las calles circunvalación Norte y Av. Lircay, además el área de estudio se encuentra a metros del Rio Claro de Talca. (**¡Error! No se encuentra el origen de la referencia.**).
...
VÉRTICES POLIGONO DEL PROYECTO
1:5.000
Valles de Lircay
...
Las actividades en terreno se ejecutaron durante el mes de Junio de 2017, se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
| 2. Vegetación peneclímax | 7. Cultivos intensificados |
| 3. Terrenos de pastoreo | 8. Invernaderos y Parques |
...
Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo de Uso Agrícola, el cual al momento de la visita se encuentra en un 80% con escasa vegetación, destacándose la pradera agrícola en desuso con presencia de malezas de tipo herbáceas que cubre la mayor parte del área del proyecto y un borde boscoso compuestos de especies arbóreas de origen introducidas que rodean el predio por orientación al Rio Claro.
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron dos unidades ambientales (Figura 5), las observaciones en terreno muestran una superficie tipo pradera agrícola en desuso, abarcando la mayor parte del predio en donde dominan especies de origen introducidas como es *Silybum marianum* (Cardo mariano) y *Hypochaeris radicata* (Hierba del chancho) además de presencia de estrata arbustiva como es el caso de la especie de *Rubus ulmifolius* (Zarza mora), y la segunda unidad ambiental Formación arbórea que abarca un 10% del área total compuestas por especies arbóreas de origen exóticas que bordean el predio, orientación al Rio que colinda con el área del proyecto (Figura 6, Figura 7). Entre las especies que predominan se encuentran *Acacia dealbata* (Aromo chileno) y *Eucalyptus globulus* (eucaliptus) las que poseen características invasoras.
...
|---------------------------|-------------------|---------------------|---------------------------|-------------------|
| Formación arbórea         | LA                | AD; EG              | Plantaciones de especies introducidas | Leñoso alto, escasa |
| Pradera agrícola en desuso| H                 | hr; sm              | Pradera natural degradada | Herbáceo, clara   |
...
CARTA DE OCUPACION DE TIERRAS (COT)
1:3.000
Pradera agrícola
Formación arbórea
Valles de Lircay
...
|--------------|------------------------|----------------------|------------|--------|
| Fabaceae     | *Acacia dealbata*      | Aromo chileno        | Arbóreo    |        |
| Myrtaceae    | *Eucalyptus globulus*  | Eucaliptus           | Arbóreo    |        |
| Rosaceae     | *Rubus ulmifolius*     | Zarza mora           | Arbustivo  |        |
| Apiaceae     | *Daucus carota*        | Zanahoria Silvestre  | Herbáceo   |        |
| Asteraceae   | *Hypochaeris radicata* | Hierba del Chancho   | Herbáceo   |        |
| Leguminosae  | *Medicago sativa*      | Alfalfa              | Herbácea   |        |
| Cyperaceae   | *Scirpus californicus* | Totora               | Herbácea   |        |
| Asteraceae   | *Silybum marianum*     | Cardo mariano        | Herbácea   |        |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Valles de Lircay”, en términos de diversidad y la presencia de especies de interés.
...
De acuerdo a su origen, un 100% de las especies identificadas en el área de estudio son consideradas como alóctonas, lo que implica que el área en estudio se encuentra altamente intervenida.

La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), estableciéndose dos unidades ambientales en el área de estudio: una superficie tipo pradera agrícola en desuso, abarcando la mayor parte del predio en donde dominan especies de origen introducidas como *Silybum marianum* (Cardo mariano) y *Hypochaeris radicata* (Hierba del chancho) además de presencia de estrata arbustiva como es el caso de la especie de *Rubus ulmifolius* (Zarza mora), y la segunda unidad ambiental Formación arbórea que abarca un 10% del área total compuestas por especies arbóreas de origen exóticas que bordean el predio, orientación al Rio que colinda con el área del proyecto. Entre las especies que predominan se encuentran *Acacia dealbata* (Aromo chileno) y *Eucalyptus globulus* (eucaliptus) las que poseen características invasoras.
