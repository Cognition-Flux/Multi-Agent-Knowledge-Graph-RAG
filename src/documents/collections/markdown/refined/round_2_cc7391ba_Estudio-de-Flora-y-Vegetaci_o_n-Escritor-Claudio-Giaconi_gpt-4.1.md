...
- Figura 10. Hábito de especies vegetales registradas en el área de estudio. ...................... 23
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Escritor Claudio Giaconi”, en la comuna de Curicó, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Escritor Claudio Giaconi”.
...
El proyecto “Escritor Claudio Giaconi” se emplaza en el sector Norte de la ciudad de Curicó (**¡Error! No se encuentra el origen de la referencia.**). El área de estudio se encuentra en una zona urbana que limita con la Calle El Boldo. (**¡Error! No se encuentra el origen de la referencia.**).

**Figura 1. Ubicación geográfica del área de estudio.**

- Consultor: Escritor Claudio Giaconi
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron dos unidades ambientales (Figura 5), las observaciones en terreno muestran una superficie tipo Pradera agrícola, abarcando la mayor parte del predio en donde dominan especies herbáceas de origen introducido como *Bromus hordeaceus* (Cebadilla), *Cynodon dactylon* (Césped), entre otras, y la segunda unidad ambiental de Formación arbórea compuesta por la especie *Populus nigra* (Álamo negro) especie arbórea de origen exótica que se concentra en los deslindes del predio.
...
|---------------------|-------------------|---------------------|---------------------------|-------------------|
| Formación arbórea   | LA                | RP                  | Formación compuesta por la especie arbórea *Populus nigra* de origen introducida que se concentra en los deslindes y cauce del predio. | Leñoso alto, escasa |
| Pradera Agrícola    |                   | Bm, cd              | Pradera agrícola degradada en desuso, dominando especies herbáceas introducidas con características invasoras. | Herbáceo, poco densa |
...
- Escala: 1:3,500
- Simbología: Pradera agrícola, Formación boscosa
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia.*
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Escritor Claudio Giaconi”, en términos de diversidad y la presencia de especies de interés.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), estableciéndose dos unidades ambientales en el área de estudio, una superficie tipo Pradera agrícola, abarcando la mayor parte del predio en donde dominan especies herbáceas de origen introducidas de características invasoras como *Bromus hordeaceus* (Cebadilla), *Cynodon dactylon* (Césped), entre otras, y la segunda unidad ambiental de Formación arbórea compuesta por la especie *Populus nigra* (Álamo negro) especie arbórea de origen exótica que se concentra en los deslindes del predio.
