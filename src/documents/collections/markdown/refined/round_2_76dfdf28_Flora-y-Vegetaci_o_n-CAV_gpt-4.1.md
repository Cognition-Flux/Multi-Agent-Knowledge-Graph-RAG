...
1. **Herbáceos (hierbas):** estratos vegetacionales conformados por especies cuyos tejidos no están lignificados.
2. **Leñosos Bajos (arbustos):** especies de tejidos lignificados, cuyo tamaño no sobrepasa los dos metros de altura, corresponden a especies de hábito arbustivo.
...
Las coordenadas de estos puntos de muestreo y su distribución espacial se presentan en la siguiente tabla y figura:
...
En cuanto al origen fitogeográfico, de las 35 especies de flora vascular identificadas, 6 de ellas corresponden a origen Nativo, de las cuales 2 corresponden a endémicas y las restantes 29 corresponden a exóticas, lo que es normal, dado el contexto vegetacional actual del sector donde se encuentra emplazada el área caracterizada.
