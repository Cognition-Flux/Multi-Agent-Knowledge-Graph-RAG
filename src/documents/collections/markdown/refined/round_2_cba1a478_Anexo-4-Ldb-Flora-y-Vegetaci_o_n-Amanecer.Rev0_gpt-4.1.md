...
En el marco de la elaboración de la Declaración de Impacto Ambiental (DIA) del Proyecto Fotovoltaico Amanecer (en adelante el Proyecto), ubicado a 3,5 km al este de la comuna de Sierra Gorda, en la Región de Antofagasta, el titular del proyecto El Cóndor Solar SpA ha realizado una caracterización ambiental del componente flora y vegetación para un área de estudio definida por el límite predial, el cual considera una superficie de 62,9 hectáreas más su respectiva línea de evacuación y camino de acceso.
