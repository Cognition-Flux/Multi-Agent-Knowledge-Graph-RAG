...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto *“Bicentenario X”*, en la comuna de Talca, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en el área de influencia del proyecto “Bicentenario X”.
...
El proyecto “Bicentenario X” se emplaza en la región del Maule en la ciudad de Talca, orientación Norte (Figura 1). El área de estudio se encuentra en una zona urbana que se conecta en 500 metros a la ruta K-511.
...
Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo de tipo Agrícola, el cual al momento de la visita se encuentra en un 90% con escasa vegetación, destacándose la pradera agrícola en desuso con presencia de malezas de tipo herbáceas que cubre la mayor parte del área del proyecto además de presencia escasa de especies arbóreas y arbustivas como *Rubus ulmifolius* (Zarza mora) de origen introducidas que se encuentran rodeando el predio.
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) no se obtuvieron resultados significativos en relación a una diferenciación de unidades ambientales (Figura 5), las observaciones en terreno muestran una superficie homogénea tipo pradera agrícola compuesta principalmente por especies herbáceas como *Daucus carota* (Zanahoria silvestre), *Hypochaeris radicata* (Hierba del chancho), *Silybum marianum* (Cardo mariano), entre otras las cuales cubren la mayor parte del terreno, también se encuentra presencia escasa de algunas especies arbóreas y arbustivas de origen introducidas (Figura 6, Figura 7).
...
|---------------------------|-------------------|---------------------|---------------------------|-------------------|
| Pradera agrícola en desuso| H                 | hr, sm, dc, af      | Pradera agrícola degradada compuesta principalmente por especies herbáceas y presencia escasa de especies arbóreas y arbustivas | Herbáceo, clara   |
...
La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 9 especies de plantas pertenecientes a 8 familias (Tabla 9). De las especies todas corresponden a especies introducidas, principalmente invasoras y ornamentales.
...
| Asteraceae  | *Silybum marianum*    | Cardo mariano        | Herbáceo   |        |
| Gramineae   | *Avena fatua*         | Avena silvestre      | Herbáceo   |        |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Bicentenario X”, en términos de diversidad y la presencia de especies de interés.
...
De acuerdo a su origen, un 100% de las especies identificadas en el área de estudio son consideradas como alóctonas. Cabe destacar que el promedio nacional de especies vegetales alóctonas es de un 15%, lo que es significativamente menor a lo detectado en este proyecto, lo que implica que el área en estudio se encuentra altamente intervenida.

La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), encontrándose solo una unidad ambiental, ya que no se obtuvieron resultados significativos en relación a una diferenciación de unidades ambientales. Las observaciones en terreno muestran una superficie homogénea tipo pradera agrícola compuesta principalmente por especies herbáceas de origen exótico como *Daucus carota* (Zanahoria silvestre), *Hypochaeris radicata* (Hierba del chancho), *Silybum marianum* (Cardo mariano), entre otras las cuales cubren la mayor parte del terreno, también se encuentra presencia escasa de algunas especies arbóreas y arbustivas de origen introducida.
