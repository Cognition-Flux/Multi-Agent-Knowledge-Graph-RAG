...
- **Predio:** Fundo Belen Hijuela Oriente *(Planta Avícola El Peumo)*
- **Rol:** 00089-00414
- **Propietario:** Banco de Crédito e Inversiones
...
1. Estudio de la cartografía presente en gabinete (mapas, imagen satelital y levantamiento).
2. Exploración en terreno (descripción de calicatas, fotografías y muestreo).
3. Análisis físico y químico en laboratorio.
4. Preparación de la memoria técnica.
...
| Identificación | Latitud S | Longitud E |
|---------------|-----------|------------|
| Calicata 1 (C1) | 5986489   | 768930     |
| Calicata 2 (C2) | 5986393   | 769066     |
| Calicata 3 (C3) | 5986451   | 769256     |
| Calicata 4 (C4) | 5986684   | 768794     |
...
- **Serie Quella:** Miembro de la Familia fina, smectítica, térmica de los Aquic Durixererts (Vertisol). Suelo en posición baja de plano depositacional (lacustrino); textura franco arcillosa y color pardo grisáceo muy oscuro en superficie; textura arcillosa (arcilla densa) y color gris oscuro en profundidad. Estructura prismática gruesa. Topografía plana, permeabilidad lenta, drenaje imperfecto y escurrimiento superficial muy lento. Substrato de toba volcánica. Variación representativa: QLA–1, suelos de textura superficial arcillosa, ligeramente profundos, planos y de drenaje imperfecto. Capacidad de Uso IVs8 (CIREN, 1999).

- **Serie Parral:** Miembro de la Familia fina, mixta, térmica de los Aquic Haploxeralf (Alfisol). Suelos sedimentarios, derivados de toba volcánica, en posición de terraza remanente. Textura franco arcillosa en superficie y arcillosa en profundidad, sobre substrato de toba volcánica. Topografía plana, moderadamente profundo, drenaje moderado, permeabilidad moderadamente lenta y escurrimiento superficial muy lento. Variación representativa: PRL–4, Fase de textura superficial franco arcillosa y franca, ligeramente profunda, casi plana con 1 a 3% de pendiente y de drenaje imperfecto. Capacidad de Uso IIIw8 (CIREN, 1999).
...
|------------------|-------------|
| 0 - 30           | Color en húmedo 10YR 5/3 pardo. Estructura masiva, grado fuerte. Consistencia en seco extremadamente dura, en húmedo muy firme, en mojado plástico y muy adhesivo. Textura arcillosa. Suelo muy compactado, escasa presencia de raíces. Moteados grises y comunes, concreciones comunes (mal drenaje). Límite lineal ondulado. |
| 30 - 150         | Color en húmedo 10YR 4/2 pardo grisáceo oscuro. Estructura de bloques subangulares que rompen a angulares, tamaño medio a fino, grado moderado a fuerte. Consistencia dura en seco, firme en húmedo, ligeramente plástico y ligeramente adhesivo en mojado. Textura areno francosa. Suelo muy compactado en forma de panes arcillosos, escasa presencia de raíces. Moteados rojizos grisáceos abundantes. |
...
| Drenaje                  | W1                  |                     |
| Textura                  | Muy fina (Arcillosa)| Gruesa (Areno francosa) |
| Agua aprovechable        | 6                   | 7                   |
| Pedregosidad en perfil   | DP1                 | DP2                 |
| Erosión                  | E1                  |                     |

**Observaciones:** D2 (suelo delgado), P1 y DP1 (Sin Pedregosidad), DP2 (Pedregosidad ligera), W1: Muy pobremente drenado, W2: Pobremente drenado, E1: (Erosión no aparente). Pedregosidad superficial es relleno para construcción, no parte del perfil natural.
...
| Profundidad (cm) | Descripción |
|------------------|-------------|
| 0 - 24           | Color en húmedo 10YR 3/2 pardo grisáceo muy oscuro. Estructura de bloques subangulares, tamaño fino, grado moderado. Consistencia en seco dura, en húmedo friable a firme, en mojado ligeramente plástico y no adhesivo. Textura arcillosa. Escasas raíces. Límite lineal claro. |
| 24 - 42          | Color en húmedo 10YR 3/3 pardo oscuro. Estructura de bloques subangulares que rompen a angular, tamaño medio, grado fuerte. Consistencia extremadamente dura en seco, firme en húmedo, plástico y adhesivo en mojado. Textura arcillosa, suelo muy compactado. Escasa raíz con oxidación radicular (nódulos ferrosos), moteados grisáceos y rojizos. Límite ondulado claro. |
| 42 - 100         | Color en húmedo 10YR 4/3 pardo a pardo oscuro. Estructura de panes masivo, tamaño medio a fino, grado moderada. Consistencia dura en seco, firme en húmedo, plástico y muy adhesivo en mojado. Textura franco arenosa. Estratas laminares tipo panecillos, escasa presencia de raíces. |
| 100+             | Matríz arenosa gruesa, color pardo grisáceo azulado, abundantes concreciones. |
...
| Profundidad              | D2                  |                     |                     |
| Pendiente                | 0,3%                |                     |                     |
| Pedregosidad superficial | P1 (Ligera)         |                     |                     |
| Drenaje                  | W4                  |                     |                     |
| Textura                  | Muy fina (Arcillosa)| Muy fina (Arcillosa)| Moderadamente gruesa (Franco arenosa) |
| Agua aprovechable        | H3 (Regular)        | H3 (Regular)        | H2 (Buena)          |
| Pedregosidad en perfil   | DP1                 | DP1                 | DP2                 |
| Erosión                  | E1                  |                     |                     |

**Observaciones:** D2 (suelo delgado), P1(Sin pedregosidad ), DP2 (Pedregosidad ligera), DP1 (Sin pedregosidad), W2: pobremente drenado, W4: Drenaje moderado, E1 (Erosión no aparente).
...
| Profundidad (cm) | Descripción |
|------------------|-------------|
| 0 - 16           | Color en húmedo 10YR 3/2 pardo grisáceo oscuro. Estructura bloques subangulares que rompen a angular, tamaño medio a fino, grado fuerte a moderada. Consistencia en seco dura a muy dura, en húmedo firme, en mojado ligeramente plástico y ligeramente adhesivo. Horizonte compactado. Textura franca. Escasa presencia de raíces (nódulos ferrosos). Limite lineal gradual. |
| 16 - 44          | Color en húmedo 10YR 3/2 pardo grisáceo muy oscuro. Estructura de bloques subangulares que rompen a angulares, tamaño a muy dura en seco, firme en húmedo, plástico y ligeramente adhesivo en mojado. Horizonte muy compactado. Textura franco arcilloso. Presencia moderada de raíces de variados tamaños (fina a media). Moteados rojizos y grises comunes. Concreciones en formación comunes. |
| 44 - 115         | Color en húmedo 10YR 4/4 pardo amarillento oscuro. Estructura de bloques subangulares que rompen a angulares, tamaño medio a fino, grado fuerte a moderada. Consistencia extremadamente dura a muy dura en seco, firme en húmedo, plástico a ligeramente adhesivo en mojado. Textura franco arcillosa. Escasas raíces, suelo muy compacto. |
...
| Pedregosidad superficial | P1 (Sin Pedregosidad)|                    |                     |
| Drenaje                  |                     |                     |                     |
| Textura                  | Media (Franca)      | Moderadamente fina (Franco arcillosa) | Moderadamente fina (Franco arcillosa) |
| Agua aprovechable        | 6                   | 7                   |                     |
| Pedregosidad en perfil   | DP1                 | DP2                 | DP2                 |
| Erosión                  | E1                  |                     |                     |

**Observaciones:** D4 (suelo moderadamente profundo), P1 y DP1 (Sin Pedregosidad), DP2 (Pedregosidad ligera), W2: Pobremente drenado, E1: (Erosión no aparente). En horizonte 2 se observan oxidaciones formando fierrillo y nódulos y roca arenisca degradándose.
...
| Profundidad (cm) | Descripción |
|------------------|-------------|
| 0 - 75           | Color en húmedo 10YR gris oscuro. Estructura masiva, grado fuerte. Consistencia en seco extremadamente dura, en húmedo muy firme, en mojado plástico y adhesivo. Textura arcilloso. Suelo muy compactado, escasa presencia de raíces. Moteados rojizos, grises y azulados comunes. Concreciones en formación. Limite ondulado claro. |
| 75 - 150+        | Color en húmedo 10YR 3/2 pardo grisáceo muy oscuro. Estructura de bloques subangulares que rompen a angulares, tamaño fino a medio, grado moderado. Consistencia dura en seco, friable en húmedo, no plástico y no adhesivo en mojado. Textura franco arenosa. Escasa presencia de raíces, material que tiende a formar capas ferrosas y muy compactas. Moteados rojizos y azulados abundantes. Concreciones en formación comunes. |
...
| Pedregosidad superficial | P1 (Sin Pedregosidad)|                    |
| Drenaje                  | W1                  |                     |
| Textura                  | Muy fina (Arcillosa)| Moderadamente gruesa (Franco arenosa) |
| Agua aprovechable        | 6                   | 7                   |
| Pedregosidad en perfil   | DP1                 | DP2                 |
| Erosión                  | E1                  |                     |

**Observaciones:** D2 (suelo delgado), P1 y DP1 (Sin Pedregosidad), DP2 (Pedregosidad ligera), W1: Muy pobremente drenado, W2: Bien drenado, E1: (Erosión no aparente). En horizonte 2 se observan oxidaciones formando fierrillo y nódulos y roca arenisca degradándose.
...
| Tamiz (mm)      | % Retenido (3-3) | % Retenido (4-3) |
|-----------------|------------------|------------------|
| 25,0 - 19,0     | 0,00             | 0,00             |
...
La velocidad de infiltración es la velocidad con que el agua penetra en forma vertical en el suelo o el volumen de agua que penetra en el perfil de suelo por unidad de superficie y de tiempo. Se expresa en cm/hr o mm/hr. Es una propiedad muy variable, que depende entre otros factores de: textura, estructura, compactación, pendiente, sales, sólidos en suspensión, cubierta vegetal, materia orgánica y grietas (Quezada, 2012).

Existe un método clásico para determinar la velocidad de infiltración del suelo, que es el método del cilindro infiltrómetro. El método consiste en una prueba de terreno que utiliza un anillo metálico o de PVC. En él se agrega agua, al igual que alrededor de él, formando un dique alrededor del cilindro para luego medir como varía la altura de esta en el cilindro.

**Figura 5.** Determinación de velocidad de infiltración, Planta Ñiquén

La evaluación se hizo frente a la calicata N° 2 y los resultados obtenidos muestran que el agua presenta una buena velocidad de infiltración, con un valor de 7,6 cm/hr (o 76 mm/hr), como infiltración básica luego de 2 horas de evaluación. Éste es un valor más alto que los comúnmente encontrados en suelos arcillosos, lo que puede deberse a que al ser tan arcilloso el suelo puede presentar ciertas grietas por el fenómeno de cuarteo que sufren las arcillas, y por ahí pudo infiltrar más fácilmente el agua.
...
Desde el punto de vista agronómico, los principales motivos para realizar análisis químicos de los suelos son:
- Satisfacer la demanda de información para la clasificación de suelos.
- Generar información para el manejo y mejoramiento de los suelos, particularmente de aquellas áreas afectadas por sales.
- Determinar el impacto ecológico de algunas prácticas agronómicas o el efecto de la contaminación ambiental.
- Evaluar el estado de la fertilidad para recomendar fertilizantes.
...
Para evaluar la fertilidad de estos suelos se obtuvieron dos muestras de suelo:
- **Ñiquén 1:** extraída en sector Norte de la Planta entre calicatas N°2 y N°3
- **Ñiquén 2:** extraída en sector Sur de la Planta entre calicatas N°1 y N°4

Cada muestra está conformada por 10 submuestras obtenidas siguiendo un trayecto en forma de “X”.
...
*(Ver Anexo para datos completos)*
...
Dentro de las especies gramíneas se encuentra presente el triguillo (*Bromus hordeaseus*), también especies como la tembladera (*Briza minor*), que es una planta herbácea perteneciente a la familia de las poáceas.
...
En los últimos años no se han desarrollado cultivos agrícolas, por lo que el predio ha visto un normal desarrollo de vida silvestre.
...
*(Datos completos en el anexo original)*
