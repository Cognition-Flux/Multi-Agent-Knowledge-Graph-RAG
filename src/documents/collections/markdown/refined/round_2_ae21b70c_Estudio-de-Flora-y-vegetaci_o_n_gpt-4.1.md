...
6. RESULTADOS ............................................................................................................. 17
   6.1 Definición del Área de influencia (AI) ................................................................ 17
...
La línea de base consiste en la descripción detallada del área de influencia de un proyecto o actividad, en forma previa a su ejecución. Constituye, además, uno de los contenidos mínimos exigidos por la Ley N° 19.300, sobre Bases Generales del Medio Ambiente, para la elaboración de Estudios y Declaraciones de Impacto Ambiental, lo cual permite evaluar los impactos que pudiesen generarse o presentarse sobre los elementos del medio ambiente.
...
El presente estudio de Línea Base de Flora y vegetación corresponde al proyecto “Valles del Country III B” de la inmobiliaria Independencia S.A., realizado en el marco de la evaluación ambiental de dicho proyecto.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en el área de influencia del proyecto “Valles del Country III B”.
...
El proyecto “Valles del Country III B” se emplaza en el sector norte de la ciudad de Talca (Figura 1). El área de estudio se encuentra en una zona urbana que limita con la Avenida Lircay y distante aproximadamente 2 km de la confluencia del río Lircay con el río Claro.
...
Se define un polígono de 6 vértices para delimitar el área del proyecto, en una superficie aproximada de 7,9 ha. (Figura 2).
...
| Vértice | Coordenadas UTM Datum WGS84 H19S |
|--------|-----------------------------------|
|        | Norte      | Este                 |
| A      | 6077803    | 263370               |
| B      | 6077786    | 263794               |
...
## 6.1 Definición del Área de influencia (AI)

Para la componente Flora y Vegetación el Área de influencia de este proyecto está definida como la superficie que coincide con la totalidad del terreno a utilizar para la construcción y operación del proyecto junto a una proyección de 10 metros (Figura 3).
...
Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo de Uso Agrícola, el cual al momento de la visita se encuentra en un 90% construido. A su vez destacar que su entorno se encuentra caracterizado por otras construcciones, siendo un lugar con gran desarrollo inmobiliario dentro de la comuna.
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvo una unidad ambiental (Figura 5), las observaciones en terreno muestran una superficie homogénea tipo pradera antropizada rodeada de infraestructura habitacional (Figura 6).
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| A. Pradera en desuso | H | cd | Pradera natural degradada | Herbáceo, muy escasa |
...
| Herbácea      | *Taraxacum officinale*   | to    |
| Herbácea      | *Trifolium repens*       | tr    |
| Herbácea      | *Hypochaeris glabra*     | hg    |
...
La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 8 especies de plantas pertenecientes a 7 familias (Tabla 9). De las especies registradas todas corresponden a especies introducidas, pero no consideradas invasoras. Se registró la presencia de un ejemplar de *Araucaria angustifolia* y *Citrus limon (L.) Burm* dentro del área de estudio como se observa en la Tabla 9.

**Tabla 9: Listado de especies vegetales registradas en el área de estudio.**

| Familia        | Especie                | Nombre común      | Hábito    | Origen     |
|---------------|------------------------|-------------------|-----------|------------|
| Salicaceae    | *Cynodon dactylon*     | Pasto bermuda     | Herbáceo  | Introducida|
| Araucariaceae | *Taraxacum officinale* | Diente de león    | Herbáceo  | Introducida|
| Arecaceae     | *Trifolium repens*     | Trébol            | Herbáceo  | Introducida|
| Rutaceae      | *Hypochaeris glabra*   | Hierba del chancho| Herbáceo  | Introducida|

*Fuente: Levantamiento en terreno. Elaboración propia.*

#### 6.3.3.2 Estado de conservación

De acuerdo a la revisión de antecedentes y la normativa vigente de nuestro país, las especies registradas no se encuentran en ninguna categoría del Reglamento de clasificación de especies ya que corresponden a especies exóticas.

---

# 7. CONCLUSIONES

En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Valles del Country III B”, en términos de diversidad y la presencia de especies de interés.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación, una unidad ambiental una de tipo pradera abierta, con presencia escasa de pastizales reducida a un parche colindante a pasados proyectos inmobiliarios, de esta forma fue posible determinar que la mayor cobertura del área de estudio se encuentra intervenida, observándose solo especies herbáceas como *Cynodon dactylon* y *Taraxacum officinale*, entre otras.

Debido a las características del estudio, se estima que el proyecto no contempla una afectación significativa, debido al grado de antropización, por lo que las condiciones no pueden verse más empobrecidas.
