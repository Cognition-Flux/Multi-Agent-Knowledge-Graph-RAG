...
El Proyecto se ubica en la comuna de Antofagasta, Provincia de Antofagasta, Región de Antofagasta; y corresponde a la construcción y operación de una Planta Fotovoltaica, constituida por 28,224 paneles fotovoltaicos de 380 Wp cada uno; que en conjunto tendrán una potencia nominal de generación de 9 MW que serán inyectados al Sistema Eléctrico Nacional (SEN).

La superficie total proyectada de Planta equivale a 21.04 hectáreas, a lo cual se adiciona la implementación de una línea de evacuación de media tensión (LMT; 23 kV), que contará con una longitud aproximada de 181 metros y superficie aproximada de 0.14 hectáreas, además de un camino de acceso que contará con una longitud aproximada de 39.83 metros y superficie aproximada de 0.02 hectáreas, de lo que se desprende una superficie total de ocupación del Proyecto equivalente a 21.2 hectáreas.
...
Previo al análisis de flora se realizó una revisión bibliográfica para contextualizar el trabajo en terreno y reconocer el piso bioclimático y las formaciones y pisos vegetacionales principales en los que se encuentra enmarcada la Provincia de Antofagasta, en la cual se emplazará el Proyecto. Para esto se revisó la obra de Gajardo (1994) y la de Luebert & Pliscoff (2017). El ecosistema se caracterizó siguiendo la bibliografía citada anteriormente y se basó en la identificación de las formas de crecimiento dominantes en los diferentes estratos de vegetación. Adicionalmente, se consultaron los antecedentes disponibles en la plataforma del Sistema de Evaluación de Impacto Ambiental (SEIA), sobre proyectos con Resolución de Calificación Ambiental (RCA) favorable que se encuentran referenciados en el entorno del AI del Proyecto.
...
La identificación de especies se realizó *in situ*. Para las especies que no pueden ser reconocidas en terreno, se colectan muestras representativas de cada ejemplar encontrado, para posteriormente utilizar claves taxonómicas y/o su descripción original. Para esto, las muestras son almacenadas en bolsas herméticas, y posteriormente se colocan en una prensa para su revisión e identificación.

Para la asignación de nombres científicos, autores, forma de crecimiento, origen y posición taxonómica de cada especie, se revisan diversas fuentes, como páginas web, libros de flora y guías de campo, y la información se corrobora en base al listado de Zuloaga *et al.* (2008). Algunas de las fuentes consultadas incluyen la base de datos del Laboratorio de Invasiones Biológicas de la Facultad de Ciencias Forestales de la Universidad de Concepción (www.lib.udec.cl), los volúmenes editados de la “Flora de Chile” (Marticorena & Rodríguez 1995, 2001, 2003), así como la “Guía de Campo de Helechos nativos del centro y sur de Chile” (Rodríguez *et al.* 2009), “Guía de Campo de Trepadoras, Epífitas y Parásitas” (Marticorena *et al.* 2010), el “Manual de malezas que crecen en Chile” (Matthei 1995), la “Flora de la Reserva Nacional Río Clarillo” (Teillier *et al.* 2005) y la “Flora Andina de Santiago” (Teillier *et al.* 2011), entre otros.
...
El trabajo de terreno del presente estudio se realizó en el AI determinada, y el trabajo fue hecho por un profesional biólogo especialista en botánica. La campaña, correspondiente a la estación de verano, fue realizada durante los días 22, 23 y 24 de abril de 2019.

Para el análisis de flora vascular y vegetación en el polígono del parque fotovoltaico se establecieron 8 transectos de muestreo (*Guía para la Descripción del Área de Influencia de los componentes suelo, flora y fauna de ecosistemas terrestres en el SEIA*, SEA 2015) de longitud variable, dependiendo de su ubicación. Estos transectos fueron distribuidos lo más uniforme posible, y de una forma que permitiera alcanzar una mayor variabilidad ambiental, dentro del AI. Cada transecto fue fotografiado y se recorrió toda su extensión, para poder observar las características generales de la vegetación y se reconocieron todas las especies vegetales presentes. Para el caso de la LMT, esta fue recorrida a lo largo de toda su extensión, y se utilizó la misma metodología mencionada para el parque fotovoltaico.
...
La ubicación de los vértices de los transectos de muestreo prospectados, en el polígono y la LMT, con sus coordenadas, se indican en la Figura N° 5 y Tabla N° 1.
...
| Transecto | Coordenadas (Datum: UTM WGS 84 Huso 18S) | Inicio Este (m) | Inicio Norte (m) | Término Este (m) | Término Norte (m) |
|-----------|--------------------------------------------|----------------|------------------|------------------|-------------------|
| T1        |                                            | 371,385        | 7,388,890        | 371,410          | 7,389,630         |
| T2        |                                            | 371,436        | 7,389,064        | 371,466          | 7,389,627         |
| T3        |                                            | 371,489        | 7,389,063        | 371,521          | 7,389,625         |
| T4        |                                            | 371,550        | 7,389,063        | 371,574          | 7,389,622         |
| T5        |                                            | 371,612        | 7,389,062        | 371,628          | 7,389,618         |
| T6        |                                            | 371,672        | 7,389,063        | 371,628          | 7,389,618         |
| T7        |                                            | 371,745        | 7,389,062        | 371,678          | 7,389,615         |
| T8        |                                            | 371,803        | 7,389,062        | 371,731          | 7,389,612         |
...
En la Fotografía N° 1 y Fotografía N° 2, se observa el aspecto general del área en estudio, donde se puede apreciar que es un terreno desprovisto completamente de vegetación.
...
La singularidad ambiental para la vegetación está determinada de acuerdo a los siguientes criterios:

1. **Presencia de formaciones vegetales únicas o de baja representatividad nacional.**
   - Considerando que en el AI no hay presencia de vegetación, se puede afirmar que tampoco existen formaciones vegetales únicas o de baja representatividad nacional.
2. **Presencia de formaciones vegetales relictuales.**
   - Considerando que en el AI no hay presencia de vegetación, se puede afirmar que tampoco existen formaciones vegetales relictuales.
3. **Presencia de formaciones vegetales remanentes.**
   - Considerando que en el AI no hay presencia de vegetación, se puede afirmar que tampoco existen formaciones vegetales remanentes.
4. **Presencia de formaciones vegetales frágiles.**
   - Considerando que en el AI no hay presencia de vegetación, se puede afirmar que tampoco existen formaciones vegetales frágiles.
...
6. **Actividad en o colindante con sitios prioritarios para la conservación de la diversidad definidos en las estrategias regionales.**
   - El Proyecto no se encuentra en o colindante con sitios prioritarios para la conservación de la biodiversidad definidos en las estrategias regionales.
7. **Actividad en o colindante con áreas bajo protección oficial.**
   - En base a la información recopilada del Registro Nacional de Áreas Protegidas, el Proyecto no se encuentra dentro de áreas bajo protección oficial. El área más cercana es la Reserva Nacional La Chimba, a 7.5 kilómetros de distancia, aproximadamente.
8. **Actividad en o colindante con áreas protegidas privadas.**
   - En base a la información recopilada de bibliografía, el Proyecto no se localiza en o colindante con áreas protegidas privadas.
9. **Actividad en o colindante con áreas de protección (Ley N° 18.378).**
   - El área del Proyecto no se encuentra dentro o colindante con áreas de protección según Ley 18.378.
10. **Actividad en o colindante con o aguas arriba de humedales**
    - Según lo observado en terreno, y en base a literatura, el Proyecto no se encuentra colindante con o aguas arriba de humedales.

---

### FLORA

Durante la prospección en terreno, y al igual como se menciona en el estudio de vegetación, no se halló individuos de ninguna especie vegetal dentro del AI.
...
Considerando que dentro del AI no fue hallada ninguna especie vegetal, no se satisface ninguno de los criterios del análisis. Por lo tanto, el AI no posee singularidades florísticas.

---

## 5. CONCLUSIONES

Luego de realizar los recorridos a través del polígono, el camino y la LTE, no se encontró ningún tipo de vegetación ni de especies de flora en el área de influencia. Las condiciones ambientales de extrema aridez explicarían la ausencia de plantas vasculares en la zona.

Por lo tanto se puede concluir que, según lo que se puede observar a simple vista, como el Área de Influencia del Proyecto no posee vegetación alguna, no hay presencia de ninguna formación vegetacional con características particulares o que amerite su protección y, del mismo modo, tampoco se encuentran especies de flora vascular protegidas o reguladas por la legislación ambiental vigente.
...
- Zuloaga FO, Morrone O & Belgrano MJ (eds.). 2008. Catálogo de las Plantas Vasculares del Cono Sur (Argentina, Sur de Brasil, Chile, Paraguay y Uruguay). Monographs of the Missouri Botanical Garden 107. Disponible en http://www2.darwin.edu.ar/Proyectos/FloraArgentina/fa.htm (consultada en mayo de 2019).
