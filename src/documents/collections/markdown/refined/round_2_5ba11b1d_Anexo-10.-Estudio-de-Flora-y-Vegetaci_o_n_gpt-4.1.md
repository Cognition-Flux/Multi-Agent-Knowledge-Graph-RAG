...
## “PROYECTO INMOBILIARIO BICENTENARIO NORORIENTE”

### ANEXO 10: ESTUDIO DE FLORA Y VEGETACIÓN

**Elaborado para:** NOVIEMBRE 2018
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Bicentenario Nororiente”, en la comuna de Talca, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Bicentenario Nororiente”.
...
El proyecto “Bicentenario Nororiente” se emplaza en la región del Maule en la ciudad de Talca orientación Noreste (Figura 1). El área de estudio se encuentra en una zona urbana que se conecta en 500 metros a la ruta K-511.

**Figura 1. Ubicación geográfica del área de estudio.**

- Consultor: Bicentenario Nororiente
- Carta: División Político Administrativa
- Escala: 1:100.000
- Simbología: Ubicación georreferenciada del proyecto
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia.*

Se define un polígono de 17 vértices para delimitar el área del proyecto, en una superficie aproximada de 14,2 ha (Figura 2).
...
Las actividades en terreno se ejecutaron durante el día 8 de Marzo de 2018, donde se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
Para la componente Flora y Vegetación el Área de influencia de este proyecto está definida como la superficie que coincide con la totalidad del terreno a utilizar para la construcción y operación del proyecto junto a una proyección de 100 metros, como se muestra en la siguiente figura.

**Figura 3. Área de Influencia del proyecto (AI).**

- Consultor: Bicentenario Nororiente
- Carta: Área de Influencia
- Escala: 1:10.000
- Proyección: WGS 84 UTM H19S
...
- Consultor: Bicentenario Nororiente
- Carta: Catastro Vegetacional (SIT)
- Escala: 1:8.000
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia.*
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT), se obtuvieron tres unidades ambientales destacándose la pradera agrícola en desuso, ya que abarca la mayor parte del predio, en donde predominan especies herbáceas como *Hypochaeris radicata* (Hierba del chancho), *Trifolium repens* (Trébol blanco) y *Verónica pérsica* (Pocilla pérsica), la segunda unidad ambiental con la especie arbustiva *Rubus ulmifolius* (Zarzamora) además de presencia arbórea ubicada en los deslindes del predio, y la tercera unidad ambiental de infraestructura que se compone de instalación de faenas y además de viviendas que corresponden a una de las fases constructivas del proyecto (Figura 5).
...
|---------------------------|-------------------|---------------------|---------------------------|-------------------|
| Pradera agrícola en desuso| H                 | hr; tr; vp Ru, rr   | Pradera natural degradada compuesta principalmente por especies herbáceas como *Hypochaeris radicata*, *Trifolium repens* y *Verónica pérsica* y la especie arbustiva *Rubus ulmifolius*, además presencia de especies arbóreas que se encuentran ubicadas en los deslindes del predio | Herbáceo, clara Leñoso bajo, muy clara |
| Cordón boscoso            | LA                | SH; PA Ru           | Franja boscosa que se restringe al borde el predio predominando especies arbóreas como *Salix humboldtiana* y *Populus alba* y la especie arbustiva *Rubus ulmifolius*. | Leñoso alto, clara Leñoso bajo muy clara |
| Infraestructura            | -                 | -                   | Se compone de instalación de faenas, y de viviendas que corresponden a una de las fases constructivas del proyecto | - |
...
|---------------|--------------------------|-------|
| Herbáceo      | *Trifolium repens*       | tr    |
| Herbáceo      | *Hypochaeris radicata*   | hr    |
| Herbáceo      | *Hypochaeris radicata*   | hr    |
| Herbáceo      | *Verónica pérsica*       | vp    |
...
- Consultor: Bicentenario Nororiente
- Carta: Carta de Ocupación de Tierras (COT)
- Escala: 1:10.000
- Proyección: WGS 84 UTM H19S
- *Fuente: Elaboración propia.*
...
La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 16 especies de plantas pertenecientes a 9 familias (Tabla 9). Del total de las especies registradas 2 corresponden nativas, siendo las restantes especies introducidas principalmente invasoras y ornamentales.
...
| Salicaceae    | *Populus alba*          | Álamo blanco      |           |            |
...
| Loranthaceae  | *Tristerix corymbosus*  | Quintral          | Arbustivo | Nativo     |
...
| Asteraceae    | *Senecio vulgaris*      | Yerba cana        |           |            |
| Plantaginaceae| *Veronica persica*      | Pocilla persica   |           |            |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Bicentenario Nororiente”, en términos de diversidad y la presencia de especies de interés.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), se obtuvieron tres unidades ambientales destacándose la pradera agrícola en desuso, ya que abarca la mayor parte del predio, en donde predominan especies herbáceas como *Hypochaeris radicata* (Hierba del chancho), *Trifolium repens* (Trébol blanco) y *Verónica pérsica* (Pocilla pérsica) y la especie arbustiva *Rubus ulmifolius* (Zarzamora), como segunda unidad ambiental con la presencia arbórea ubicada en los deslindes del predio, y la tercera unidad ambiental de infraestructura que se compone de instalación de faenas y además de viviendas que corresponden a una de las fases constructivas del proyecto.
