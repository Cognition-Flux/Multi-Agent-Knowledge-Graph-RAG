...
## PROYECTO INMOBILIARIO “JARDIN FLORESTA IV Y V”
...
| Tabla | Descripción |
|-------|-------------|
| 1 | Ubicación Georreferenciada del proyecto |
| 2 | Claves de codificación según el espectro biológico de las especies |
| 3 | Categorías de recubrimiento y codificación |
| 4 | Codificación de las especies dominante |
| 5 | Grado de artificialización |
| 6 | Regiones Vegetacionales en Chile |
| 7 | Resultados Carta de Ocupación de Tierras |
| 8 | Especies dominantes descritas en la COT |
| 9 | Listado de especies vegetales registradas en el área de estudio |
| 10 | Ficha *Blechnum hastatum* |
| 11 | Ficha *Drimys winteri* |
...
- Figura 6-9. Características del área de estudio
...
- Figura 12. Registro de *Rhaphithamnus spinosus* (Espino blanco) y *Blechnum hastatum* (Palmilla)
...
El presente documento contiene los resultados obtenidos de la caracterización de la flora y vegetación del área de influencia del proyecto “Jardín Floresta IV y V”, ubicado al suroeste de la comuna de Villarrica, Región de la Araucanía.
...
Dado lo anterior, es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Jardín Floresta IV y V”, en la comuna de Villarrica, región de La Araucanía.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Jardín Floresta IV y V”.
...
El proyecto “Jardín Floresta IV y V” se emplaza al suroeste de la comuna de Villarrica, Región de la Araucanía (Figura 1).

**Figura 1. Ubicación geográfica del área de estudio, Región de la Araucanía**

- Consultor: [Datos del consultor]
- Carta: [Datos de carta]
- Escala: 1:8.000
...
Las actividades en terreno se ejecutaron durante el mes de junio de 2019, donde se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales. Posteriormente, en noviembre de 2019 se realizó otra campaña de muestreo para identificar cambios en los patrones de vegetación debido a la fenología de las especies.
...
|-----------|--------------|
| 1. Vegetación clímax | |
| 2. Vegetación peneclímax | 2.1 Bosque virgen coetáneo o multietáneo, 2.2 Exclusiones |
...
Finalmente, en base al registro del Sistema Nacional de Información Ambiental (SINIA) del Ministerio de Medio Ambiente, el área de emplazamiento del proyecto se ubica en una zona donde el uso actual de suelo corresponde a Praderas Matorrales.

De esta forma y de acuerdo los antecedentes mencionados, en la actualidad el área de estudio presenta principalmente áreas urbanizadas y praderas naturales, siendo un lugar altamente intervenido por actividad humana.

### 6.3. Levantamiento de información en terreno

#### 6.3.1. Caracterización general del terreno

Según el Sistema Informativo territorial, las superficies por uso dentro de la comuna de Villarrica corresponden en total a 129.871 ha, de las cuales 3.402,8 ha son ocupadas como Terrenos agrícolas, 55.205,7 ha corresponde a Bosques, 1.767,4 ha son utilizadas como Áreas Urbanas Industriales, 52.512,6 ha a Praderas y Matorrales, 15.634,6 ha corresponden a Cuerpos de agua, mientras que 985 ha corresponden a Áreas sin vegetación, 62,1 ha pertenecen a Humedales; finalmente 300,8 ha corresponden a Nieves y Glaciares.

Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo correspondiente a Praderas y Matorrales; no obstante, al momento de la visita se observó principalmente una pradera en desuso, con presencia de malezas de tipo herbáceas especies exóticas y una zona arbórea que rodea el deslinde norte del predio. Cabe en dicha zona arbórea se observó la presencia de regeneración de especies nativas, la cual se encuentra en los sectores de menor accesibilidad.

#### 6.3.2. Vegetación

Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron 2 unidades ambientales (Figura 5), la primera unidad identificada corresponde a una Pradera, unidad que domina el área estableciéndose como una matriz donde predominan especies como *Cynodon dactylon* y *Oxalis sp.* La segunda unidad ambiental corresponde a Arbóreo, la cual corresponde a un cordón arbóreo compuesto de especies de origen introducido como *Pinus radiata*, la cual ocupa la mayor cobertura. Destaca además la presencia de especies nativas en regeneración bajo el dosel, como *Rhaphithamnus spinosus* y *Berberis darwinii*.
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| Pradera | H | cd, os | 3.1. Pradera natural degradada o matorral abierto con pasto degradado y arbustos no ramoneados. | d, pd |
| Arbóreo |   | PR, Rs, Bd | 4.2. Bosque artificial abandonado | pd, c, mc |
...
|  | *Crepis capillaris* | Falsa achicoria |   |   |
...
| Verbenaceae | *Rhaphithamnus spinosus* | Espino blanco |   |   |
| Winteraceae | *Drimys winteri* | Canelo |   |   |
| Berberidaceae | *Berberis darwinii* | Calafate | Arbustivo |   |
| Flacourtiaceae | *Azara microphylla* | Roblecillo | Arbustivo |   |
| Elaeocarpaceae | *Aristotelia chilensis* | Maqui |   |   |

##### 6.3.3.2. Estado de conservación

De acuerdo a la revisión de antecedentes y la normativa vigente, existen dos especies en el área del proyecto que se encuentran clasificadas en categoría de conservación, las que corresponden a *Blechnum hastatum* (D.S. N°19/2012 del MMA) y *Drimys winteri* (D.S. N°6/2017 del MMA), las cuales se encuentran en categoría de Preocupación Menor (LC).
...
| Amenazas | Amenazada por pérdida y degradación de hábitat por causas antrópicas; cosecha y especies exóticas invasoras (impactando directamente la especie). |
...
|--------------------------|--|
| Categoría de conservación | Preocupación Menor (LC) |
| Fuente de Categoría | D.S. N°6/17 MMA |
| Justificación de la conservación | La especie NO cumple con los umbrales de ninguno de los criterios para ser clasificada en alguna de las categorías de amenaza de UICN 3.1 (Extinta, Extinta en la Naturaleza, En Peligro Crítico, En Peligro o Vulnerable) y su amplia distribución indica que no está próxima a satisfacer los criterios. |
| Distribución | Nativo de Chile y Argentina. En Chile crece desde la provincia de Limarí (quebrada Camarones 30º20’S; 71º26’O) hasta la provincia de Aysén (Río Exploradores 46º25’S; 73º20’O, Región de Aysén). |
| Amenazas | Amenaza por destrucción de poblaciones en cauces permanentes de las regiones IV, V y RM, por construcción de tranques y relaves. |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto “Jardín Floresta IV y V”, en términos de diversidad y la presencia de especies de interés.
