...
**III. Visita a terreno:** Una vez completados los puntos anteriores, se realizó una visita a terreno el día 3 de agosto de 2021, cuyo fin fue realizar un reconocimiento de especies, su diversidad y abundancia.
...
El área del Proyecto se encuentra inmerso en la región y sub-región del mismo nombre, del Matorral y el bosque esclerófilo, específicamente en la formación Matorral espinoso de las serranías.
...
Con fecha 3 de agosto de 2021, se realizó una visita a terreno con el objetivo de identificar tanto las formaciones vegetacionales como los individuos de flora al interior del área de estudio. Las transectas utilizadas para dicho trabajo se presentan en la Ilustración 5: Transectas en área de estudio.
...
|-----------------------|--------------|-------------------|------------|--------------------------|---------------------|
| Eucalyptus globulus   | Eucalipto    | Arbórea           | Introducida| --                       | No                  |
| Persea americana     | Paltos       | Arbórea           | Introducida| --                       | No                  |
| Maytenus boaria      | Maitén       | Arbórea           | Nativa     | --                       | Sí                  |
| Citrus limon         | Limón        | Arbórea           | Introducida| --                       | No                  |
| Acacia caven         | Espino       | Arbórea           | Nativa     | --                       | Sí                  |
| Zarzamora            | Arbustiva    | Nativa            |            |                          | No                  |
...
Unidad de vegetación que se encuentra formada en su totalidad por especies arbóreas con dominancia de *Eucalyptus globulus* y con presencia de forma irregular de Zarzamora, las que en el terreno se encuentran utilizadas como cortina o cerco perimetral del predio.

*Ilustración 6: Formación arbórea de Eucalyptus Globulus*

#### Cultivos agrícolas

Unidad vegetacional marcada por la actividad agrícola, se encuentra conformada por cultivos de *Persea americana* (paltas), *Citrus limón* (limón) y hortalizas.
...
Sector con presencia de la especie *Acacia caven* y *Maytenus boaria* cuya cobertura determinada mediante parcelas es inferior al 10%, además de no contar con la superficie y ancho requerido, por lo que **no** es posible clasificarlo como bosque nativo en base a lo establecido en la Ley N° 20.283, tal como se indica en el ítem correspondiente.

La Ley 20.283 de Bosque Nativo y Fomento Forestal, para determinar si califica como Bosque Nativo, establece que una formación califica como Bosque cuando se cumplen simultáneamente los siguientes requisitos:
...
La unidad vegetacional descrita fue descartada como bosque nativo ya que no cumple la cobertura (10%), la superficie (5,000 m²) ni el ancho requerido (40 metros).

La ubicación de las UVH descritas anteriormente se encuentra en la Ilustración 10: Unidades vegetacionales homogéneas.
...
| Formación                                 | Superficie (m²) |
|-------------------------------------------|-----------------|
| Formación arbórea de Eucalyptus globulus  | 3,072           |
| Cultivo agrícola                          | 11,775          |
| Pradera                                   | 3,798           |
| Individuos nativos aislados               | 8,908           |
...
Al definir el contexto biogeográfico se determinó que el área de influencia del proyecto se encuentra inmerso en la región y sub-región del mismo nombre del Matorral espinoso de las serranías, específicamente en la formación Bosque esclerófilo andino (Gajardo, 1994) y del Piso Vegetacional Bosque espinoso mediterráneo interior de *Acacia caven* y *Prosopis chilensis* (Federico Luebert, 2017).
...
Fue posible delimitar 4 unidades de formación vegetacional homogéneas, tales como la formación arbórea de *Eucalyptus globulus* con 0.3 hectáreas, cultivo agrícola con 1.1 hectáreas, pradera con 0.37 hectáreas y formación nativa con individuos aislados con 0.89 hectáreas.
