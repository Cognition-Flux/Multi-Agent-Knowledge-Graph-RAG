...
| OBJETIVOS | 3 |
| ANTECEDENTES | 4 |
| LUGAR DE APLICACIÓN | 9 |
| DISEÑO DE EJECUCIÓN DEL PLAN | 10 |
| Desmantelamiento de obras | 11 |
| Caracterización del área a revegetar | 12 |
| Selección de especies | 12 |
| Densidad de plantación | 13 |
| Preparación de las áreas a revegetar | 13 |
| Limpieza del sitio | 13 |
| Aplicación de fertilizantes | 14 |
| Preparación del suelo | 14 |
| Cercado | 15 |
| Cortafuego | 15 |
| Acciones de revegetación | 15 |
| Transporte de plantas | 16 |
| Labores de Plantación | 17 |
| Intervenciones post plantación | 18 |
...
Las obras que se realizarán en el área del parque fotovoltaico (PFV) incluyen los paneles fotovoltaicos (PF), la sala de comunicaciones (SC), las subestaciones transformadoras (ST), el camino interno (CI) y la instalación de faenas (IF). En el Cuadro 1 se entrega el detalle de la superficie de cada una de estas obras.
...
La Línea de base del componente suelo (estudio agrológico) presentado en la DIA documenta las siguientes características del suelo presente en el área de obras, correspondiendo a la serie Tabolango (CIREN, 2009):
...
El análisis de los potenciales impactos sobre el suelo del proyecto de PFV indica que en lo relativo a perdida de suelos:
...
- Al tratarse de un proyecto fotovoltaico, no se realizará una eliminación del estrato superior por nivelación o por labores de compactación, tampoco se realizará escarpe de suelo. Los paneles fotovoltaicos se sujetan sobre estructuras de soporte que van hincados o clavados en la superficie del terreno. La excepción es la habilitación de un camino interno (CI), la sala de comunicaciones (SC), las subestaciones transformadoras (ST) y la instalación de faenas (IF). Donde sí se realizará compactación de suelos. La superficie de estas obras es poco significativa en comparación con la superficie del Parque Solar.
...
- Para el funcionamiento del Proyecto se requiere realizar compactación de suelos en CI, SC, ST y en algunas zonas de la IF. Dicha superficie es mínima respecto a la superficie del Parque Solar. Si bien se realizará efectivamente compactación de suelos, estas serán delimitadas en sectores reducidos.
- De acuerdo con Claviere et al. (2000) la compactación por el tránsito de maquinaria pesada genera un resistencia a la penetración significativamente mayor en los primeros 15 cm del suelo y es detectable hasta los 38 cm.

Deterioro de las propiedades físicas, químicas o biológicas del suelo:

- Las propiedades físicas del suelo no se verán afectadas por el proyecto. Respecto a las propiedades químicas, el proyecto no contempla realizar ningún tipo de cambio al suelo. Las propiedades biológicas del suelo no se verán afectadas, dado que los paneles permitirán que tanto luz difusa como directa llegue a la superficie del suelo, permitiendo el desarrollo de especies presumiblemente del tipo herbácea; a excepción de CI, SC, ST y algunas zonas de la IF, en donde la compactación va a afectar las propiedades biológicas, pero que pueden ser restauradas en la fase de cierre del Proyecto.
...
La línea de base del componente flora y vegetación, presentada en la DIA, documenta las formaciones vegetacionales identificadas a partir de la COT para el área de estudio, en el área de influencia con alteración de la vegetación de la PFV:
...
## Herbácea clara de Avena barbata (12,21 ha)
...
Estas suman una superficie de aproximadamente 12,67 ha en el área de desarrollo de obras de la PFV.
...
Correspondiendo a las características principales del piso vegetacional, las condiciones de imagen para el plan de restauración y revegetación.
...
El plan de restauración y revegetación se ejecutará en las áreas de obras permanentes y transitorias (área de influencia) del PFV Los Maquis Solar, con posterioridad al cierre del proyecto.
...
- Recuperar las características micro topográficas de la superficie del sitio, para reestablecer las condiciones morfológicas iniciales. Los vacíos creados por el retiro de los materiales demolidos deberán ser sustituidos por suelo apto para actividades forestales.
- Someter al suelo a labores de descompactación, esto aplicado a las áreas de sala de comunicaciones (SC), las subestaciones transformadoras (ST), el camino interno (CI) y la instalación de faenas (IF), mediante:
  - Subsolado (arado subsolador) a 1 m de profundidad a distancias de 1 m, en las áreas de mayor compactación y compactación profunda y labor posterior con arado de cincel.
...
Descripción del área a revegetar en términos de las características climáticas, de suelos disturbados y de vegetación remanente e invasiva, en los aspectos de interés para la revegetación, incluyendo su sectorización cuando corresponda. Esto debe realizarse por un especialista, a posterioridad al retiro de obras, para evaluar también la presencia de especies invasivas o facilitadas por la presencia de los paneles fotovoltaicos.
...
Seleccionándose a las especies arbóreas: **Acacia caven** (espino), **Lithrea caustica** (litre) y **Quillaja saponaria** (quillay).

# Densidad de plantación

La densidad de la cobertura arbórea actual es cercana al 10% para la mayor parte del área proyectada con obras de la PFV y cercana al 50% en el borde oeste del área de obras. Para efectuar la plantación con fines de restauración, se considerará una cobertura objetivo cercana al 50%, número entre 400 y 700 plantas por hectárea, intercalando espino, litre y quillay, en una proporción de 3:1:1. Esta densidad de árboles es mayor que la observada en las formaciones vegetacionales presentes, y permitirá, en un estado avanzado de la revegetación, considerar coberturas de hasta el 75%, dada la creación de condiciones también adecuadas para la regeneración natural.
...
Dada la pequeña superficie de revegetación, se considera un cortafuego perimetral, donde se despejará de vegetación hasta el acceso al suelo mineral, en un ancho aproximado de 2 veces la altura máxima potencial a alcanzar por la plantación (y la vegetación circundante), esto es 16 m. Considerándose su inspección anual.
...
Si las plantas son compradas, el revegetador deberá acudir a viveros inscritos en el SAG. De gran ayuda puede ser la consulta al directorio de viveros forestales que administra y publica la Corporación Nacional Forestal o en su página web, www.conaf.cl

O bajo las condiciones que la legislación y normativa establezcan en el momento de realizar las acciones de restauración.

# Labores de Plantación

Para efectuar la plantación con fines de restauración, se considerará un número entre 600 y 900 plantas por hectárea, intercalando espino, litre y quillay, en una proporción de 3:1:1. En espaciamiento de 4x3 m. La densidad y espaciamiento permitirá la recolonización del área a partir de semillas de los árboles plantados, y por transporte de semillas de especies arbustivas y herbáceas (sea por viento o animales), permitiendo acercarse a las condiciones del ecosistema imagen.

Además, el crecimiento arbóreo genera las condiciones microclimáticas que pueden ser beneficiosos para el crecimiento del estrato herbáceo bajo el dosel (Del Pozo et al., 1989; Ovalle et al., 1990 y 1996), y la colonización de mayor diversidad de especies (geófitos por ejemplo).
