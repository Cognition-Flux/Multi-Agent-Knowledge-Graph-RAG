...
## Caracterización de Flora Proyecto “Parque Solar La Peña”
...
3. Área de influencia y estudio .................................................................................. 5  
4. Metodología ........................................................................................................... 6  
5. Resultados ............................................................................................................. 7  
5.1. Características generales del piso vegetacional en la zona de estudio .......... 7  
5.2. Formaciones vegetacionales .......................................................................... 8  
5.3. Categoría de Conservación ............................................................................ 9  
5.4. Legislación aplicable ...................................................................................... 9  
5.4.1. Formación de bosque ............................................................................. 9  
5.4.2. Formación xerofítica .............................................................................. 10  
5.4.3. Bosque Nativo de Preservación ........................................................... 11  
5.5. Trabajo en terreno ......................................................................................... 12  
5.5.1. Metodología aplicada ............................................................................ 12  
5.5.2. Especies identificadas ........................................................................... 13  
5.5.3. Formaciones vegetacionales ................................................................. 14  
5.6. Resultados en terreno .................................................................................. 20  
5.6.1. Especies en categoría de conservación ............................................... 20  
5.6.2. Formación vegetacional aplicable a la ley ........................................... 20  
5.6.3. Hongos y Líquenes ............................................................................... 20  
6. Conclusión ........................................................................................................... 21  
7. Bibliografía ........................................................................................................... 22

### Índice de ilustraciones

- Ilustración 1 Área de influencia del Proyecto ............................................................. 5
- Ilustración 2 Piso vegetacional .................................................................................. 7
- Ilustración 3 Formaciones vegetacionales ................................................................. 8
- Ilustración 4 Recorrido y parcelas realizadas en terreno ......................................... 12
- Ilustración 5 Formaciones vegetacionales ............................................................... 14
- Ilustración 6 Bosque Nativo de Preservación .......................................................... 16
- Ilustración 7 Bosque nativo de Acacia caven .......................................................... 17
- Ilustración 8 Bosque de pino ................................................................................... 19

### Índice de tablas

- Tabla 1 Formaciones xerofíticas ............................................................................... 11
- Tabla 2 Especies identificadas al interior del Proyecto ............................................ 13
- Tabla 3 BNP ............................................................................................................. 14
- Tabla 4 Imágenes del sector .................................................................................... 15
- Tabla 5 Bosque Nativo ............................................................................................. 16
- Tabla 6 Imágenes de la formación ........................................................................... 17
- Tabla 7 Formación de bosque introducido ............................................................... 18
- Tabla 8 Imágenes del sector .................................................................................... 18

---

## 1. Introducción

El Proyecto Parque Solar La Peña corresponde a un proyecto del tipo PMGD de Energía Renovable No Convencional de 8 MW nominal que inyectará su energía por medio de una línea de media tensión al Sistema Eléctrico Nacional (SEN), aportando energía limpia a la matriz energética nacional. Este Proyecto se ubica en la comuna de Nogales, perteneciente a la provincia de Quillota, región de Valparaíso.
...
## 3. Área de influencia y estudio
...
**II. Evaluación de la zona mediante sistemas GIS e información satelital:** Previo al trabajo en terreno se realiza una revisión mediante información satelital, con el fin de poder determinar el esfuerzo de muestreo que se considera para el terreno. En el caso de que se divise una alta presencia arbórea se procederá a realizar el método de parcelas con el fin de determinar si corresponde a una formación de bosque (según los términos de la ley y el reglamento, que se indican en el punto 5.4.1), caso contrario, se realizará el método de transectas con el objetivo de poder divisar los individuos aislados y determinar el tipo de formación existente.

**III. Visita a terreno:** Una vez completado los puntos anteriores, se realizó una visita a terreno el día 23 y 24 de noviembre (primavera), cuyo fin fue realizar un reconocimiento de especies, diversidad y abundancia. Cabe indicar que la fecha en que se realizó corresponde a la época con mayor abundancia de especies.
...
El área de estudio para la presente caracterización es el área correspondiente al sitio donde se instalará el Proyecto. Respecto al piso vegetacional de la zona, según Luebert y Pliscoff corresponden a Bosque esclerófilo mediterráneo costero de *Lithrea caustica* y *Cryptocarya alba*.
...
El área del Proyecto se encuentra mayormente en la formación “Bosque esclerófilo” inserto en el piso vegetacional Bosque esclerófilo mediterráneo costero de *Lithrea caustica* y *Cryptocarya alba*, este piso se encuentra dominado por *Lithrea caustica*, a la que generalmente se asocia *Cryptocaria alba*, *Peumus boldus* y *Schinus latifolius*. Presenta un importante contingente de arbustos esclerófilos y espinosos como *Colliguaja odorífera*, *Escallonia pulverulenta*, *Eupatorium glechonophyllum*, *Lobelia excelsa*, *Retanilla trinervia* y otros. La presencia de herbáceas es más bien escasa, principalmente *Solenomelus pedunculatus* y *Vulpia myuros*, mientras que las epífitas están prácticamente ausentes. En las laderas más secas es frecuente la presencia de matorrales dominados por *Retanilla trinervia* y *Colliguaja odorifera*. En algunos sectores se asocia con *Jubaea chilensis*. En algunas quebradas se observan bosques de *Aextoxicon punctatum*. La degradación antrópica ha producido una transformación estructural del bosque, pérdida de cobertura y favorece la inmigración de especies arbustivas y herbáceas más xerofíticas; una recuperación de la vegetación original sería posible en ausencia de perturbaciones.

### 5.2. Formaciones vegetacionales

La formación vegetacional definida por Gajardo y que se encuentra inmersa en el área de estudio corresponde a “Matorral Estepario Costero del Desierto del Pacífico” común de la zona costera de Coquimbo y La Serena, donde se encuentran especies en categoría de conservación tales como *Porlieria chilensis* y especies de cactáceas y suculentas.
...
### 5.5.1. Metodología aplicada

Con fecha 23 y 24 de noviembre, se realizó una visita a terreno con el objetivo de identificar tanto las formaciones vegetacionales como los individuos de flora al interior del área de estudio. Para dicha visita se utilizó el método de transectas para el área del Proyecto y el método de parcelas para el sector colindante.

*Ilustración 4 Recorrido y parcelas realizadas en terreno*

### 5.5.2. Especies identificadas

El trabajo fue realizado por dos especialistas por medio del método de transectas y de parcelas, al respecto, se identificaron las siguientes especies:
...
| Solanum yuberosum      | Papa              |                   |        |                          |
| Raphanus satibus       | Rábano silvestre  |                   |        |                          |
| Foeniculum vulgare     | Hinojo            |                   |        |                          |
| Polygonum persicaria   | Duraznillo        |                   |        |                          |
| Datura stramonium      | Chamico           |                   |        |                          |
| Convolvulus arvensis   | Correhuela        |                   |        |                          |
| Anthriscus caucalis    | Cicuta            |                   |        |                          |
| Eschscholzia califórnica| Dedal de oro     |                   |        |                          |
| Acacia caven           | Espino            | Nativo            |        |                          |
| Junglans regia         | Nogales           |                   |        |                          |
| Robinia pseudoacacia   | Robinias          |                   |        |                          |
| Pinu strobus           | Pino              |                   |        |                          |
| Porlieria chilensis*   | Guayacán          | Nativo            | Vulnerable |
| Baccharis linearis*    | Romerillo         | Matorral          | Endémico |                          |

*Especie presente fuera del área del Proyecto

### 5.5.3. Formaciones vegetacionales

Respecto a las unidades vegetacionales homogéneas (UHV), se presenta en la siguiente imagen las formaciones presentes en el área de estudio.

*Ilustración 5 Formaciones vegetacionales*

A continuación se presenta una caracterización de las formaciones vegetacionales colindantes al Proyecto y reguladas por la normativa vigente:

#### I) Bosque Nativo de preservación de Acacia caven y Porlieria chilensis

Bosque nativo con especies en categoría de conservación, específicamente Porlieria chilensis, sus características se presentan en la siguiente tabla:

**Tabla 3. BNP**

| Tipo de bosque | Composición | Superficie | Listado florístico | Categorías de conservación | Estado del sector |
|---------------|-------------|------------|--------------------|----------------------------|-------------------|
| Renoval       | Bosque nativo de Acacia caven y Porlieria chilensis, con una leve presencia de especies introducidas | 5,39 hectáreas dividido en dos sectores | Acacia caven, Porlieria chilensis, Eucalyptus sp y Opuntia ficus-indica | Porlieria chilensis en estado vulnerable | Corresponde a un botadero de residuos ilegal |

Cabe indicar que complementariamente se realizó un censo de especies vulnerables en un área de 100 metros desde el Proyecto, constatando que el individuo más cercano se encuentra a 55 metros del límite norte.

**Tabla 4. Imágenes del sector**

*Ilustración 6 Bosque Nativo de Preservación*

#### II) Bosque Nativo de Acacia caven

Formación presente en el sector nororiente del Proyecto, el cual actualmente se encuentra en un proceso de reforestación:

**Tabla 5. Bosque Nativo**

| Tipo de bosque | Composición | Superficie | Listado florístico | Categorías de conservación | Estado del sector |
|---------------|-------------|------------|--------------------|----------------------------|-------------------|
| Renoval       | Bosque nativo de Acacia caven | 3,1 hectáreas | Acacia caven | Sin especies en estado vulnerable | En buen estado, sector cercado y en proceso de reforestación |

**Tabla 6. Imágenes de la formación**

*Ilustración 7 Bosque nativo de Acacia caven*

#### III) Bosque de Eucalyptus Sp y Acacia melanoxylon

Formación de especies introducidas con una baja presencia de especies de acacia caven (menos de 4 individuos).

**Tabla 7. Formación de bosque introducido**

| Tipo de bosque | Composición | Superficie | Listado florístico | Categorías de conservación | Estado del sector |
|---------------|-------------|------------|--------------------|----------------------------|-------------------|
| -             | Bosque de Eucalyptus Sp. y Acacia melanoxylon | 0,8 hectáreas | Eucalyptus Sp. y Acacia melanoxylon | Sin especies en estado vulnerable | Vertedero ilegal |

**Tabla 8. Imágenes del sector**

*Ilustración 8 Bosque de pino*
...
En relación con lo visto en terreno, no se constató la presencia de especies en categoría de conservación al interior del predio, dada la intervención producto de la actividad agrícola. Sin embargo, en el área colindante a este, se constató la presencia de un bosque nativo de preservación de *Porlieria chilensis*.
...
En relación a la visita en terreno, no se constató la presencia de Hongos y Líquenes, esto debido a la baja presencia de especies arbóreas (sitios donde suelen habitar los líquenes) y el uso de elementos químicos para evitar externalidades en los cultivos (uso de fungicidas).

---

## 6. Conclusión

El proyecto “Parque Solar La Peña” corresponde a un proyecto PMGD del tipo ERNC de 8 MW, que se ubicará en la comuna de Nogales, región de Valparaíso. La zona cuenta con una alta actividad agrícola y ganadera que genera una alta intervención a flora nativa y endémica de la zona, dado que se requieren grandes extensiones de terreno para realizar monocultivos destinados a la producción antes indicada.

Por ende y dado que la zona en donde se instalará el Proyecto es una zona altamente intervenida por actividad agrícola, la afectación del Proyecto a la flora nativa y endémica de la zona y del país es nula.

Por otro lado, la identificación de flora realizada en terreno los días 23 y 24 de noviembre confirmó la ausencia de especies en categoría de conservación y formaciones vegetacionales reguladas por la normativa forestal vigente.

Por último, es importante destacar que el proyecto considerando el área de intervención y de influencia, no afectará a la flora nativa ni a formaciones vegetacionales en categoría de conservación, dado que en la zona solo existen monocultivos o plantaciones con fines agrícolas. Referente a la afectación por incendios u otra emergencia, se tiene considerado un plan de contingencias para prevenir cualquier evento y uno de emergencia para poder actuar oportunamente y evitar cualquier impacto al medio ambiente.

En relación a la afectación producto del levantamiento de emisiones, se puede determinar que el Proyecto aportará menos de un 4% de lo que indica la normativa de calidad de aire (según los datos de la modelación de emisiones) en MPS (PM 10 y 2.5). Es importante indicar que la modelación de emisiones no considera las barreras naturales generadas por las cortinas de especies que se encuentran entre el Proyecto y el bosque nativo de preservación, por lo que el porcentaje del 4% es un valor conservador frente a la realidad.
