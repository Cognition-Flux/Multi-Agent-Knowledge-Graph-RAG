...
## PROYECTO INMOBILIARIO “BRISAS DE PENCAHUE”
...
| Tabla | Descripción |
|-------|-------------|
| 1 | Ubicación georreferenciada del área del proyecto (polígono 1). |
...
| Figura | Descripción |
|--------|-------------|
| 1 | Ubicación geográfica del área de estudio Región del Maule. |
| 2 | Área del proyecto (Polígono Total) |
| 3 | Área de influencia del proyecto. |
| 4 | Catastro Vegetacional SIT CONAF 2016. |
| 5 | Resultados COT. |
| 6 | Características generales del área de estudio |
| 7 | Características generales del área de estudio |
| 8 | Origen de especies vegetales registradas en el área de estudio. |
| 9 | Hábito de especies vegetales registradas en el área de estudio |
| 10 | Ejemplar de *Chrysanthemum coronarium* (manzanillón) |

---

## 1. INTRODUCCIÓN

El presente documento contiene los resultados obtenidos de la caracterización de la flora y vegetación del área de influencia del proyecto “Brisas de Pencahue”, ubicado al noroeste de la comuna de Pencahue, Región del Maule.
...
Dado lo anterior, es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Brisas de Pencahue”, en la comuna de Pencahue, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Brisas de Pencahue”.
...
El proyecto “Brisas de Pencahue” se emplaza en la comuna de Pencahue, región del Maule (Figura 1).
...
Las actividades en terreno se ejecutaron durante el mes de Julio de 2018, se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
El Proyecto se desarrollará en una superficie de 7,77 ha aproximadamente, la cual será intervenida de manera directa por la construcción y operación del Proyecto. De esta manera, para el componente fauna el AI está definida como la superficie que coincide con la totalidad del terreno a utilizar para la construcción y operación del Proyecto Loteo Labranza y una proyección de 100 metros con el fin de caracterizar el entorno y sus potenciales efectos indirectos (Figura 3).
...
Según el Sistema Informativo territorial, las superficies por uso dentro de la comuna de Pencahue corresponden en total a 95,497.4 ha. Su superficie en relación a su uso se encuentra compuesta por zonas Áreas Urbanas e Industriales 416.5 ha, Terrenos Agrícolas 20,545.7 ha, Praderas y Matorrales 17,614.5 ha, Bosques 56,127.2 ha, Humedales 8.2 ha, Áreas sin Vegetación 343.3 ha y Cuerpos de Agua 442.0 ha.

Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo de en su totalidad de Uso Agrícola, el cual al momento de la visita se encuentra en un 100% en desuso con presencia de malezas de tipo herbáceas que cubre la mayor parte del área del proyecto y presencia de especies arbóreas nativas.
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron dos unidades ambientales (Figura 5). Las observaciones en terreno muestran una primera unidad tipo pradera agrícola en desuso abarcando la totalidad del predio, donde dominan especies de origen introducidas como es *Cirsium vulgare* (Cardo negro) y *Hypochaeris radicata* (Hierba del chancho). Además, en esta unidad se distingue la presencia de estrato arbóreo compuesto es el caso de la especie de *Acacia caven* (Acacio Maulino).
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| Pradera en desuso | H, LA, hr, AC | Pradera en desuso degradada, dominando especies herbáceas además de la presencia de ejemplares de *Acacia Caven* (Espino maulino) | Herbáceo denso, Leñoso alto, muy clara |
| Cordón arbóreo | LA, AM | Cordón arbóreo presente en el deslinde oeste del predio dominado por | Leñoso alto, denso |

*Fuente: Etienne y Prado, 1982. Levantamiento en terreno Elaboración propia.*

**Tabla 8. Especies dominantes descritas en la COT.**

| Estrato | Especie Dominante | Sigla |
|---------|-------------------|-------|
| Leñoso alto | *Acacia caven* | Ru |
...
| Asteraceae | *Chrysanthemum coronarium* | Manzanillón | | |
...
| Poaceae | *Hordeum murinum* | Cebadilla | | |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Brisas de Pencahue”, en términos de diversidad y la presencia de especies de interés.
...
De acuerdo a su origen, un 93% de las especies identificadas en el área de estudio son consideradas como alóctonas y el 7% nativo, producto de la fuerte presión antropogénica se ha generado, por un lado, una notable reducción de la superficie arbórea, su confinamiento territorial a los espacios no utilizables para otros fines y, por otro lado, la degradación ecológica de muchos de los suelos originalmente ocupados por bosques.

La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), estableciéndose dos unidades ambientales. La primera corresponde a una superficie tipo pradera en desuso, abarcando la mayor parte del predio en donde dominan especies de origen introducidas como es *Cirsium vulgare* (Cardo negro) y *Hypochaeris radicata* (Hierba del chancho), que además presenta un estrato arbustivo con presencia de la especie de *Acacia caven* (Espino maulino). Respecto a la segunda y última unidad ambiental, corresponde a un cordón arbustivo formado por *Acacia melanoxylon* y *Populus nigra*.

En relación a la especie nativa presente en el área (*Acacia caven*), si bien no se encuentra clasificada en alguna categoría de conservación, es importante considerar que de acuerdo a la normativa vigente todas las especies de árboles nativos se encuentran protegidos por la Ley sobre recuperación del bosque nativo y fomento forestal” (D.L. N°20283/2009). Este es un árbol de amplia distribución, común de las regiones de Atacama al Biobío donde se asocia a matorral y bosque esclerófilo, la que actualmente no presenta una categoría de conservación. En terrenos agrícolas, como es el caso del proyecto, su eliminación provoca condiciones restrictivas (hídricas y tróficas) para las especies que se desarrollan cuando el árbol está presente, por lo que existe un desplazamiento de especies de ciclo biológico más largo (poaceas), por parte de especies más precoces y de menor producción (Ovallle y Avendaño, 1984a). Dentro del área del proyecto, la especie es escasa, con una veintena de individuos de poca altura, aislados y que alcanzan una cobertura menor al 5% del terreno. No se supone que la afectación sobre la especie sea significativa, considerando, además, que en sitios aledaños se registra la especie en mayor proporción que en el terreno de emplazamiento del proyecto.

Finalmente, y considerando las condiciones generales del área de emplazamiento del proyecto, se concluye que el proyecto no genera efecto negativo significativo en el recurso estudiado.
