...
## PROYECTO INMOBILIARIO “VALLES DE DON EMILIANO”
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Valles de Don Emiliano”, en la comuna de Curicó, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Valles de Don Emiliano”.
...
El proyecto “Valles de Don Emiliano” se emplaza en el sector Norte de la ciudad de Curicó (Figura 1). El área de estudio se encuentra en una zona urbana que limita con la Calle El Boldo (Figura 2).

**Figura 1. Ubicación geográfica del área de estudio.**

- Consultor: Valles de Don Emiliano
...
- Consultor: Valles de Don Emiliano
- Carta: Vértices Polígono del Proyecto
- Escala: 1:5.000
- Proyección: WGS 84 UTM H19S
- Simbología
...
Las actividades en terreno se ejecutaron el día 7 de junio de 2018, se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
- Consultor: Valles de Don Emiliano
- Carta: Área de Influencia del Proyecto
- Escala: 1:4.000
- Proyección: WGS 84 UTM H19S
- Simbología
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron dos unidades ambientales (Figura 5), las observaciones en terreno muestran una superficie tipo Pradera agrícola en desuso y altamente intervenida, abarcando la mayor parte del predio en donde dominan especies herbáceas de origen introducidas de características como *Centaurea solstitialis*, entre otras, y la segunda unidad ambiental compuesta por infraestructura.
...
| Cordón arbóreo    | A, PA             | Cordón de *Populus alba* especie arbórea introducida | Leñoso alto poco denso |
| Infraestructura   | -                 | -                   | -                         | -                 |
...
| Salicaceae   | *Populus alba*           | Aromo blanco         | Arboreo  |        |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Valles de Don Emiliano”, en términos de diversidad y la presencia de especies de interés.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación en cuanto a su fisionomía (Formación vegetal), estableciéndose tres unidades ambientales en el área de estudio, una tipo Pradera en desuso y altamente intervenida, la cual abarca la mitad del área comprendida por el futuro proyecto, donde dominan especies herbáceas de origen introducidas de características invasoras como el cardo amarillo, entre otras, y la segunda unidad ambiental la cual involucra el cordón arbóreo de Álamo blanco, el cual a su vez, corresponde a una especie introducida. Por último, se evidencia una tercera unidad que corresponde a una infraestructura.

Finalmente, y de acuerdo a lo expuesto, se puede concluir que el proyecto no afecta el recurso natural Flora y Vegetación, sin embargo, se recomienda que en su proyecto paisajístico se incluyan especies nativas.
