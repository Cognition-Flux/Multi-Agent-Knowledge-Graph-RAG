# ESTUDIO DE LÍNEA BASE FLORA Y VEGETACIÓN
...
<!-- PageHeader="Línea de Base Ambiental Proyecto Regularización Plantel Lechero y Engorda Fundo Santa Cristina" -->
...
| 3.3.1. Formación vegetacional y coberturas | 14 |
...
20
- **Tabla 9.** Formaciones vegetacionales y especies encontradas en el área de estudio del Plantel Lechero y de Engorda Fundo Santa Cristina, comuna de Antuco.  
22
...
5
- **Figura 2.** Área de estudio. Proyecto "Regularización Plantel Lechero y Engorda Fundo Santa Cristina". Comuna de Antuco, Provincia del Biobío, Región del Biobío.  
7
...
21
- **Figura 9.** Superficie en porcentaje de las formaciones vegetacionales (Herbácea, Leñosa alta y Leñosa bajo). Periodo de muestreo Verano 2022. Proyecto "Regularización Plantel Lechero y Engorda Fundo Santa Cristina". Comuna de Antuco, Provincia del Biobío, Región del Biobío.  
23
...
La producción lechera y engorda es un proceso que genera residuos orgánicos, por lo cual Agropecuaria Los Varones Ltda. se estableció como objetivo una diferenciación en el manejo y disposición final de estos residuos, dando la posibilidad de utilizarlos como materiales de fertilización en predios que serán utilizados para la producción de alimentos, para el mismo proceso lechero y ganadero, permitiendo además eliminar o minimizar la incorporación de fertilizantes artificiales a los suelos agrícolas en el corto y mediano plazo. Por lo que el objetivo principal del proyecto es regularizar sus instalaciones y procesos productivos.
...
#### Tabla 1. Coordenadas (UTM, WGS-84, H19S) de los vértices del área de muestreo
...
#### Tabla 2. Campañas de muestreo, fechas, extensión temporal y taxa evaluados

| Clase Taxonómica | Campaña de muestreo | Estación | Fechas | Nº de días |
| --- | --- | --- | --- | --- |
...
- **Fotointerpretación:** Mediante la utilización de imágenes satelitales actuales de escala 1:14.000, provenientes del satélite Maxal Technologies donde se pre identificó unidades homogéneas de vegetación (UHV) y ocupación de las especies en el lugar y fueron delimitadas en un Sistema de Información Geográfica (SIG), con el geoprocesamiento con Proyección Universal Transversal de Mercator (UTM, Huso 19 Sur y Datum World Geodesic System (WGS84) con fecha de captura el 20 de enero de 2022. Con el fin de mejorar la interpretación de la flora en el sitio de muestreo se ejecutó capturas de imágenes espaciales (UAV) con ayuda de un dron (Mavic Pro), con ángulos de 120 y 180°, la cual tiene una resolución pixel de 12.71 M, con una altura de vuelo de hasta 200 m.
...
Por otro lado, el origen biogeográfico corresponde a la distribución geográfica, ya sea natural o artificial, tanto de animales como plantas. De esta manera, una especie vegetal puede ser clasificada según su origen biogeográfico de la siguiente forma:
...
| --- | --- | --- | --- | --- |
| Herbáceo | Minúscula | minúscula | Zea mays | zm |
| Leñoso Alto | Mayúscula | Mayúscula | Quillaja saponaria | QS |
| Leñoso bajo | Mayúscula | minúscula | Fabiana imbricata | Fi |
...
| Vegetación Peneclimax | Vegetación en evolución o bosques en proceso de recuperación. | 2 |
...
En general, dentro del área de estudio se identifican dos formaciones vegetales: zonas de cultivo y de tipo arbóreas (bosque). Se registraron 28 especies en la zona de estudio (Tabla 8). De las 28 especies presentes en el área de estudio, se evidenció la presencia de Baccharis obovata "Chilca", especie endémica representando un 3,6%. Las especies nativas con 7 especies: Maytenus boaría "Maitén", Aristotelia chilensis "Maqui", Cryptocarya alba "Peumo", Luma apiculata "Arrayán", Nothofagus obliqua "Roble", Quillaja saponaria "Quillay" y Fabiana imbricata "Pichi" especies que representaron un 25 % de la abundancia. Las especies de origen exótico estuvieron representadas por 20 especies, las que contribuyeron con un 71,4 % de la abundancia total del área de estudio (Tabla 8, Figura 7). Por su parte, según su forma de crecimiento, el 50% correspondió a herbáceas, el 36% a arbóreas y el 14% a especies arbustivas (Tabla 8, Figura 8).

#### Tabla 8. Listado de especies en la zona de estudio, se indica el nombre común, la forma de crecimiento y el origen geográfico. Periodo de muestreo verano 2022

| Familia | Especie | Nombre común | Origen | Hábito | Conservación |
| --- | --- | --- | --- | --- | --- |
| Asteraceae | Cirsium vulgare | Cardo | Introducida | Herbácea | No aplica |
| Apiaceae | Conium maculatum | Cicuta | Introducida | Herbácea | No aplica |
| Asteraceae | Anthemis cotula Taraxacum officinale Bellis spp Baccharis obovata | Manzanilla bastarda Diente de león Margarita Chilca | Introducida Introducida Introducida Endémica | Herbácea Herbácea Herbácea Arbustiva | No aplica No aplica LC No aplica |
| Boraginaceae | Echium plantagineum | Hierba azul | Introducida | Herbácea | No aplica |
| Celastraceae | Maytenus boaría | Maitén | Nativa | Arbórea | LC |
| Convolvuláceas | Calystegia sepium | Campanilla blanca | Introducida | Herbácea | No aplica |
| Elaeocarpaceae | Aristotelia chilensis | Maqui | Nativa | Arbustiva | LC |
| Fabaceae | Acacia melanoxylon Acacia dealbata | Aromo australiano Aromo chileno | Introducida Introducida | Arbórea Arbórea | No aplica No aplica |
| Lauraceae | Cryptocarya alba | Peumo | Nativa | Arbórea | LC |
| Myrtaceae | Eucalyptus nitens Eucalyptus globulus Luma apiculata | Eucalipto Eucalipto Arrayán | Introducida Introducida Nativa | Arbórea Arbórea Arbórea | No aplica No aplica LC |
| Nothofagaceae | Nothofagus obliqua | Roble | Nativa | Arbórea | LC |
| Poaceae | Zea mays Bromus hordeaceus Lolium multifllorum Vulpia bromoides Holcus lanatus | Maíz Triguillo Ballica italiana Pasto pelillo Pasto chileno | Introducida Introducida Introducida Introducida Introducida | Herbácea Herbácea Herbácea Herbácea Herbácea | No aplica No aplica No aplica No aplica No aplica |
| Pinaceae | Pinus radiata | Pino | Introducida | Arbórea | No aplica |
| Quillajaceae | Quillaja saponaria | Quillay | Nativa | Arbórea | LC |
| Rosaceae | Rubus ulmifolius Rosa rubiginosa | Zarza mora Rosa mosqueta | Introducida Introducida | Herbácea Arbustiva | No aplica No aplica |
| Scrophulariaceae | Verbascum thapsus | Hierba del paño | Introducida | Herbácea | No aplica |
| Solanaceae | Fabiana imbricata | Pichi | Nativa | Arbustiva | LC |
...
De las 7 especies nativas presentes en el área de estudio, las especies arbóreas: Maytenus boaría "Maitén", Cryptocarya alba "Peumo", Luma apiculata "Arrayán", Nothofagus obliqua "Roble", Quillaja saponaria "Quillay"; las arbustivas: Aristotelia chilensis "Maqui" y Fabiana imbricata "Pichi". Según la UICN se encuentran categorizadas como Preocupación menor (LC). Además, estas especies poseen una amplia distribución en la zona, lo cual indica que no están próximas a satisfacer los criterios de peligro (Tabla 8).

### Dominancia de especies y formación vegetacionales

A partir de los muestreos del 16 y 17 de marzo de 2022 de manera satelital e in situ, se observó tres tipos de formaciones vegetales para cinco tipos de especies dominantes diferentes, los cuales destacan Herbáceos pertenecientes en su mayoría a la especie Zea mays, Leñosos altos correspondientes a árboles superiores a 2 metros de altura los cuales destacan Cyptocarya alba y Quillaja saponaria y Leñosos bajos correspondientes a arbustos que varían entre 1,5 a 2 m de altura como Fabiana imbricata y Baccharis obovata (Tabla 9, Figura 10), de estos 313,48 Ha corresponden a herbáceos, 412,06 Ha a leñosos bajos y 132,19 Ha a leñosos altos. De estas especies tres corresponden a especies nativas categorizada como preocupación menor.

Las densidades a partir de los cálculos de cobertura para las transectas variaron entre "Clara" a "Muy denso", con porcentajes de coberturas que fluctuaron entre 93,0% para las especies de Zea mays y 43,0% para las especies de Fabiana imbricata (Tabla 9).
...
- Cinco especies fueron dominantes dentro del área del proyecto (Zea mays, Fabiana imbricata, Baccharis obovata, Cyptocarya alba y Quillaja saponaria).
...
DINERSTEIN, E., OLSON, D. M., GRAHAM, D. J., WEBSTER, A. L., PRIMM, S. A., BOOKBINDER, M. P., & LEDEC, G. (1995). Una evaluación del estado de conservación de las ecoregions terrestres de América latina y el Caribe. Washington D.C .: WWF - World Bank. Pp: 135.
