...
## “PROYECTO CONJUNTO HABITACIONAL DOÑA IGNACIA IX”
...
Es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Doña Ignacia IX”, en la comuna de Talca, región del Maule.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Doña Ignacia IX”.
...
El proyecto “Doña Ignacia IX” se emplaza en la región del Maule en la entrada orientación sur de la ciudad de Talca (Figura 1). El área de estudio se encuentra en una zona urbana que se conecta en 1 km con la Panamericana Sur.
...
- **Carta:**
- **Escala:** 1:100.000
- **Simbología:** Divisón Politico Administrativa
...
Las actividades en terreno se ejecutaron durante el mes de Septiembre de 2017, se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
Disposición vertical en la comunidad. Se utilizan los 4 tipos biológicos como base en la definición de la estratificación.
...
Se define en función de la proyección del área ocupada por la vegetación.
...
| 3. Terrenos de pastoreo                   | 3.0 Pradera natural, 3.1 Pradera degradada, 3.2 Matorral abierto, etc.      |
| 4. Cultivos anuales de secano/Bosque art. | 4.0 Cereal de secano, 4.1 Chacra de secano, 4.2 Bosque artificial abandonado|
| 5. Cultivos anuales de riego/perennes     | 5.0 Cereal de riego, 5.1 Cultivo forrajero, 5.2 Bosque artificial, etc.     |
| 6. Cultivos perennes de riego             | 6.0 Silvicultura intensiva, 6.1 Cultivo forrajero, 6.2 Viticultura, etc.    |
| 7. Cultivos intensificados                | 7.0 Hortalizas, 7.1 Vivero forestal, 7.2 Vivero ornamental, etc.            |
| 8. Invernaderos y Parques                 | 8.0 Invernaderos, 8.1 Parques y plantaciones ornamentales                   |
| 9. Zonas edificadas                       | 9.0 Pueblos, 9.1 Zona periurbanas, 9.2 Ciudad con áreas verdes, etc.        |
...
|-----------------------------------|----------------|----------------------------------------------------------------------------|
| Desierto                          | I - VI región  | Desierto Andino, Desierto Absoluto, Desierto Costero, Desierto Florido, Estepa Alto–Andina |
| Extremo norte–VII (Cordillera de los Andes) | Altiplano y Puna, Andes Mediterráneos |
...
Según el Sistema Informativo territorial, las superficies por uso dentro de la comuna de Talca corresponden en total a 23.110,5 ha, de las cuales 3.265,8 son equivalentes a Áreas Urbanas-Industriales, 15.885,4 ha corresponde a Terrenos Agrícolas, 2.639,1 ha a Praderas y Matorrales, mientras 1.029,5 ha corresponden a Bosques, finalmente 290,7 ha pertenecen a Cuerpos de Agua.

Dentro del área de emplazamiento del proyecto, el SIT registra un uso de suelo de Uso Agrícola, el cual al momento de la visita se encuentra en un 70% con escasa vegetación, destacándose la pradera agrícola en desuso, que cubre la mayor parte del área del proyecto, además un cordón boscoso que rodea el predio en donde predominan especies arbóreas.
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT), se obtuvieron 6 unidades ambientales destacándose la pradera agrícola con una superficie homogénea, que abarca la mayor área del predio, en donde predominan especies herbáceas como *Rapistrum rugosum* (Rapistro), *Cirsium vulgare* (Cardo negro) y *Galega officinalis* (Galega). La segunda unidad ambiental es la de cordón boscoso que se restringe al borde del predio y en los caminos de accesos en donde predomina en sectores exclusivamente *Salix humboldtiana* (Sauce Chileno), mientras en otros se encuentra *Robinia pseudoacacia* con presencia de estrato arbustivo representado con la especie *Rubus ulmifolius* (Zarzamora). La unidad ambiental de humedal se compone de una zona de inundación que se abastece por las lluvias, en donde se establece vegetación dependiente de agua como *Typha angustifolia* (Vatro) y *Juncus procerus* (Junco). La siguiente unidad ambiental es la de plantación de la especie arbórea *Eucalyptus globulus* con presencia en su dosel de estrato herbáceo de origen introducido. La unidad de Infraestructura corresponde a construcciones de galpones avícolas, y por otro parte infraestructura habitacional que se encuentran habitadas hasta la fecha de la campaña de terreno, y por último la unidad ambiental de esteros que corresponde a 3 cuerpos de agua de tipo canal con un caudal menor, 2 de estos son utilizados para riego agrícola, se encuentran ubicados al fondo de la unidad de pradera agrícola.

##### Tabla 7. Resultados Carta de Ocupación de Tierras

| Unidad ambiental     | Formación Vegetal | Especies Dominantes | Grado de artificialización | Densidad (Índice) | Descripción |
|---------------------|-------------------|---------------------|---------------------------|-------------------|-------------|
| Pradera agrícola    |                   | rr; cv; go          | Herbáceo, muy clara       |                   | Ambiente que ocupa la mayor área del predio, con una superficie homogénea de especies herbáceas, predominando *Rapistrum rugosum*, *Cirsium vulgare* y *Galega officinalis*. |
| Cordón boscoso      | LA                | SH; RP; Ru          | Leñoso alto, poco densa   |                   | Franja boscosa que se encuentra en los bordes del predio y en los caminos de acceso predominando en algunos sectores *Salix humboldtiana*, mientras en otros exclusivamente *Robinia pseudoacacia*, además presencia arbustiva de la especie *Rubus ulmifolius*. |
| Humedal            |                   | Ta; jp              | Herbáceo, clara           |                   | Zona de inundación que se abastece por las lluvias, en donde se establece vegetación dependiente de agua predominando especies como *Typha angustifolia* (Vatro) y *Juncus procerus* (Junco). |
| Plantación de Eucaliptus | EG           |                     | Leñoso alto, densa        |                   | Plantación de la especie arbórea *Eucalyptus globulus* que alcanzan una altura de varios metros, bajo su dosel se desarrolla una abundante cubierta herbácea de origen introducido. |
| Infraestructura     | -                 | -                   | -                         |                   | Corresponden a construcciones de galpones avícolas instalados en el predio, además de construcciones habitacionales. |
| Esteros             | H                 | al; lp              | Herbáceo, muy clara       |                   | Corresponde a 3 cuerpos de agua de tipo canal de pequeño tamaño, 2 de los canales son usados para riego agrícola y se ubican al interior de la pradera agrícola, donde se pueden encontrar especies herbáceas como *Alisma lanceolatum* y *Ludwigia peploides*. |
...
|               | *Cirsium vulgare*         | cv    |
|               | *Galega officinalis*      | go    |
|               | *Typha angustifolia*      | ta    |
|               | *Juncus procerus*         | jp    |
|               | *Ludwigia peploides*      |       |
|               | *Alisma lanceolatum*      | al    |
| Arbustivo     | *Rubus ulmifolius*        | Ru    |
| Arbóreo       | *Salix humboldtiana*      | SH    |
| Arbóreo       | *Robinia pseudoacacia*    | VP    |
...
- **Carta:**
- **Escala:** 1:2.000
- **Simbología:** Pradera agrícola, Cordón boscoso, Humedal, Plantación de Eucaliptus, Infraestructura, Esteros
- **Proyección:** WGS 84 UTM H19S
...
La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 25 especies de plantas pertenecientes a 15 familias (Tabla 9). Del total de las especies registradas 4 corresponden nativas, siendo las restantes especies introducidas principalmente invasoras y ornamentales.

##### Tabla 9. Listado de especies vegetales registradas en el área de estudio

| Familia      | Especie                | Nombre común      | Hábito     | Origen     |
|--------------|-----------------------|-------------------|------------|------------|
| Myrtaceae    | Eucaliptus            | Eucaliptus globulus|            |            |
| Fabaceae     | Acacia dealbata       | Aromo Chileno     |            |            |
| Salicaceae   | Salix humboldtiana    | Sauce chileno     | Nativo     |            |
| Leguminosae  | Robinia pseudoacacia  | Falsa acacia      |            |            |
| Fabaceae     | Acacia caven          | Espinillo         | Nativo     |            |
| Rosaceae     | Prunus domestica      | Ciruelo           |            |            |
| Rosaceae     | Cydonia oblonga       | Membrillo         |            |            |
| Moraceae     | Ficus carica          | Higuera           |            |            |
| Rosaceae     | Rubus ulmifolius      | Zarzamora         | Arbustivo  |            |
| Juncaceae    | Juncus procerus       | Junco             | Nativo     |            |
| Typhaceae    | Typha angustifolia    | Vatro             | Nativo     |            |
| Alismataceae | Alisma lanceolatum    | Llantén de agua   |            |            |
| Onagraceae   | Ludwigia peploides    | Pasto de la rana  |            |            |
| Fabaceae     | Galega officinalis    | Galega            |            |            |
| Apiaceae     | Conium maculatum      | Cicuta            |            |            |
| Cyperaceae   | Eleocharis macrostachya| Junco de espiga   |            |            |
...
| Asteraceae   | Senecio vulgaris      | Hierba cana       |            |            |
| Asteraceae   | Anthemis cotula       | Manzanillón       |            |            |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto inmobiliario “Doña Ignacia IX”, en términos de diversidad y la presencia de especies de interés.
...
Las características vegetacionales del área de estudio están definidas por el alto grado de intervención antrópica (pastizal y despeje de vegetación) facilitando el establecimiento de especies vegetales invasoras, las cuales no permiten el crecimiento de flora nativa.
