...
- Figura 13. Imagen de *Calystegia sepium* (Carricillo)
...
El presente informe expone los resultados obtenidos para la elaboración del Estudio de Flora y Vegetación, enmarcado en la caracterización ambiental del Medio Biótico del Proyecto Plaza Parque, en la comuna de Temuco, Región de la Araucanía.
...
Describir la flora y caracterizar la vegetación presente en el área de influencia del Proyecto.
...
El Proyecto se emplaza en la salida norte de la ciudad de Temuco, en la comuna de Temuco, Región de la Araucanía (Figura 1). El área de estudio se encuentra en una zona poblada que limita con la ruta S-348 (Calle Rudecindo Ortega) y a unos 900 m del río Cautín.

**Figura 1. Ubicación geográfica del área de estudio Región de la Araucanía.**

- **Consultor:** Proyecto Inmobiliario Plaza Parque
- **Carta:** División Político Administrativa
- **Escala:** 1:100.000
- **Proyección:** WGS 84 UTM H19S
- *Fuente: Elaboración propia.*

Se define un polígono de 3 vértices para delimitar el área del proyecto, en una superficie aproximada de 2,4 hectáreas.
...
La tercera variable se realizó con la tabla de grados de artificialización que va desde el 1. Vegetación clímax al 9. Zonas edificadas, con subtipos en cada una de ellas como se identifica en la Tabla 5.
...
Para la componente Flora y Vegetación el Área de influencia de este proyecto está definida por los impactos ambientales potenciales que pueda tener el proyecto sobre cada componente del ambiente. Es por esto que el Área de Influencia se define como el área donde el proyecto coincide con la totalidad del terreno, el cual incluye el área de emplazamiento de las obras, temporales y permanentes con una proyección de 100 metros con el fin de caracterizar el entorno del proyecto y sus potenciales efectos indirectos.
...
Finalmente, en base al registro del Sistema Nacional de Información Ambiental (SINIA) del Ministerio de Medio Ambiente, el área de emplazamiento del proyecto se ubica en una zona donde el uso actual de suelo corresponde a Terrenos agrícolas, la cual se caracteriza por presentar una pendiente entre 0 y 15% de exposición plano, y una altitud de entre 0 y 200 metros.

Más específica el Catastro vegetacional ubica al predio en matorral arborescente abierto y praderas perennes (Figura 4).
...
De esta forma y de acuerdo los antecedentes mencionados, en la actualidad las áreas de estudio presentan principalmente áreas urbanizadas, sitio intervenido antrópicamente con limpieza de maleza, arbusto, que actualmente se utiliza de estacionamiento y un área de pradera con edificaciones asociadas a instalaciones de faenas y sala de ventas, siendo un lugar altamente intervenido por actividad humana.
...
| Unidad ambiental | Formación Vegetal (Tabla 2) | Especies Dominantes (Tabla 3, Tabla 4) | Grado de Artificialización (Tabla 5) | Densidad (Índice) |
|------------------|----------------------------|----------------------------------------|--------------------------------------|-------------------|
| A. Infraestructura| H                          | cd                                     | 9.1 Zona periurbana                  | Muy Clara (3)     |
| B. Pradera       | H                          | ca, cd                                 | 9.1 Zona periurbana                  | Muy Clara (3)     |
|                  | H                          | ca                                     |                                      | Clara (4)         |
...
|---------------|---------------------------|-------|
| Herbácea      | *Chenopodium álbum*       | ca    |
| Herbácea      | *Cynodon dactylon*        | cd    |
| Herbácea      | *Polygonum persicaria*    | pp    |
| Herbácea      | *Achillea millefolium*    | am    |
| Herbácea      | *Amaranthus quitensis*    | aq    |
...
La flora vascular que se registró en el área de estudio fue caracterizada en términos de riqueza florística, origen geográfico y grado de conservación. Los resultados arrojan un total de 30 especies de plantas pertenecientes a 16 familias (Tabla 9). De las especies registradas solo 1 corresponde a especie de origen nativo y 29 especies exóticas.

**Tabla 9. Listado de especies vegetales registradas en el área de estudio.**

| N° | Familia         | Especie                   | Nombre común         | Hábito     | Origen   |
|----|----------------|---------------------------|----------------------|------------|----------|
| 1  | Amaranthaceae  | *Amaranthus quitensis*    | Yuyo colorado        |            |          |
| 2  | Apiaceae       | *Conium maculatum*        | Cicuta               |            |          |
| 3  | Asteraceae     | *Achillea millefolium*    | Milenrama            |            |          |
| 4  |                | *Anthemis cotula*         | Manzanilla bastarda  |            |          |
| 5  |                | *Cichorium intybus*       | Achicoria            |            |          |
| 6  |                | *Sonchus asper*           | Ñilhue caballuno     |            |          |
| 7  |                | *Taraxacum officinale*    | Diente de león       |            |          |
| 8  |                | *Hypochaeris radicata*    | Hierba del chancho   |            |          |
| 9  |                | *Xanthium spinosum*       | Abrojo               |            |          |
| 10 |                | *Lapsana communis*        | Lapsana              |            |          |
| 11 | Boraginaceae   | *Echium vulgare L.*       | Hierba azul          |            |          |
| 12 | Chenopodiaceae | *Chenopodium álbum*       | Cenizo               |            |          |
| 13 | Convolvulaceae | *Calystegia sepium*       | Carricillo           |            |          |
| 14 |                | *Convolvulus arvensis*    | Correhuela           |            |          |
| 15 | Cupressaceae   | *Cupressus sempervirens*  | Ciprés               | Arbóreo    |          |
| 16 | Elaeocarpaceae | *Aristotelia chilensis*   | Maqui                | Arbustivo  | Nativa   |
| 17 | Fabaceae       | *Robinia pseudoacacia*    | Falsa acacia         | Arbóreo    |          |
| 18 |                | *Acacia dealbata*         | Aromo                | Arbóreo    |          |
| 19 |                | *Trifolium repens*        | Trébol blanco        |            |          |
| 20 | Pinaceae       | *Pinus radiata*           | Pino                 | Arbóreo    |          |
| 21 | Plantaginaceae | *Plantago lanceolata*     | Llantén              |            |          |
| 22 | Poaceae        | *Agrostis capillaris*     | Chepica              |            |          |
| 23 |                | *Holcus lanatus*          | Pasto miel           |            |          |
| 24 |                | *Bromus hordeaceus*       | Cebadilla            |            |          |
| 25 |                | *Cynodon dactylon*        | Césped               |            |          |
| 26 | Polygonaceae   | *Polygonum persicaria*    | Duraznillo           |            |          |
| 27 |                | *Rumex sp*                | Romaza               |            |          |
| 28 | Rosaceae       | *Rubus ulmifolius*        | Zarzamora            |            |          |
| 29 | Scrophulariaceae| *Verbascum thapsus*      | Hierba del paño      |            |          |
| 30 | Solanaceae     | *Datura stamoniun*        | Chamico              |            |          |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del Proyecto Plaza Parque, principalmente en términos de diversidad y la presencia de especies de interés.
...
La flora y vegetación está compuesta principalmente por pastizales con presencia de especies arbóreas, evidenciándose una sola especie nativa, las cuales se encuentran cubriendo una pequeña parte del área de estudio. Las características vegetacionales del área de estudio están definidas por el alto grado de intervención antrópica (pastizal, acumulación de residuos domiciliarios y despeje de vegetación) facilitando el establecimiento de especies vegetales invasoras, las cuales no permiten el crecimiento de flora nativa.
...
La metodología de la Carta de Ocupación de Tierras (COT), permite caracterizar el estado actual de la vegetación, estableciéndose unidades homogéneas en cuanto a su fisionomía (formación vegetal) y especies dominantes, de esta forma fue posible determinar que la mayor cobertura del área de estudio se encuentra intervenida, observándose principalmente especies herbáceas de tipo invasivas formando praderas abiertas con escasa vegetación.

Finalmente, en relación a la especie nativa presente en el área, cabe señalar que no se encuentra clasificada en alguna categoría de conservación. Sin embargo, de acuerdo a la normativa vigente todas las especies de árboles nativos se encuentran protegidos por la *Ley sobre recuperación del bosque nativo y fomento forestal* (DL. 20283/2009). Es por lo anterior que se hace necesario señalar que, según el diseño del proyecto, dicho ejemplar no será intervenido, por lo que no se hace necesaria ninguna medida de resguardo.
...
- CONAF (Corporación Nacional Forestal). 2011. Catastro de los Recursos Vegetacionales Nativos de Chile. Monitoreo de cambios y actualizaciones. Período 1997-2011. 25 pp.
...
- GAJARDO, R. 1993. La vegetación natural de Chile, Clasificación y Distribución Geográfica. Editorial Universitaria. Santiago. 165 pp.
