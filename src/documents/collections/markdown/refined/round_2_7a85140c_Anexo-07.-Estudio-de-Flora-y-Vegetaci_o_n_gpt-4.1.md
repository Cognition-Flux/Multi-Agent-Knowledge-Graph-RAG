...
## PROYECTO “CONDOMINIO PIEDRA DE RIO”
...
El presente documento contiene los resultados obtenidos de la caracterización de la flora y vegetación del área de influencia del proyecto “Condominio Piedra de Río”, ubicado en la comuna de Padre Las Casas, provincia de Cautín, IX Región de la Araucanía.
...
Dado lo anterior, es materia del presente informe exponer los resultados obtenidos para la elaboración de la Línea base de Flora y Vegetación, enmarcada en la caracterización ambiental del Medio Biótico del Proyecto “Condominio Piedra de Río”, en la comuna de Padre Las Casas, región de la Araucanía.
...
El objetivo general de este estudio es describir la flora y caracterizar la vegetación presente en al área de influencia del proyecto “Loteo Padre Las Casas”.
...
El proyecto “Condominio Piedra Río” se emplazará en la comuna de Padre Las Casas, Provincia de Cautín, Región de la Araucanía, específicamente a unos 700 metros al norte de la Ruta Panamericana Sur y 400 metros al este de la Otra Longitudinal Sur (Figura 1).
...
Las actividades en terreno se ejecutaron el día 20 de noviembre de 2019, donde se realizó una descripción cartográfica de la vegetación presente en el área de estudio, con el objeto de describir las unidades y/o recabar patrones vegetacionales.
...
De esta manera, para la componente Flora y Vegetación el Área de influencia de este proyecto está definida como la superficie que coincide con la totalidad del terreno a utilizar para la extracción y operación del proyecto además de una zona buffer de 100 m por todo el contorno del área del proyecto (Figura 3).
...
Según el Sistema Informativo territorial, las superficies por uso dentro de la comuna de Padre Las Casas corresponden en total a 40,198.1 ha, de las cuales 31,927.1 ha son ocupadas como Terrenos agrícolas, 6,014.1 ha corresponde a Bosques, 554.2 ha son utilizadas como Áreas Urbanas Industriales, 1,177.9 ha a Praderas y Matorrales, 416.0 ha corresponden a Cuerpos de agua, mientras que 33.1 ha corresponden a Áreas sin vegetación, finalmente 75.7 ha pertenecen a Humedales.
...
Mediante la metodología de la Carta de Ocupación de Tierras (COT) se obtuvieron 3 unidades ambientales (Tabla 7), la primera unidad identificada corresponde a formación Arbórea que se compone de cordones de bosque de especies introducidas, mayormente *Eucalyptus globulus*, *Pinus radiata*, *Acacia dealbata* y *Acacia melanoxylon*. La segunda unidad ambiental corresponde a la de Matorral predominando la especie arbustiva *Rubus ulmifolius*; finalmente, la tercera unidad ambiental corresponde Pradera donde predominan especies como *Carduus pycnocephalus*, *Rapistrum rugosum*, *Vulpia bromoides* y *Anthemis cotula*.
...
|------------------|------------------|---------------------|---------------------------|-------------------|
| Arbóreo          | LA               | PR, EG, AD, AM      | 4.2. Bosque artificial abandonado | pd, pd, pd, pd   |
| Matorral         |                  | Ru                  | 3.1. Pradera natural degradada o matorral abierto con pasto degradado y arbustos no ramoneados | pd |
| Pradera          | H H              | cp, rr, vb, ac      | 3.1. Pradera natural degradada o matorral abierto con pasto degradado y arbustos no ramoneados | d, d, d, d |
...
|---------------|---------------------------|-------|
| Herbácea      | *Carduus pycnocephalus*   | cp    |
| Herbácea      | *Rapistrum rugosum*       | rr    |
| Herbácea      | *Vulpia bromoides*        | vb    |
| Herbácea      | *Anthemis cotula*         | ac    |
...
|                 | *Baccharis linearis*      | Romerillo            | Arbustivo  | Nativa   |
...
| Brassicaceae    | *Capsella bursa-pastoris* | Bolsita del pastor   |            |          |
|                 | *Rhaphanus raphanistrum*  | Rábano silvestre     |            |          |
|                 | *Rapistrum rugosum*       | Rapistro-Falso yuyo  |            |          |
|                 | *Sisymbrium officinale*   | Mostacilla           |            |          |
| Caryophyllaceae | *Petrorhagia dubia*       | Rosa peluda          |            |          |
...
En el presente estudio se analizó la representatividad y singularidad de la flora y vegetación presente en el área de influencia del proyecto “Condominio Piedra del Río”, en términos de diversidad y la presencia de especies de interés.
...
La flora del lugar está compuesta mayormente por especies introducidas o exóticas, principalmente de formaciones herbáceas, muchas de ellas consideradas invasoras o dañinas. Mientras que las formaciones arbóreas, están también dominadas por especies exóticas distribuidas en pequeños cordones boscosos hacia los límites del terreno. Por lo que podemos afirmar que las características vegetacionales del área de estudio están definidas por el alto grado de intervención antrópica observada, la que ha modificado el paisaje y la posibilidad de desarrollo de especies de flora nativa.
...
La metodología de la Carta de Ocupación de Tierras (COT) permitió caracterizar el estado actual de la vegetación, obteniendo 3 unidades ambientales representativas, la primera unidad identificada corresponde a la formación arbórea, la cual se compone de cordones de bosque con especies introducidas, mayormente *Eucalyptus globulus*, *Pinus radiata*, *Acacia dealbata* y *Acacia melanoxylon*. La segunda unidad ambiental corresponde a la de Matorral predominando la especie arbustiva *Rubus ulmifolius*; finalmente, la tercera unidad ambiental corresponde Pradera donde predominan especies como *Carduus pycnocephalus*, *Rapistrum rugosum*, *Vulpia bromoides* y *Anthemis cotula*. Esta última unidad es la que cubre mayor superficie dentro del terreno, mostrando características de alto grado de intervención antrópica y con dominancia de especies denominadas como malezas o malas hierbas.

En relación a la especie arbórea nativa presente en el área, *Aristotelia chilensis*, es posible indicar que, si bien ninguna se encuentra clasificada en alguna categoría de conservación, es importante considerar que de acuerdo a la normativa vigente todas las especies de árboles nativos se encuentran protegidos por la Ley sobre recuperación del bosque nativo y fomento forestal” (DL. 20283/2009).

Finalmente, y por todo lo anterior, se concluye que el proyecto no genera efectos negativos significativos sobre el recurso estudiado.
